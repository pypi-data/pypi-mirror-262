...
class HandleApi:
    ...
    def input_get_url_by_unique(self, unique: str) -> str:
        return self.__storage.tencent_get_file_url(self.input_get_path_by_unique(unique))
    ...
    # 上传字幕文件
    def output_upload_subtitle(self, unique: str, subtitles: EntitySubtitles):
    ...
    #  直接上传文件
    def output_upload_file(self, unique: str, path: str):
    ...
    # 从本地上传文件并获取url
    def tencent_get_url_by_local(self, path: str) -> str:
