...
class SpaceLogClient:
    DEFAULT_SUPABASE_PROJECT_ID = "wttxigswgidkqoqwscsa"
    ...
    def __init__(self, application_id: str,
                 ...
                 supabase_project: str = DEFAULT_SUPABASE_PROJECT_ID):
    ...
    def from_environment(application_id: Optional[str] = None,
                         auth_token: Optional[str] = None,
                         supabase_project: str = DEFAULT_SUPABASE_PROJECT_ID) -> Optional["SpaceLogClient"]:
