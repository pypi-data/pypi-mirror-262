...
class ProductCategoryProcessor(object):
    ...
    def update_wc_id(self, name: str, wc_id: int):
        attribute_updates = {"wc_id": wc_id}
        return self.dynamodb_storage_client.update(key={"name": name, "attribute_updates": attribute_updates})
