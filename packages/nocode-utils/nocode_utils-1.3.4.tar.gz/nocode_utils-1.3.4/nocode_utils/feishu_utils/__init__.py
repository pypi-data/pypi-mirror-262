...
class FeishuBot:
    ...
    def send_custom_card(self, template_id, template_version_name, template_variable, emails=[]):
        tenant_access_token = self.get_tenant_access_token()
        # 获取调用函数信息
        stack = inspect.stack()
        caller_frame = stack[1]
...
if __name__ == "__main__":
    bot = FeishuBot("")
    bot.send_custom_card("AAqU6XYqJLRQu", "1.0.0", {"title": "123", "content": "456"}, ["haohe@nocode.com"])
