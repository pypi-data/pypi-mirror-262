...
class FixedIncome:
    ...
    def expectedMaturity(self, total_coupons, maturity_date, issuance_date, years_to_maturity, nper):
        #Determination of the expected maturity date
        if (maturity_date.month - issuance_date.month - nper) != 0 or maturity_date.day != issuance_date.day:
