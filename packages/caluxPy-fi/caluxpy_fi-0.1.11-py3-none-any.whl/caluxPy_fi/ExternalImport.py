...
class ExternalImport:
    ...
    def __init__(self, file = '', df = '', initial_row = 0, columns = ''):#, repos = False, repos_attributes = [], medida = False):
        self.file = file
        self.df = df
        ...
        fileHandler = logging.FileHandler("{0}/{1}.log".format(os.getcwd(), 'ei'), mode = 'w', encoding = 'utf-8')
