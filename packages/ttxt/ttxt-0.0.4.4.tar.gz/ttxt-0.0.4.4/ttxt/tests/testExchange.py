...
def test(exchangeName="", params={}):
    ...
    if "createLimitOrder" in params and params["createLimitOrder"]:
        ...
        try:
            resp = ttxtExchange.create_limit_order(symbol=tickerToTest, amount=2, side="sell", price=10)
    ...
    if "myTrades" in params and params["myTrades"]:
        ...
        try:
            resp = ttxtExchange.fetch_my_trades(symbol=tickerToTest, startTime='',endTime='', limit=100)
            print(resp)
        except Exception as e:
