...
def generate_kirby_conf(table_raw_name=None, table_master_name=None, kirby_type=None, target_staging_path=None):
    ...
    if kirby_type == "raw":
        ...
        table_dict_conf[table_raw_name]["kirby"]["output"]["compactConfig"]["targetPath"] = f"/data/raw/{uuaa_raw}/datatmp/{table_raw_name}_kirbycompact/" + "${AAUUID}"
        ...
        for field in txt_json["fields"]:
            name = str(field.get("legacyName")).replace("-", "_").strip()
        ...
        table_dict_conf[table_master_name]["kirby"]["output"]["compactConfig"]["targetPath"] = f"/data/master/{uuaa_master}/datatmp/{table_master_name}_kirbycompact/" + "${AAUUID}"
