...
setup(
    name="mylibisyourlib",  # Nom de votre package
    version="0.2",  # Version de votre package
    author="Robin Messiaen",  # Ajoutez votre nom
    author_email="robin_messiaen@hotmail.fr",  # Ajoutez votre adresse email
    description="A library for all people working on my project.",  # Ajoutez une brève description
