...
class ConversationSource(BaseModel):
    ...
    author: Author
    body: StrictStr
    __properties: ClassVar[List[str]] = ["type", "id", "author", "body"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConversationSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConversationSource from a dict"""
        if obj is None:
            return None
