...
from windmillcomputev1.computev1.compute_client import ComputeClient
from windmillcomputev1.filesystem import download_by_filesystem, upload_by_filesystem
from bcesdk.bce_client import BceClient
...
class ArtifactClient(BceClient):
    """
    ...
    def get_artifact(self, name: Optional[str] = "", object_name: Optional[str] = "", version: Optional[str] = ""):
        ...
        """
        if name != "":
            object_name, version = parse_artifact_name(name=name)
