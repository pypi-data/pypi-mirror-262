...
from findly.unified_reporting_sdk.data_sources.common.common_parser import CommonParser, RESERVED_TOTAL
from findly.unified_reporting_sdk.protos.semantic_layer_pb2 import QueryArgs
...
class GA4QueryArgsParser(CommonParser):
    ...
    async def parse_query_args_to_request_params(
        ...
        ga4_date_ranges = await self.get_date_ranges(
    ...
    async def get_dimensions(
        self, dimensions_name_list: List[str]
    ) -> List[Dimension]:
    ...
    async def get_metrics(
        self, metrics_name_list: List[str]
    ) -> List[Metric]:
