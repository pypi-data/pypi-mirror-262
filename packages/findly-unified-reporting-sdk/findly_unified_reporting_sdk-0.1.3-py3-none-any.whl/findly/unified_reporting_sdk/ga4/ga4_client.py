...
from findly.unified_reporting_sdk.protos.semantic_layer_pb2 import Metric as MetricProto
from findly.unified_reporting_sdk.protos.semantic_layer_pb2 import (
    MetricValueType,
    QueryArgs,
)
...
from findly.unified_reporting_sdk.ga4.ga4_query_args_parser import (
    GA4QueryArgsParser,
)
...
class GA4Client(AnalyticsClient):
    def __init__(
        self,
        token: str,
        client_id: str,
        ...
        metrics_list: List[MetricProto] = await asyncio.gather(
            *[
                self.get_metric_from_name(
                    metric_name=metric_metadata.api_name,
                    property_id=property_id,
                )
                for metric_metadata in metadata_response.metrics
            ]
