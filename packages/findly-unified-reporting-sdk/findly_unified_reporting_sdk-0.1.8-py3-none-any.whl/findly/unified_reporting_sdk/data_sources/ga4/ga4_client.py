...
class GA4Client(ReportsClient):
    ...
    async def list_property_ids(self, **kwargs: Dict) -> Optional[List[str]]:
    ...
    async def get_domain_name(self, property_id: str) -> Optional[str]:
    ...
    async def get_dimension_values(
        self, dimension: DimensionProto, top_n: int, property_id: str, **kwargs: Dict
    ) -> Optional[List[str]]:
        LOGGER.info(
            {
        ...
        dimension = await self.get_ga4_dimension_from_name(
    ...
    async def is_metric_empty(
        ...
        ga4_metric: Metric = await self.get_ga4_metric_from_name(
    ...
    async def get_metadata(self, property_id: str) -> Optional[Metadata]:
    ...
    async def get_dimension_from_name(
        self, dimension_name: str, property_id: str, **kwargs: Dict
    ...
    async def get_metric_from_name(
        self, metric_name: str, property_id: str, **kwargs: Dict
    ...
    async def list_dimensions(
        self, property_id: str, **kwargs: Dict
        ...
        dimensions_list: List[DimensionProto] = await asyncio.gather(
            *[
    ...
    async def list_metrics(
        ...
        metrics_list: List[MetricProto] = await asyncio.gather(
            *[
