...
from dvcx.sql.selectable import values
...
def test_select_values(warehouse: "AbstractWarehouse", query):
...
def test_select_from_values(warehouse: "AbstractWarehouse", query):
    result = list(warehouse.db.execute(query))
