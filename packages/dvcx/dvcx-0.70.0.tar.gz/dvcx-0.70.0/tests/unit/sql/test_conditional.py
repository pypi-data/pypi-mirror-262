...
from dvcx.sql import column, select, values
from dvcx.sql import literal as lit
from dvcx.sql.functions import greatest, least
...
def test_greatest(warehouse: "AbstractWarehouse", args, expected):
...
def test_least(warehouse: "AbstractWarehouse", args, expected):
...
def test_conditionals_with_multiple_rows(
    warehouse: "AbstractWarehouse", expr, expected
):
