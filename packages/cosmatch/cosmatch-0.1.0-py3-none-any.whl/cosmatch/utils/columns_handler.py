...
def add_postfix_to_main_columns(df: pd.DataFrame, postfix: Union[str], add_to_attrs: bool = True) -> None:
    """
    ...
    Args:
        ...
        postfix: Постфикс для добавляемых колонок. Может быть пустой строкой,\
