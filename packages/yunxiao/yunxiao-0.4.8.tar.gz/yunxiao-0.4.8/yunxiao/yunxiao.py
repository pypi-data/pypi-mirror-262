...
class YunXiao:
    ...
    def renew_auth(self):
        ...
        headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) "
                   ...
                   "Origin": "https://clouds.xiaogj.com",
                   "Yunxiao-Version": "3.44"}
        with requests.Session() as client:
            client.headers.update(headers)

            applogin = client.post(
                url="https://clouds.xiaogj.com/api/cs-crm/teacher/loginByPhonePwd",
                json={"_t_": timestamp(), "password": self.pwd, "phone": self.user, "userType": 1}
            ).json()["data"]["token"]

            headers["x3-authentication"] = client.get(
                url="https://clouds.xiaogj.com/api/cs-crm/teacher/businessLogin",
            ...
            weblogin = client.post(
                ...
                json={"_t_": timestamp(), "clientId": "x3_prd", "password": self.pwd, "username": self.user,
                      "redirectUri": "https://clouds.xiaogj.com/web/teacher/#/home/0",
                      "errUri": "https://clouds.xiaogj.com/web/simple/#/login-error"},
    ...
    def company_query_performance(self, startdate: str, enddate: str) -> list:
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-report/report/findDataReportList",
            json={
    ...
    def campus_query(self) -> list:
        ...
        return self.request(
            method="get",
            url="https://clouds.xiaogj.com/api/cs-crm/campus/list?type=2"
        )["data"]
    ...
    def teachers_query(self, page, size, name: str = "", status: tuple = (1,)):
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-crm/teacher/pageList",
            json={
                "_t_": timestamp(),
    ...
    def intentions_query(self, page, size, distributeStatus: int = 1, keyWord: str = "", level: int = "",
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-crm/intention/clue/allPage",
            json={
                "_t_": timestamp(),
    ...
    def intentions_query_students(self, page, size, distributeStatus: int = 1, keyWord: str = "", level: int = "",
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-crm/student/listForIntentionManage",
            json={
                "_t_": timestamp(),
                "distributeStatus": distributeStatus,
                "campusIds": self.campus,
    ...
    def students_query(self, page, size, curriculumids: tuple = (), classids: tuple = (), student_ids: tuple = (),
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-crm/student/extendList",
            json={
                "_t_": timestamp(),
                "campusIds": self.campus,
    ...
    def students_query_cards(self, page: int, size: int, display_history: bool = True, fee_warn_status: int = 0,
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/studentCourseCard/report",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def students_query_course_fee(self, page: int, size: int, displayHistory: bool = True,
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findStudentCourseFee",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def students_query_course_amount(self, page: int, size: int, displayHistory: bool = True,
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findStudentCourseAmount",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def student_query_info(self, student_id: int):
        ...
        return self.request(
            method="get",
            url="https://clouds.xiaogj.com/api/cs-pc-crm/student/detail",
            params={
                "_t_": timestamp(),
                "id": student_id,
                "queryMember": True,
    ...
    def student_query_cards(self, studentid: int) -> list:
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/studentCard/list",
            json={
                "_t_": timestamp(),
                "studentId": studentid
            }
    ...
    def student_query_course(self, studentid: int) -> list:
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/courseStudent/findStudentAttendCourse",
            json={
                "_t_": timestamp(),
                "studentId": studentid,
    ...
    def student_operation_become_history(self, studentlist: tuple):
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/student/becomeHistory",
    ...
    def student_operation_become_study(self, studentlist: tuple):
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/student/becomeStudy",
            json={"_t_": timestamp(), "studentIds": list(studentlist)}
        )
    ...
    def curriculums_query(self, page: int, size: int, searchname: str = None):
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/curriculum/page",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
    ...
    def arranges_query(self, page, size, starttime: str, endtime: str, classid: int = "", teacherids: tuple = (),
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/arrange/page",
            json=data
        )
    ...
    def classes_query(self, page, size, teacherids: tuple = (), class_ids: tuple = (), class_status: tuple = ()):
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/classInfo/page",
            json={
                "_t_": timestamp(),
                "queryClassTime": 1,
                "campusIds": self.campus,
    ...
    def class_query_info(self, classid: int = None) -> dict:
        ...
        return self.request(
            method="get",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/classInfo/getClassInfoVo",
            params={
                "_t_": timestamp(),
                "classId": classid
            }
    ...
    def class_query_student(self, classid: int, inout: int = 1) -> list:
        ...
        return self.request(
            method="get",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/classStudent/queryClassStudentList",
    ...
    def charges_query_record(self, page, size, startdate: str, enddate: str, class_id: int = None,
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findCourseSignCharge",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def charges_query_detail_record(self, page, size, startdate: str, enddate: str, class_id: int = None,
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findCourseSignChargeDetail",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def orders_query_items(self, page, size, start_date: str = "", end_date: str = "", order_types: tuple = (),
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findOrderItemAll/page",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def payments_query_refund(self, page, size, startdate: str = "", enddate: str = ""):
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findPaymentRefundList",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def payments_query(self, page, size, startdate: str = "", enddate: str = "", revenue_type: int = "",
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findPaymentList",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def payments_query_record(self, page, size, startdate: str = "", enddate: str = "",
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findPaymentAccountCustomRecord",
            json={
                "_t_": timestamp(),
                "paymentAccountCustomIds": [],
                "page": {"pageNum": page, "pageSize": size},
    ...
    def payments_query_receipt(self, orderinfo_id: int, payment_groupid: int) -> dict:
        ...
        return self.request(
            method="get",
            url="https://clouds.xiaogj.com/api/cs-pc-edu/public/receipt/findReceipt",
            params={
    ...
    def payments_query_achievements_datarange(self, page, size, startdate: str = "", enddate: str = "",
        ...
        return self.request(
            method="post",
            url="https://clouds.xiaogj.com/api/cs-pc-report/cs-report/reports/findAchievementBelongerDetail",
            json={
                "_t_": timestamp(),
                "page": {"pageNum": page, "pageSize": size},
                "campusIds": self.campus,
    ...
    def comefroms_query(self):
        return self.request(
            method="get",
            url=f"https://clouds.xiaogj.com/api/cs-crm/customField/get",
