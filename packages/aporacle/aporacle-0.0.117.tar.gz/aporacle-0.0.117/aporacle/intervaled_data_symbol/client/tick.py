...
class Tick(KomoBase):
    ...
    def __init__(self, symbol: str, stamp: int, ttl: int = 180):
        ...
        self.previous_returns_means: dict = {"coston": [], "flare": [], "songbird": []}
        ...
        self.returns: dict = {"coston": 0.0, "flare": 0.0, "songbird": 0.0}  # {chain: return}
    ...
    def summary(self) -> dict:
        base = {
            ...
            'return_coston_feature': round(self.returns['coston'], 8),
    ...
    def simple_moving_average(self, metric: str):
        ...
        if metric == 'prices':
            ...
            for chain in ['coston', 'flare', 'songbird']:
                # Create a numpy array from the values
    ...
    def finalize_returns(self, previous_returns_means=None):
        if previous_returns_means is None:
            previous_returns_means = {"coston": [], "flare": [], "songbird": []}
