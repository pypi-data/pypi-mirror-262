...
setup(
    name='ezipset',
    version='0.9.0',
    description='ezIPSet is a pure Python library to manipulate IPSet rules. Uses ctypes and libipset.so, it\'s incredibly fast!',
    ...
    project_urls={
        ...
        "Latest Release": "https://github.com/rabuchaim/ezIPSet/releases/latest",
    },    
