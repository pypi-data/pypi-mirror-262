...
def process_response(responseType, payload):
    if responseType == "message":
        return call_send_api(message(payload))
    elif responseType == "post_back":
        return call_send_api(post_back(payload))
    elif responseType == "quick_reply":
        return call_send_api(quick_reply(payload))
    else:
