...
# NOTE: for SLA purpose
DEEPYTORCH_COMMITID = "aa0d77"
_root_path_deepgpu = "https://aiacc.oss-cn-beijing.aliyuncs.com/"
_root_path_deepytorch = f"{_root_path_deepgpu}/deepytorch/dev/{DEEPYTORCH_VERSION}/{DEEPYTORCH_COMMITID}/"
...
class PostInstallCommand(install):
    ...
    def run(self):
        ...
        pkg = f"{_root_path_deepytorch}" \
            ...
            f"linux_x86_64.whl"
        os.system(f'echo "install deepytorch: {pkg}" >> {_temp_log}')
        ...
        if res.returncode == 0:
            ...
            while(count != 0):
                ...
                if res.returncode == 0:
                    ...
                    count -= 1
            if res.returncode != 0:
                os.system(f'echo "install deepytorch failed! {res.stderr}" >> {_temp_log}')
