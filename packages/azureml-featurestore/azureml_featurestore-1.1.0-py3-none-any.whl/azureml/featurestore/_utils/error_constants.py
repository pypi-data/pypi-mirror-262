...
INVALID_DERIVED_FEATURE_SET = "Index columns should be none for a derived feature set."
...
FEATURE_SET_SOURCE_VALIDATION = (
    "Invalid schema for feature source. Timestamp column should not be provided when source type is {}."
    + REFER_FEATURE_SET_SPEC_SCHEMA
)
