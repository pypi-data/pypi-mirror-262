...
# pre_conv_cfg, v08.23
conv1x1=dict(
    in_channels=1024, hid_channels=512, out_channels=1024,
    num_layers=2, kernel_size=1,
    with_bias=True, with_last_bn=False, norm_cfg=dict(type='BN'),  # ori
    with_last_dropout=0, with_avg_pool=False, with_residual=True)
# pre_attn_cfg, v08.23
embedded=dict(
...
pre_neck=dict(
    ...
    in_channels=1024, hid_channels=512, out_channels=128, num_layers=2, with_avg_pool=True)
