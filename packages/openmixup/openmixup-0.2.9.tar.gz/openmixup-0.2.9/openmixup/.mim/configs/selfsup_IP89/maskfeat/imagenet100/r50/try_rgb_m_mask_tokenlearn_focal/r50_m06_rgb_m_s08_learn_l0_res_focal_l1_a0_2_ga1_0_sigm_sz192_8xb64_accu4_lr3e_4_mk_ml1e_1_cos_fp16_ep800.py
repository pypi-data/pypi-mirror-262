_base_ = [
    '../../../../_base_/datasets/imagenet100/mim_rgb_m_s08_sz192_bs64.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        mask_layer=0, mask_token="learnable",  # no mask token
        num_stages=4,
    ...
    head=dict(
        ...
        loss=dict(type='RegressionLoss', mode='focal_l1_loss',
            loss_weight=1.0, reduction='none', alpha=0.2, gamma=1.0, residual=False),
        unmask_weight=0,
        fft_weight=0,
        fft_focal=False,
        fft_unmask_weight=0.,  # unmask in fft loss
        fft_reweight=False,
