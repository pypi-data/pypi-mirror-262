...
model = dict(
    ...
    auxi_mb_loss=None,  # v09.27, ["BCE", "infoNCE"]
    feat_pos_extend="both",  # 09.24, "interpolation", "expolation"
    mix_shuffle_no_repeat=True,  # v09.22, ok
    loss_weights=dict(
        decent_weight=["weight_mb_mask"], accent_weight=[],
        weight_bb_mix=1, weight_bb_ssl=1, weight_mb_main=1, weight_mb_auxi=0,
