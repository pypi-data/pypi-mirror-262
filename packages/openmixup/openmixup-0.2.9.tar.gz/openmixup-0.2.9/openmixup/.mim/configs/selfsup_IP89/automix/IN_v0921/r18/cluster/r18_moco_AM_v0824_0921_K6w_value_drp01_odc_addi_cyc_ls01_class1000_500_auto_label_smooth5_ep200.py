_base_ = '../../../../../base.py'
# model settings
num_classes = 1000  # add clustering ImageNet
...
model = dict(
    type='MOCO_AutoMix_V0824',  # 09.23 update
    pretrained=None,
    alpha=2,
    queue_len=65536,
    feat_dim=128,
    ...
    mask_adjust="auto_label",  # v09.15, OK
    mean_margin=0.05,  # v09.05, OK
    mask_smooth=5, # v09.13
    pre_one_loss=-1,  # v08.24 pre loss
    pre_mix_loss=-1,  # v08.24 pre loss
    lam_margin=0.10,
    mean_pos_loss=False,  # v09.23, try
    # mean_pos_loss=0.5,  # v09.23, try
    mix_shuffle_no_repeat=True,  # v09.22
    ...
    neck=dict(
        ...
        out_channels=128,
        with_avg_pool=True),
    # neck = dict(type='AvgPoolNeck')  # for feature extract
    ...
    clustering=dict(
        ...
        memory_bank=dict(
            ...
            min_cluster=500,  # for more uniform parition
            debug=False)
    ),
