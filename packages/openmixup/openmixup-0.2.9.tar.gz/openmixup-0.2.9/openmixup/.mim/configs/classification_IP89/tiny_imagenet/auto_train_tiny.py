...
def main():
    # 10.11, baselines
    base_path = "configs/classification/tiny_imagenet/mixup/r18_mixups_v1011_CE_use_sigm.py"
    ...
    model_var = {
        ...
        'model.head.two_hot_mode': ['none'],
        # 'model.head_mix.two_hot': [True],
        'model.mix_mode': ['mixup', 'cutmix', 'saliencymix', 'fmix', 'resizemix', 'manifoldmix'],
        # 'model.alpha': [1,],
    ...
    gm_var = {
        ...
        'model.alpha': [0.2, 1, 2],
        # 'model.alpha': [0.1, 0.2, 0.3, 0.5, 2, 4],
        # 'model.mix_block.mask_loss_mode': ["L1+Variance", "Variance"],
        # 'model.mix_block.mask_loss_mode': ["L1+Variance",],  # OK
        # 'model.mix_block.mask_loss_mode': ["Variance",],  # OK
        # 'model.mask_adjust': [0.25, 1,],
        # 'model.mask_adjust': [0.25,],  # OK
        # 'model.mix_block.lam_mul_k': [0, 0.25, 0.5, 1],
        # 'model.mix_block.lam_mul_k': [0.25, 0.5],  # tiny ok
        # 'model.head.two_hot_thr': [0.6, 0.7, 0.8, 0.9, 1],
        # 'model.head.two_hot_idx': [0.5, 1, 2,],
        # 'model.head.two_hot_idx': [1, ],
        'model.head.two_hot_scale': [0.25, 0.5, 1,],
        'total_epochs': [400,]
    }
