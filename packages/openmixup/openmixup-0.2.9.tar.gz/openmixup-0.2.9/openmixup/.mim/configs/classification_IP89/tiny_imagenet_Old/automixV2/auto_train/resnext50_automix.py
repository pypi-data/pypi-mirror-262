...
model = dict(
    ...
    mask_layer=2,
    grad_mode=None,
    momentum=0.996,  # try hook m
    mask_loss=0.,
    save=True,  # save gradCAM
    backbone_q=dict(  # mmclassification
    ...
    backbone_k=dict(  # mmclassification
        type='resnext_mixup_CIFAR',
        depth=50,
        mask_layer=2,
        num_stages=4,
    ...
    mix_block = dict(  # v05.12 automix
        type='PixelMixBlock_v0609', in_channels=1024, reduction=2, use_scale=True,
