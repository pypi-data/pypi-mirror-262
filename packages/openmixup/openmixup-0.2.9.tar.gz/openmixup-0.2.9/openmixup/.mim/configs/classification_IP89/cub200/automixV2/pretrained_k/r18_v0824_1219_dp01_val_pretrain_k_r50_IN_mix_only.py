...
model = dict(
    ...
    pretrained_k='work_dirs/classification/imagenet/automixV2/v0824/' + \
        'r50_v0824_L2_a2_bili_mul_x_cat_L1_var_01_value_minlr1e_3_lrmin0_ep100/epoch_100.pth',
    alpha=2.0,
    ...
    head_weights=dict(  # frozen mixblock losses, mix head only
        head_mix_q=1, head_mix_k=0, head_one_k=0),
)
