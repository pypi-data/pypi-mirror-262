...
train_pipeline = [
    dict(type='RandomResizedCrop', size=256, scale=[0.2, 1.0], interpolation=3),  # bicubic
    dict(type='RandomHorizontalFlip'),
    dict(type='RandAugment',
        policies=rand_increasing_policies,
        num_policies=2, total_level=10,
        magnitude_level=6, magnitude_std=0.5,  # RSB A3
        hparams=dict(
...
test_pipeline = [
    dict(type='Resize', size=300, interpolation=3),  # 0.85, better
