...
def main():
    ...
    # base_path = "configs/classification/cifar100/mixup/rx50_mixups_v1128_CE_use_soft.py"

    # 12.08
    base_path = "configs/classification/cifar100/mixup/r18_mixups_1209_CE_use_soft.py"
    # base_path = "configs/classification/cifar100/mixup/rx50_mixups_1209_CE_use_soft_wd5e_4.py"
    # base_path = "configs/classification/cifar100/mixup/rx50_mixups_1209_CE_use_soft.py"
    ...
    model_var = {
        ...
        # 'model.head.loss.use_mix_decouple': [True,],  # mixup baseline, 12.08
        ...
        #
        # 'model.mix_mode': ['mixup', 'cutmix', 'fmix', 'saliencymix', 'resizemix'],
        # 'model.mix_mode': ['cutmix', 'fmix', 'saliencymix',],
        # 'model.mix_mode': ['manifoldmix',],
        # 'model.mix_mode': ['saliencymix',],
    }
    gm_var = {
        # 'model.mix_mode': ['mixup', 'resizemix', ],
        'model.mix_mode': ['cutmix', 'fmix', 'saliencymix',],
        # 'model.alpha': [2, 4],
        'model.alpha': [0.2,],
        # 'model.alpha': [1,],
        ...
        # 'model.head.loss.use_lam': [True, ],  # mixup baseline, try
        # 'model.head.loss.use_eta': [1, 0.5, 0.1, 0.01],  # try use_eta for mix baselines
        # 'model.head.loss.use_eta': [0.5, 0.1, 0.01],  # try use_eta for mix
        # 'model.head.loss.use_idx': [-2, -1, -0.5],  # mixup, try
        # 'model.head.lam_idx': [0, 0.5],  # mixup baseline, try lam idx, 12.08
        # 'model.head.lam_idx': [0, ],  # mixup baseline, lam idx, 12.08
        # 'model.head.eta_weight.eta': [0.5, 0.1,],  # mixup baseline, try eta, 12.08
        # 'model.head.eta_weight.eta': [0.01, 0.1,],  # mixup baseline, try eta, 12.08
        # 'model.head.eta_weight.mode': ["less", "more",],  # mixup baseline, try eta biased
        # 'model.head.eta_weight.mode': ["both", ],  # mixup baseline, no eta biased
        # 'model.head.eta_weight.thr': [0.5],  # mixup baseline, try eta biased, 12.08
        'total_epochs': [400,]
        # 'total_epochs': [800,]
    }
