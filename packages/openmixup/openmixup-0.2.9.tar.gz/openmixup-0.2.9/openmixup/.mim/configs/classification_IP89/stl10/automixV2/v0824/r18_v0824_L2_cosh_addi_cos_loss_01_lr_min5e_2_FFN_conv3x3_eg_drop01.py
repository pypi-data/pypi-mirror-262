...
conv3x3=dict(
    ...
    with_bias=True, with_last_dropout=0.1, with_avg_pool=False, with_residual=True)
# pre_attn_cfg, v08.23
gaussian=dict(
...
# pre_head_cfg, v08.24
mix_head=dict(
    type='ClsMixupHead', with_avg_pool=True, in_channels=256, num_classes=10)
