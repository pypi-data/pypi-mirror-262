...
model = dict(
    ...
    mix_block = dict(  # automix.V1, v07.05
        ...
        in_channels=256, reduction=2, use_scale=True, mode='embedded_gaussian',
    ...
    head_one_k=dict(
        type='ClsHead', with_avg_pool=True, frozen=True, in_channels=512, num_classes=10),
    head_mix_k=dict(
        type='ClsMixupHead', with_avg_pool=True, frozen=True, in_channels=512, num_classes=10),
    )
