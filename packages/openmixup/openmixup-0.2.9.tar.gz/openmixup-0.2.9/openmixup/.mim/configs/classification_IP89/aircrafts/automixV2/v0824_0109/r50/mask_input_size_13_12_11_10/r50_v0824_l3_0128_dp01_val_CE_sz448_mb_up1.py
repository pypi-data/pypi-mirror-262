...
conv1x1=dict(
    type="ConvNeck",
    in_channels=2048, hid_channels=512, out_channels=1,  # MixBlock v
...
model = dict(
    ...
    mask_adjust=0,
    mask_input_size=[416, 384, 352, 320,],  # v01.18, 448=7x2x32, using 13, 6x2, 11, 5x2
    ...
    mix_block = dict(  # V2
        type='PixelMixBlock',
        in_channels=2048, reduction=2, use_scale=True, double_norm=False,
...
data = dict(
    imgs_per_gpu=4,  # try small bs in fine-grained
    workers_per_gpu=4,
