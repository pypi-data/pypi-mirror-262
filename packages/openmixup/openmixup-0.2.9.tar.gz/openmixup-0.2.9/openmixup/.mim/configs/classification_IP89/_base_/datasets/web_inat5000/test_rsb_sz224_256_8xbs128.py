...
# dataset settings
data_source_cfg = dict(type='ImageNet', return_label=False)  # submit to server

# ImageNet dataset
data_train_list = 'data/Web_iNat5000/meta/train_split_labeled.txt'
data_train_root = 'data/Web_iNat5000/'
# data_test_list = 'data/Web_iNat5000/meta/val_split_labeled.txt'
# data_test_root = 'data/Web_iNat5000/'
data_test_list = 'data/Web_iNat5000/meta/testa.txt'
data_test_root = 'data/Web_iNat5000/'
# data_test_list = 'data/Web_iNat5000/meta/testb.txt'
# data_test_root = 'data/Web_iNat5000/'

dataset_type = 'ClassificationDataset'
img_norm_cfg = dict(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
train_pipeline = [
    dict(type='RandomResizedCrop', size=224, scale=[0.2, 1.0], interpolation=3),  # bicubic
...
test_pipeline = [
    dict(type='Resize', size=300, interpolation=3),  # 0.85
