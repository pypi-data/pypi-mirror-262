...
model = dict(
    ...
    pretrained_k='work_dirs/classification/imagenet/automixV2/v0824_1110_IP127/r50/CE_q_soft_BCE_k/' + \
        'r50_v0824_l2_a2_bili_val_dp01_mul_x_cat_L1_var_01_use_soft_CE_q_soft_k_neg1__ep300/epoch_300.pth',
    alpha=2.0,
