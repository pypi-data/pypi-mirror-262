...
model = dict(
    ...
    mix_block = dict(  # automix, v06.09
        ...
        frozen=False),
    head_one_q=dict(
        type='ClsHead', with_avg_pool=True, in_channels=512, num_classes=100),
    head_mix_q=dict(
        type='ClsMixupHead', with_avg_pool=True, in_channels=512, num_classes=100),
    head_one_k=dict(
        type='ClsHead', with_avg_pool=True, frozen=True, in_channels=512, num_classes=100),
    head_mix_k=dict(
        type='ClsMixupHead', with_avg_pool=True, frozen=True, in_channels=512, num_classes=100),
    )
