...
model = dict(
    ...
    mix_block = dict(  # V2
        ...
        lam_concat=True, lam_concat_v=False,  # V1: lam cat q,k,v
        lam_mul=False, lam_residual=False, lam_mul_k=-1,  # lam: None
        value_neck_cfg=None,  # V2: None
        x_qk_concat=False, x_v_concat=False,  # x concat: None
...
optimizer = dict(type='SGD', lr=0.001, momentum=0.9, weight_decay=0.0005,
                paramwise_options={
                    'mix_block': dict(lr=0.01, momentum=0.)},)  # required parawise_option
# optimizer args
