...
def main():
    ...
    # 12.08, V2
    # base_path = "configs/classification/cifar10/automixV2/v0824_1208/r18_v0824_1128_l2_dp0_val_CE_use_soft_use_mix.py"
    # base_path = "configs/classification/cifar10/automixV2/v0824_1208/r18_v0824_1128_l2_dp01_val_CE_use_soft_use_mix.py"
    base_path = "configs/classification/cifar10/automixV2/v0824_1208/rx50_v0824_1128_l2_dp01_val_CE_use_soft_use_mix.py"
    ...
    # create nested dirs
    model_var = {
        # 'model.head_mix.loss.use_mix_decouple': [False,],  # automix, 12.08, V2
        'model.head_mix.loss.use_mix_decouple': [True,],  # automix, 12.08, V3
        # 'model.mix_block.unsampling_mode': ['bilinear',],
        # 'model.mix_mode': ['mixup', 'cutmix', 'saliencymix', 'fmix', 'resizemix', ],
        # 'model.mix_mode': ['mixup', 'cutmix', 'saliencymix', ],
    ...
    gm_var = {
        ...
        # 'model.head_mix_k.neg_weight': [0, 0.01, 0.1,],
        ##### OK, use_mix + eta (mixup) ####
        # 'model.head.two_hot_thr': [1],
        # 'model.head.loss.use_lam': [False, ],  # mixup baseline, OK
        # 'model.head.loss.use_eta': [0.5, 0.1, 0.01],  # try use_eta for mix baselines
        # ##### OK, use_mix + eta (automix) ####
        'model.head_mix.lam_idx': [0, 0.5],  # mixup baseline, try lam idx, 12.08
        'model.head_mix.eta_weight.eta': [1, 0.5, 0.1, 0.01],  # mixup baseline, try eta, 12.08
        'model.head_mix.eta_weight.mode': ["both",],  # mixup baseline, eta un-biased
        # 'model.head_mix.eta_weight.mode': ["more", "less", ],  # mixup baseline, try eta un-biased
        'model.head_mix.eta_weight.thr': [0.5],  # mixup baseline, try eta biased, 12.08
        #
        # 'model.mask_adjust': [0, 0.25],
        'model.mask_adjust': [0.25, ],
        # 'model.mix_block.lam_mul_k': [0, 0.25, 0.5, 1],
        'model.mix_block.lam_mul_k': [0.25, 1],
        # 'model.mix_block.lam_mul_k': [-1, 0.5],
        # 'model.mix_block.lam_mul_k': [1, ],
        ...
        # 'optimizer.lr': [0.03, 0.1, ],
        # 'optimizer.weight_decay': [1e-3, 5e-4, ],
        # 'optimizer.paramwise_options.mix_block.weight_decay': [1e-3, 5e-4, 1e-4, 0,],
        # 'lr_config.min_lr': [5e-2, 1e-2, 1e-3, 5e-3, ],
        'lr_config.min_lr': [1e-2,],
        # 'total_epochs': [400,]
        'total_epochs': [800,]
    }
