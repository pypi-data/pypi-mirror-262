...
model = dict(
    ...
    mix_block = dict(  # automix.V1, v07.05
        type='PixelMixBlock_V1',
        in_channels=1024, reduction=2, use_scale=True, mode='embedded_gaussian',
    ...
    head_mix_q=dict(
        type='ClsMixupHead', with_avg_pool=True, in_channels=2048, num_classes=10),
    head_one_k=dict(
        type='ClsHead', with_avg_pool=True, frozen=True, in_channels=2048, num_classes=10),
    head_mix_k=dict(
        type='ClsMixupHead', with_avg_pool=True, frozen=True, in_channels=2048, num_classes=10),
    )
