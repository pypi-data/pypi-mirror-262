...
model = dict(
    ...
    pretrained_k='work_dirs/classification/imagenet/automixV2/v0824_1110_IP127/r101/' + \
        'r101_v0824_l2_a2_bili_val_dp01_mul_x_cat_L1_var_01_use_soft_CE_q_soft_k_neg0_1_ep100/epoch_100.pth',
    alpha=2.0,
    ...
    backbone=dict(
        ...
        out_indices=(3,),
        style='pytorch'),
    backbone_k=dict(  # pretrained k: R101
        type='ResNet_mmcls',
        depth=101,
        num_stages=4,
