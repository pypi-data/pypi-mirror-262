...
Command(
    ...
    memory=None, complete=True, running=False, forget=False, keep_request=True, error=None
)
...
Command(
    ...
    memory=None, complete=False, running=True, forget=False, keep_request=True, error=None
)
