...
class MailActivations(Methods):
    ...
    def mailbox_get_fresh_id(self,
        ...
        json_data = super().mailbox_get_fresh_id(site, email, **kwargs)
        catch_error(json_data)
        return GetTaskId(**json_data)

    def mailbox_get_domains(self, **kwargs) -> Domains:
        json_data = super().mailbox_get_domains(**kwargs)
        catch_error(json_data)
    ...
    def mailbox_zones(self,
        ...
        json_data = super().mailbox_zones(popular, zones, site, **kwargs)
        catch_error(json_data)
