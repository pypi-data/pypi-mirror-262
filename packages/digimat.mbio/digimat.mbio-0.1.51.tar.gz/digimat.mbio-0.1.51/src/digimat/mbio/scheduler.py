    ...
    def reload(self):
                        ...
                        with io.StringIO(data) as f:
                            if self.loadcsv(f):
                                ...
                                try:
                                    ...
                                    if self.getLocalStorageDataHashCode(self.config.type)!=hcode:
                                        self.updateLocalStorageData(self.config.type, r.content)
                                except:
                                    pass
                    else:
        ...
        if self.config.type=='csv':
            if not self._reloadDataValid:
                ...
                try:
                    with open(self.getLocalStorageFilePath(self.config.type), 'r') as f:
                        if self.loadcsv(f):
                            self._reloadDataValid=True
                except:
                    pass
