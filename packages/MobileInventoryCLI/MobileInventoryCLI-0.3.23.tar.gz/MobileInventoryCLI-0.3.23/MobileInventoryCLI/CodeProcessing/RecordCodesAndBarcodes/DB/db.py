    ...
    def csv_values(self):
        ...
        for i in self.__table__.columns:
            ...
            if isinstance(value,str):
                value=value.replace("\n","$NEWLINECHAR$").replace("\t","$TABCHAR$").replace("#","$HASHTAGCHAR$")
            values.append(value)
...
{Fore.light_blue}$HASHTAGCHAR$ for {Fore.light_yellow}#{Style.reset} as {Fore.light_yellow}#{Style.reset} is csv delimiter
                    """)
        return values
