...
class DockerGame:
    def __init__(self, options):
        ...
        self.cache_main_data = utils.read_json('./datasets/cache_main_data.json')
    ...
    def init_map(self):
        self.cache_bill_map = utils.read_json('./datasets/cache_bill_map.json')
        self.cache_consignor_map = utils.read_json('./datasets/cache_consignor_map.json')
    ...
    def create_game(self):
        ...
        self.operation_list = self.operation_list
