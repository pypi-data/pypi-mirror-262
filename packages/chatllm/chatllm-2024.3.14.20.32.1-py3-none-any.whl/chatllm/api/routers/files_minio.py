...
from meutils.oss.minio_oss import client as minio_client
...
async def get_files(
    ...
    if api_key := auth and auth.credentials or None:
    ...
    #     "result": {
    #         "content_length": 521,
    #         "content_raw_length": 521,
    #         "file_id": "chatglm4/67a2b31f-1398-450b-9f43-a4ab11936e2e.pdf",
    #         "file_name": "xx.pdf",
    #         "file_size": 0,
    #         "file_url": "https://sfile.chatglm.cn/chatglm4/67a2b31f-1398-450b-9f43-a4ab11936e2e.pdf",
    #         "questions": [],
    #         "questions_usage": {},
    #         "summary": "",
    #         "summary_usage": {}
...
async def upload_files(
    ...
    elif purpose == Purpose.file_embedding:
        pass

    elif purpose == Purpose.file_upload:  # minio url
        return FileObject(
            ...
            bytes=file.size,
            created_at=int(time.time()),
            filename=file.filename,  # {"file_name": "", "file_url": "", "questions": [""], "summary": ""} # todo: 结构体
            object='file',
