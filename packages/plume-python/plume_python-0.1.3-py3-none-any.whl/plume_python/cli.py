...
def main():
    ...
    parser.add_argument("output_dir",
                        help="Output directory where all files will be saved. The directory is created if it does not exists.")
    ...
    parser.add_argument("--descriptors", "-d", nargs="*",
                        help="Descriptor name used for filtering which samples to output as CSV files. Short name will automatically be preprended (eg. TransformUpdatePosition -> plume.sample.unity.TransformUpdatePosition)")
