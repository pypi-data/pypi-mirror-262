...
try:
    ...
    verbose_proxy_logger.debug("Error importing enterprise: " + str(e))
    verbose_proxy_logger.debug(f"current working dir: {os.getcwd()}")
    verbose_proxy_logger.debugf("content in currnt working dir: {os.listdir()}")
