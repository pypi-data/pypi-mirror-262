...
try:
    ...
    print("current modules in litellm proxy")
    print(" ".join(list(sys.modules.keys())))

    print("modules in litellm.proxy")


    print("\nmodules in litellm.proxy:")
    for module_name in sys.modules:
        if module_name.startswith('litellm.proxy'):
            print(module_name)
