...
def slice_data_within_circadian(date, **kwargs):

    start_time = date.replace(hour=7, minute=0, second=0)
    end_time = start_time + datetime.timedelta(days=1)
    raw = slice_data_within(start_time, end_time, **kwargs)
...
def slice_data_within(start_time, end_time, animal,
    ...
    file_list = get_file_list(animal, path_in, start_time=start_time, end_time=end_time)
