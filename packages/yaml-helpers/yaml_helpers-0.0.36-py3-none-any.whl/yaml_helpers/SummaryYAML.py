...
class SummaryYAML:
    ...
    def _get_entity_info(self, entity_info, level=0, prefix='  ',include_description=True):
        entity_info_str = ''
    ...
    def get_all_entities_info_in_current_file(self, include_description=True):
        all_entities_info = ""
        ...
        for entity_info in entities_in_file:
            all_entities_info += self._get_entity_info(entity_info, include_description=include_description)
