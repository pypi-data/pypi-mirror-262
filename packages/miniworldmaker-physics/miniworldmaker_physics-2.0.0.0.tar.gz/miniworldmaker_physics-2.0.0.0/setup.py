...
setup(
    name="miniworldmaker_physics",
    version="2.0.0.0",
    description="Physics engine for miniworldmaker",
    ...
    package_dir={"miniworldmaker_physics_board": "miniworldmaker_physics_board"},
    install_requires=["miniworldmaker"],
