...
from httprunner_lite import exceptions, loader, utils
from httprunner_lite.models import FunctionsMapping, VariablesMapping
...
def get_mapping_function(
    ...
    if function_name in functions_mapping:
        ...
        from httprunner_lite.ext import uploader
