...
from httprunner_lite.response import ThriftResponseObject
from httprunner_lite.runner import ALLURE, HttpRunner
from httprunner_lite.step_request import (
...
def run_step_thrift_request(runner: HttpRunner, step: TStep) -> StepResult:
    ...
    if not runner.thrift_client:
        ensure_thrift_ready()
        from httprunner_lite.thrift.thrift_client import ThriftClient
