...
class ActivityPub:
    ...
    async def get_timeline(  # noqa: PLR0913 This method has this many arguments
        self: ActivityPubClass,
        local: bool = False,
        remote: bool = False,
        ...
        logger.debug("ActivityPub.get_timeline - url = %s", url)
        logger.debug("ActivityPub.get_timeline - params = %s", params)
        try:
