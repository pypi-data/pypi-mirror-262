...
import mlx.core
import typing
__all__ = ['fft', 'fft2', 'fftn', 'ifft', 'ifft2', 'ifftn', 'irfft', 'irfft2', 'irfftn', 'rfft', 'rfft2', 'rfftn']
def fft(a: mlx.core.array, n: int | None = None, axis: int = -1, stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
    ...
    """
def fft2(a: mlx.core.array, s: list[int] | None = None, axes: list[int] | None = [-2, -1], stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
    ...
    """
def fftn(a: mlx.core.array, s: list[int] | None = None, axes: list[int] | None = None, stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
            ...
            Returns:
                array: The DFT of the input along the given axes.
    """
def ifft(a: mlx.core.array, n: int | None = None, axis: int = -1, stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
    ...
    """
def ifft2(a: mlx.core.array, s: list[int] | None = None, axes: list[int] | None = [-2, -1], stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
    ...
    """
def ifftn(a: mlx.core.array, s: list[int] | None = None, axes: list[int] | None = None, stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
            ...
            Returns:
                array: The inverse DFT of the input along the given axes.
    """
def irfft(a: mlx.core.array, n: int | None = None, axis: int = -1, stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
    ...
    """
def irfft2(a: mlx.core.array, s: list[int] | None = None, axes: list[int] | None = [-2, -1], stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
    ...
    """
def irfftn(a: mlx.core.array, s: list[int] | None = None, axes: list[int] | None = None, stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
    ...
    """
def rfft(a: mlx.core.array, n: int | None = None, axis: int = -1, stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
    ...
    """
def rfft2(a: mlx.core.array, s: list[int] | None = None, axes: list[int] | None = [-2, -1], stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
            ...
            Returns:
                ...
                data type will be complex.
    """
def rfftn(a: mlx.core.array, s: list[int] | None = None, axes: list[int] | None = None, stream: None | mlx.core.Stream | mlx.core.Device = None) -> mlx.core.array:
    """
