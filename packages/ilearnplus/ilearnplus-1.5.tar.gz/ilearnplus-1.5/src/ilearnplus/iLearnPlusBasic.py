...
class ILearnPlusBasic(QTabWidget):
    ...
    def get_fasta_file_name(self):
        ...
        self.desc_fasta_file, ok = QFileDialog.getOpenFileName(self, 'Open', os.path.join(pPath, 'data'), 'Plan text (*.*)')
    ...
    def data_from_file(self):
        self.clust_file, ok = QFileDialog.getOpenFileName(self, 'Open', os.path.join(pPath, 'data'),
    ...
    def data_from_file_s(self):
        self.selection_file, ok = QFileDialog.getOpenFileName(self, 'Open', os.path.join(pPath, 'data'),
                                                              'CSV Files (*.csv);;TSV Files (*.tsv);;SVM Files(*.svm);;Weka Files (*.arff)')
    ...
    def data_from_file_ml(self, target='Training'):
        if target == 'Training':
            self.ml_panel_clear()
        file_name, ok = QFileDialog.getOpenFileName(self, 'Open', os.path.join(pPath, 'data'),'CSV Files (*.csv);;TSV Files (*.tsv);;SVM Files(*.svm);;Weka Files (*.arff)')
        if ok:
