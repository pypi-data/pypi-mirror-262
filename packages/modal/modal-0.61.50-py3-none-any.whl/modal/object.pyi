...
class _Object:
    ...
    async def _deduplication_key(self) -> typing.Union[typing.Hashable, None]:
        ...
...
class Object:
    ...
    class ___deduplication_key_spec(typing_extensions.Protocol):
        def __call__(self) -> typing.Union[typing.Hashable, None]:
            ...

        async def aio(self, *args, **kwargs) -> typing.Union[typing.Hashable, None]:
            ...
