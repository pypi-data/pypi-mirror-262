...
class APIKeyServicerMiddleware(Middleware):
    ...
    async def __Revoke(
        ...
        try:
            return await self._servicer.Revoke(
                context=context,
                state=state,
                request=request
            )
    ...
    async def __Authenticate(
        ...
        try:
            return await self._servicer.Authenticate(
                context=context,
                state=state,
                request=request
            )
...
resemble.cloud.v1alpha1.auth.auth_pb2.InvalidInputError        ]
    ...
    async def Revoke(
        ...
        return await self.writer(rsm_context_or_workflow).Revoke(
            request,
            rsm_idempotency,
            metadata=rsm_metadata,
        )
    ...
    async def Authenticate(
        ...
        *,
        ...
        return await self.reader(rsm_context_or_workflow).Authenticate(
            request,
            metadata=rsm_metadata,
        )
