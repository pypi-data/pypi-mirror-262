...
name_regex2 = r"^(?P<parent_type>.+?)s/(?P<parent_name>.+?)/(?P<object_type>.+?)s/(.+?)$"

name_regex3 = r"^workspaces/(?P<workspace_id>.+?)/(?P<parent_type>.+?)s/" \
...
def get_name_regex1(object_name):
    ...
    n.parent_name = "workspaces/" + n.workspace_id + "/" + n.parent_type + "s/" + m.group("parent_name")
    return n
...
def get_name_regex3(object_name):
    ...
    n.parent_name = "workspaces/" + n.workspace_id + "/" + n.parent_type + 's/' + n.parent_name
