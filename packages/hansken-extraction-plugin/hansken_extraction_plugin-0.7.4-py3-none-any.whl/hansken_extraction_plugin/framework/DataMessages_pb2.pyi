...
class RpcPluginInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["author", b"author", "id", b"id", "resources", b"resources"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["apiVersion", b"apiVersion", "author", b"author", "deferredIterations", b"deferredIterations", "description", b"description", "id", b"id", "license", b"license", "matcher", b"matcher", "maturity", b"maturity", "name", b"name", "resources", b"resources", "type", b"type", "version", b"version", "webpageUrl", b"webpageUrl"]) -> None: ...
...
class RpcPluginIdentifier(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["category", b"category", "domain", b"domain", "name", b"name"]) -> None: ...
...
class RpcAuthor(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["email", b"email", "name", b"name", "organisation", b"organisation"]) -> None: ...
...
class RpcPluginResources(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["maxCpu", b"maxCpu", "maxMemory", b"maxMemory", "maxWorkers", b"maxWorkers"]) -> None: ...
...
class RpcTrace(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "properties", b"properties", "tracelets", b"tracelets", "transformations", b"transformations", "types", b"types"]) -> None: ...
...
class RpcDataStreamTransformation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dataType", b"dataType", "transformations", b"transformations"]) -> None: ...
...
class RpcSearchTrace(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data", "id", b"id", "properties", b"properties", "types", b"types"]) -> None: ...
...
class RpcDataContext(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data", "dataType", b"dataType"]) -> None: ...
...
class RpcRandomAccessDataMeta(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["firstBytes", b"firstBytes", "size", b"size", "type", b"type"]) -> None: ...
...
class RpcTransformation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["rangedTransformation", b"rangedTransformation", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["rangedTransformation", b"rangedTransformation", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["rangedTransformation"] | None: ...
