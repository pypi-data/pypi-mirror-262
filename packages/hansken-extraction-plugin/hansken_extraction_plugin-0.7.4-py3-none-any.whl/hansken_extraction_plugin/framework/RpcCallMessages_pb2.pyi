...
class RpcStart(google.protobuf.message.Message):
    ...
    *
    ...
    def HasField(self, field_name: typing_extensions.Literal["dataContext", b"dataContext", "trace", b"trace"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["dataContext", b"dataContext", "trace", b"trace"]) -> None: ...
...
class RpcPartialFinishWithError(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["actions", b"actions", "errorDescription", b"errorDescription", "statusCode", b"statusCode"]) -> None: ...
...
class RpcRead(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["count", b"count", "dataType", b"dataType", "position", b"position", "traceId", b"traceId", "traceUid", b"traceUid"]) -> None: ...
...
class RpcBeginDataStream(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dataType", b"dataType", "traceId", b"traceId"]) -> None: ...
...
class RpcWriteDataStream(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data", "dataType", b"dataType", "traceId", b"traceId"]) -> None: ...
...
class RpcSearchRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["count", b"count", "query", b"query"]) -> None: ...
...
class RpcSearchResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["totalResults", b"totalResults", "traces", b"traces"]) -> None: ...
