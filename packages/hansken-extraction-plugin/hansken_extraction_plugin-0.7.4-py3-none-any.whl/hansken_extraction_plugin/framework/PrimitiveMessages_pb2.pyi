...
class RpcZonedDateTime(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["epochSecond", b"epochSecond", "nanoOfSecond", b"nanoOfSecond", "zoneId", b"zoneId", "zoneOffset", b"zoneOffset"]) -> None: ...
