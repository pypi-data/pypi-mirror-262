...
class rbmClassification:
    ...
    def classificationSco(score, ytest, predictions, target_names):
        ...
        return [accuracyScore, atopic_dermatitis[0], dyshidrotic_eczema[0], nummular_dermatitis[0], atopic_dermatitis[2], dyshidrotic_eczema[2], nummular_dermatitis[2], atopic_dermatitis[3], dyshidrotic_eczema[3], nummular_dermatitis[3],accuracy, macro_avg[0], macro_avg[1], macro_avg[2], macro_avg[3], weighted_avg[0],weighted_avg[1], weighted_avg[2], weighted_avg[3]]
