...
def data_analysis_QE(filter_query,analyses_parameters):
    measurements_alignment = mr.get_measurements(filter_query=filter_query, measurement_type="fiber_alignment",catalog_endpoint='dev')
    measurements_iv_light = mr.get_measurements(filter_query=filter_query, measurement_type="light_iv_sweep",catalog_endpoint='dev')
    measurements_iv_dark = mr.get_measurements(filter_query=filter_query, measurement_type="dark_iv_sweep",catalog_endpoint='dev')
    measurements_polarization = mr.get_measurements(filter_query=filter_query, measurement_type="polarization_maximization",catalog_endpoint='dev')
    data_array_QE = []
    count = 0
