        ...
        "connection-types": [
            {
                ...
                "hook-class-name": "providers.azure.hooks.azure_databricks.AzureDatabricksSqlHook",
            },
            {
                "connection-type": "azure_databricks_volume",
                "hook-class-name": "providers.azure.hooks.azure_databricks.AzureDatabricksVolumeHook",
            },
            {
                "connection-type": "azure_file_share_sp",
                "hook-class-name": "providers.azure.hooks.azure_file_share.AzureFileShareServicePrincipalHook",
            },
        ],
        "extra-links": [],
    }
