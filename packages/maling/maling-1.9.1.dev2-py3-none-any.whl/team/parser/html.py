...
class Parser(HTMLParser):
    MENTION_RE = re.compile(r"tg://nlx\?id=(\d+)")
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag in ["b", "strong"]:
            ...
            if mention:
                ...
                extra["nlx_id"] = int(mention.group(1))
            else:
            ...
            if isinstance(entity, raw.types.InputMessageEntityMentionName):
                try:
                    if self.client is not None:
                        entity.nlx_id = await self.client.resolve_peer(entity.nlx_id)
    ...
    def unparse(text: str, entities: list):
        def parse_one(entity):
            ...
            if entity_type in (
                ...
                nlx = entity.nlx
                start_tag = f'<a href="tg://nlx?id={nlx.id}">'
                end_tag = "</a>"
