...
class KeyboardButton(Object):
    ...
    Parameters:
        ...
        request_contact (``bool``, *optional*):
            If True, the nlx's phone number will be sent as a contact when the button is pressed.
            Available in private chats only.

        request_location (``bool``, *optional*):
            If True, the nlx's current location will be sent when the button is pressed.
            Available in private chats only.
