...
async def get_chunk(
    ...
    r = await client.invoke(
        raw.functions.messages.Search(
            ...
            max_id=0,
            from_id=(
                await client.resolve_peer(from_nlx)
                if from_nlx
                else None
            ),
            hash=0
...
class SearchMessages:
    ...
    async def search_messages(
        ...
        Parameters:
            ...
            from_nlx (``int`` | ``str``, *optional*):
                Unique identifier (int) or nlxname (str) of the target nlx you want to search for messages from.
        ...
        Example:
            .. code-block:: python
                ...
                async for message in app.search_messages(chat, "hello", from_nlx="me"):
                    print(message.text)
        """
