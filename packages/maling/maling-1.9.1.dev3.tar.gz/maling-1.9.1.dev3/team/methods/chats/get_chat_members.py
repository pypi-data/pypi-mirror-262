...
async def get_chunk(
    ...
    nlxs = {u.id: u for u in r.nlxs}
    chats = {c.id: c for c in r.chats}

    return [types.ChatMember._parse(client, member, nlxs, chats) for member in members]
    ...
    async def get_chat_members(
        ...
        if isinstance(peer, raw.types.InputPeerChat):
            ...
            for member in members:
                yield types.ChatMember._parse(self, member, nlxs, {})
