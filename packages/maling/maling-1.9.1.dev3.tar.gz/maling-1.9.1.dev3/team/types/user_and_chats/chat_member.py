...
class ChatMember(Object):
    ...
    Parameters:
        ...
        nlx (:obj:`~team.types.User`, *optional*):
        ...
        until_date (:py:obj:`~datetime.datetime`, *optional*):
            ...
            Date when restrictions will be lifted for this nlx.

        invited_by (:obj:`~team.types.User`, *optional*):
            Administrators and self member only. Information about the nlx who invited this member.
            In case the nlx joined by himself this will be the same as "nlx".

        promoted_by (:obj:`~team.types.User`, *optional*):
            Administrators only. Information about the nlx who promoted this member as administrator.

        restricted_by (:obj:`~team.types.User`, *optional*):
            Restricted and banned only. Information about the nlx who restricted or banned this member.

        is_member (``bool``, *optional*):
            Restricted only. True, if the nlx is a member of the chat at the moment of the request.

        can_be_edited (``bool``, *optional*):
            True, if the you are allowed to edit administrator privileges of the nlx.

        permissions (:obj:`~team.types.ChatPermissions`, *optional*):
            Restricted only. Restricted actions that a non-administrator nlx is allowed to take.
    ...
    def _parse(
        ...
        if isinstance(member, raw.types.ChatParticipant):
            return ChatMember(
                ...
                nlx=types.User._parse(client, nlxs[member.nlx_id]),
                joined_date=utils.timestamp_to_datetime(member.date),
                invited_by=types.User._parse(client, nlxs[member.inviter_id]),
                client=client
            )
        ...
        if isinstance(member, raw.types.ChannelParticipant):
            ...
            return ChatMember(
                ...
                nlx=types.User._parse(client, nlxs[member.nlx_id]),
                joined_date=utils.timestamp_to_datetime(member.date),
                promoted_by=types.User._parse(client, nlxs[member.promoted_by]),
                invited_by=(
                    types.User._parse(client, nlxs[member.inviter_id])
            ...
            nlx = (
                types.User._parse(client, nlxs[peer_id])
            ...
            return ChatMember(
                ...
                restricted_by=types.User._parse(client, nlxs[member.kicked_by]),
