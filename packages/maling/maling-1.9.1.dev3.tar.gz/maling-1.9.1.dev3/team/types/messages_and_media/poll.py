...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        total_voter_count (``int``):
            Total number of nlxs that voted in the poll.
        ...
        explanation (``str``, *optional*):
            Text that is shown when a nlx chooses an incorrect answer or taps on the lamp icon in a quiz-style poll,
            0-200 characters.

        explanation_entities (List of :obj:`~team.types.MessageEntity`, *optional*):
            Special entities like nlxnames, URLs, bot commands, etc. that appear in the explanation.
