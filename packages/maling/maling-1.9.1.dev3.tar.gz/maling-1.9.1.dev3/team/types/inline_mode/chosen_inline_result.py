...
class ChosenInlineResult(Object, Update):
    """A :doc:`result <InlineQueryResult>` of an inline query chosen by the nlx and sent to their chat partner.
    ...
    Parameters:
        ...
        from_nlx (:obj:`~team.types.User`):
            The nlx that chose the result.

        query (``str``):
            The query that was used to obtain the result.

        location (:obj:`~team.types.Location`, *optional*):
            Sender location, only for bots that require nlx location.
    ...
    @staticmethod
    def _parse(client, chosen_inline_result: raw.types.UpdateBotInlineSend, nlxs) -> "ChosenInlineResult":
        ...
        return ChosenInlineResult(
            ...
            from_nlx=types.User._parse(client, nlxs[chosen_inline_result.nlx_id]),
