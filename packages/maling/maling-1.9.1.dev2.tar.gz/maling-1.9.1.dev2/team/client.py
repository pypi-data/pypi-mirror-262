...
class Client(Methods):
    ...
    Parameters:
        ...
        proxy (``dict``, *optional*):
            ...
            E.g.: *dict(scheme="socks5", hostname="11.22.33.44", port=1234, nlxname="nlx", password="pass")*.
            The *nlxname* and *password* can be omitted if the proxy doesn't require authorization.
        ...
        takeout (``bool``, *optional*):
            ...
            Only available for nlxs, bots will ignore this parameter.
    ...
    async def fetch_peers(self, peers: List[Union[raw.types.User, raw.types.Chat, raw.types.Channel]]) -> bool:
        ...
        for peer in peers:
            ...
            if isinstance(peer, raw.types.User):
                ...
                nlxname = (
                    peer.nlxname.lower() if peer.nlxname
                    else peer.nlxnames[0].nlxname.lower() if peer.nlxnames
                    else None
                )
                phone_number = peer.phone
                peer_type = "bot" if peer.bot else "nlx"
            ...
            parsed_peers.append((peer_id, access_hash, peer_type, nlxname, phone_number))
    ...
    async def handle_updates(self, updates):
        ...
        if isinstance(updates, (raw.types.Updates, raw.types.UpdatesCombined)):
            is_min = any((
                await self.fetch_peers(updates.nlxs),
                await self.fetch_peers(updates.chats),
            ))

            nlxs = {u.id: u for u in updates.nlxs}
                    ...
                    if not isinstance(message, raw.types.MessageEmpty):
                        try:
                            ...
                            if not isinstance(diff, raw.types.updates.ChannelDifferenceEmpty):
                                nlxs.update({u.id: u for u in diff.nlxs})
                                chats.update({c.id: c for c in diff.chats})

                self.dispatcher.updates_queue.put_nowait((update, nlxs, chats))
    ...
    async def load_session(self):
        ...
        session_empty = any([
            ...
            await self.storage.nlx_id() is None,
        ...
        if session_empty:
            ...
            await self.storage.nlx_id(None)
