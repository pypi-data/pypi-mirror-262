...
class AddContact:
    async def add_contact(
        ...
        """Add an existing Telegram nlx as contact, even without a phone number.
        ...
        Parameters:
            ...
            share_phone_number (``bool``, *optional*):
                Whether or not to share the phone number with the nlx.
                Defaults to False.

        Returns:
            :obj:`~team.types.User`: On success the nlx is returned.
        ...
        Example:
            .. code-block:: python
                ...
                # Add contact by nlxname
                await app.add_contact("nlxname", "Bar")
        """
        r = await self.invoke(
            raw.functions.contacts.AddContact(
                id=await self.resolve_peer(nlx_id),
        ...
        return types.User._parse(self, r.nlxs[0])
