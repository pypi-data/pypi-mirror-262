...
class GetChat:
    async def get_chat(
        ...
        Information include current name of the nlx for one-on-one conversations, current nlxname of a nlx, group or
        channel, etc.
        ...
        Parameters:
            chat_id (``int`` | ``str``):
                ...
                Unique identifier for the target chat in form of a *t.me/joinchat/* link, identifier (int) or nlxname
                of the target channel/supergroup (in the format @nlxname).
        ...
        if isinstance(peer, raw.types.InputPeerChannel):
            ...
            r = await self.invoke(raw.functions.nlxs.GetFullUser(id=peer))
        else:
