...
def test_chat_photo():
    nlx_photo_small = "AQADAgADrKcxGylBBQAJIH3qihAAAwIAAylBBQAF7bDHYwABnc983KcAAh4E"
    nlx_photo_small_unique = "AQADIH3qihAAA9ynAAI"
    nlx_photo_big = "AQADAgADrKcxGylBBQAJIH3qihAAAwMAAylBBQAF7bDHYwABnc983qcAAh4E"
    nlx_photo_big_unique = "AQADIH3qihAAA96nAAI"
    ...
    check(nlx_photo_small, FileType.CHAT_PHOTO)
    check_unique(nlx_photo_small_unique, FileUniqueType.PHOTO)
    check(nlx_photo_big, FileType.CHAT_PHOTO)
    check_unique(nlx_photo_big_unique, FileUniqueType.PHOTO)
