...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    @staticmethod
    async def _parse(client: "team.Client", callback_query, nlxs) -> "CallbackQuery":
        message = None
        ...
        return CallbackQuery(
            ...
            from_nlx=types.User._parse(client, nlxs[callback_query.nlx_id]),
            message=message,
    ...
    async def answer(self, text: str = None, show_alert: bool = None, url: str = None, cache_time: int = 0):
        ...
        Parameters:
            text (``str``, *optional*):
                Text of the notification. If not specified, nothing will be shown to the nlx, 0-200 characters.
            ...
            url (``str`` *optional*):
                URL that will be opened by the nlx's client.
