...
class InlineQueryResultLocation(InlineQueryResult):
    ...
    By default, the location will be sent by the nlx. Alternatively, you can use *input_message_content* to send a
    ...
    Parameters:
        ...
        heading (``int``, *optional*):
            For live locations, a direction in which the nlx is moving, in degrees.
