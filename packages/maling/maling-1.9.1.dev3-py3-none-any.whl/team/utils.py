...
async def parse_messages(
    ...
    nlxs = {i.id: i for i in messages.nlxs}
    ...
    for message in messages.messages:
        parsed_messages.append(await types.Message._parse(client, message, nlxs, chats, replies=0))
...
async def parse_text_entities(
    ...
    if entities:
        # Inject the client instance because parsing nlx mentions requires it
