...
class EditChatInviteLink:
    async def edit_chat_invite_link(
        ...
        Parameters:
            chat_id (``int`` | ``str``):
                Unique identifier for the target chat or nlxname of the target channel/supergroup
                (in the format @nlxname).
        ...
        return types.ChatInviteLink._parse(self, r.invite, nlxs)
