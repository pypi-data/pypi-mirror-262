...
class GetChatJoinRequests:
    async def get_chat_join_requests(
        ...
        offset_date = 0
        offset_nlx = raw.types.InputUserEmpty()
        ...
        while True:
            ...
            offset_nlx = await self.resolve_peer(r.importers[-1].nlx_id)

            for i in r.importers:
                yield types.ChatJoiner._parse(self, i, nlxs)
