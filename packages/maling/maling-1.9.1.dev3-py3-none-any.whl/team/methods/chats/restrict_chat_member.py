    ...
    async def restrict_chat_member(
        ...
        Example:
            .. code-block:: python
                ...
                await app.restrict_chat_member(chat_id, nlx_id, ChatPermissions())
                ...
                await app.restrict_chat_member(chat_id, nlx_id,
                    ChatPermissions(can_send_messages=True))
        """
        r = await self.invoke(
            raw.functions.channels.EditBanned(
                channel=await self.resolve_peer(chat_id),
                participant=await self.resolve_peer(nlx_id),
                banned_rights=raw.types.ChatBannedRights(
                    ...
                    invite_nlxs=not permissions.can_invite_nlxs,
