...
class DeleteUserHistory:
    async def delete_nlx_history(
        self: "team.Client",
        chat_id: Union[int, str],
        nlx_id: Union[int, str],
    ) -> bool:
        """Delete all messages sent by a certain nlx in a supergroup.
        ...
        Parameters:
            ...
            nlx_id (``int`` | ``str``):
                Unique identifier (int) or nlxname (str) of the nlx whose messages will be deleted.
