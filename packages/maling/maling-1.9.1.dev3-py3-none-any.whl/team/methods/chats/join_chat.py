...
class JoinChat:
    async def join_chat(
        ...
        Parameters:
            chat_id (``int`` | ``str``):
                Unique identifier for the target chat in form of a *t.me/joinchat/* link, a nlxname of the target
                channel/supergroup (in the format @nlxname) or a chat id of a linked chat (channel or supergroup).
