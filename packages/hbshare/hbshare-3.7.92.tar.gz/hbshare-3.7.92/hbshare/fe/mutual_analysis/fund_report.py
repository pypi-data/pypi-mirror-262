...
class QuantitativeReport:
    ...
    def get_fund_info(self):
        ...
        scale = scale.rename(columns={'jjdm': 'FUND_CODE', 'bblb': 'REPORT_TYPE', 'jsrq': 'REPORT_DATE', 'ggrq': 'PUBLISH_DATE', 'zcjz': 'EQUITY'})
    ...
    def get_fund_company_info(self):
        ...
        company_fund_scale = company_fund_scale.rename(columns={'jjdm': 'FUND_CODE', 'bblb': 'REPORT_TYPE', 'jsrq': 'REPORT_DATE', 'ggrq': 'PUBLISH_DATE', 'zcjz': 'EQUITY'})
    ...
    def get_fund_scale(self):
        ...
        if len(self.compare_fund_code_list) > 0:
            ...
            compare_scale = compare_scale.rename(columns={'jjdm': 'FUND_CODE', 'bblb': 'REPORT_TYPE', 'jsrq': 'REPORT_DATE', 'ggrq': 'PUBLISH_DATE', 'zcjz': 'EQUITY'})
    ...
    def get_fund_manager_info(self):
        ...
        for manager_code in manager['MANAGER_CODE'].unique().tolist():
            ...
            funds_scale = funds_scale.rename(columns={'jjdm': 'FUND_CODE', 'bblb': 'REPORT_TYPE', 'jsrq': 'REPORT_DATE', 'ggrq': 'PUBLISH_DATE', 'zcjz': 'EQUITY'})
    ...
    def get_fund_achievement(self):
        ...
        # fund_benchmark = fund_benchmark.rename(columns={'jjdm': 'FUND_CODE', 'jsrq': 'CHANGE_DATE', 'bjjz': 'FUND_BENCHMARK', 'syzt': 'IS_NEW'})
