...
def fund_valuation_plot(date, pic_path):
    ...
    plt.legend(loc=8, bbox_to_anchor=(0.5, -0.35), ncol=3, frameon=False)
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.title('估值分布（PE）', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    ...
    plt.legend(loc=8, bbox_to_anchor=(0.5, -0.35), ncol=2, frameon=False)
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.title('估值分布（PB）', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xticks(rotation=45)
    plt.title('平均估值差（PE）', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xticks(rotation=45)
    plt.title('核心资产估值溢价（PE）', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xticks(rotation=45)
    plt.title('核心资产估值溢价（PB）', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
...
def fund_sector_plot(date, pic_path):
    ...
    plt.legend(loc=8, bbox_to_anchor=(0.5, -0.35), ncol=5, frameon=False)
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    ax.set_title('板块分布', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.legend(handles=h1 + h2, labels=l1 + l2, loc=8, bbox_to_anchor=(0.5, -0.35), ncol=2, frameon=False)
    ...
    ax1.set_ylabel('')
    ax2.set_ylabel('')
    plt.title('港股配置比例及估值', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
...
def fund_theme_plot(date, pic_path):
    ...
    plt.legend(loc=8, bbox_to_anchor=(0.5, -0.35), ncol=6, frameon=False)
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.title('主题分布', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
...
def fund_industry_plot(date, pic_path, n=2, industry_name_1st='食品饮料'):
    ...
    plt.legend(loc=8, bbox_to_anchor=(0.5, -0.4), ncol=6, frameon=False)
    plt.xticks(rotation=60)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.xlabel('')
    plt.ylabel('')
    plt.title('一级行业持仓统计', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xlabel('')
    plt.ylabel('')
    plt.title('一级行业持仓环比变化', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 10})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
...
def fund_market_value_plot(date, pic_path):
    ...
    plt.legend(loc=8, bbox_to_anchor=(0.5, -0.2), ncol=3, frameon=False)
    ax.set_ylim([0.0, 0.7])
    ax.set_xticklabels(labels=fund_mv1_latest.index, rotation=45)
    ax.yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.title('成分股占比变化', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.title('权重股占比变化', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
...
def fund_style_plot(date, pic_path):
    ...
    h1, l1 = ax1.get_legend_handles_labels()
    h2, l2 = ax2.get_legend_handles_labels()
    plt.legend(handles=h1 + h2, labels=l1 + l2, loc=8, bbox_to_anchor=(0.5, -0.3), ncol=3, frameon=False)
    ...
    plt.title('风格统计', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=False, left=False, bottom=False)
    ...
    plt.legend(handles=h1 + h2, labels=l1 + l2, loc=8, bbox_to_anchor=(0.5, -0.35), ncol=3, frameon=False)
    ax.set_ylim([0.0, 0.6])
    ...
    plt.title('细分风格统计', fontdict={'font': 'SimHei', 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=False, left=False, bottom=False)
