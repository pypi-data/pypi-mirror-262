...
setup(**{
    ...
    'install_requires': (
        ...
        'async_timeout~=4.0',
        'attrs>=20.3',
        'backend.ai-cli==24.03.0b1',
        'backend.ai-common==24.03.0b1',
        'backend.ai-kernel-binary==24.03.0b1',
        'backend.ai-kernel-helper==24.03.0b1',
        'backend.ai-kernel==24.03.0b1',
        'backend.ai-krunner-static-gnu==4.1.1',
        'backend.ai-plugin==24.03.0b1',
        'cachetools~=5.2.0',
        'callosum~=1.0.3',
        'cattrs~=22.2.0',
        'click~=8.1.7',
