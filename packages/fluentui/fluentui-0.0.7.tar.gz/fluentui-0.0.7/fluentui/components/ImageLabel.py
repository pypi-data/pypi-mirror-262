...
from PySide6.QtCore import QUrl, QByteArray, Qt, QSize, QBuffer, QIODevice, QEventLoop, QDateTime
...
class ImageLabel(Label):
    ...
    def __init__(self, src='', **kwargs):
        ...
        self.__reply: QNetworkReply | None = None
    ...
    def load(self, url: str | None = None, sync=False) -> None:
        if not url:
            return
    ...
    def __finished(self, path: Path, data: QByteArray | bytes | None) -> None:
