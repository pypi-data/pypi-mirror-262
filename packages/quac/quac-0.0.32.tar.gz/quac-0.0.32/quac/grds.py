...
__all__ = ['OriginTypes', 'OriginGuard', 'hashash', 'ishashable', 'hasorigin', 'isspecial', 'isnotspecial', 'isoptional',
           ...
           'isbool', 'isdict', 'isiter', 'isnan', 'isenum', 'istuple', 'notnone', 'isargs', 'istyping', 'isnotiterstr',
...
from typing import (
    ...
    ParamSpecArgs, ParamSpecKwargs, _UnionGenericAlias
)
...
from .cons import U1, U2, DUCK, LOAD, __HASH__, ALL_ATTRS, DEVICE_NAMES
from .cons import NIL, NDIM, SHAPE, KEYS, VALUES, __K__, __V__, __N__, __RETANNOT__, __KVTYPES__, __NAME__
from .type import T, O, P
from .prot import Hashable, NonStrBytesIterable, Origin, Special, NotSpecial
from .prot import DuckSpecProtocol, DuckModuleProtocol, DuckTypeProtocol, DeviceProtocol
