...
__all__ = ['iterable', 'itertype', 'iterq', 'listq', 'tupleq', 'nlen', 'len1', 'len2', 'len3', 'len4', 'npbool', 'boolic',
           ...
           'dim2', 'dim3', 'dim4', 'genset', 'setstr', 'setnum', 'kvdict', 'pttndict', 'annreturn', 'slicelike',
...
from quac.cons import (
    ...
    __D__, __LIT__, __LITNAME__, __EMPTYVAL__, __DEV__
)
...
class slicespec(Duck):
    ...
    -----
    slice : SliceFormats
        the default representations of a python slice, 
        i.e. `(start: int, stop: int, step: int)`
        
    coord : SliceFormats
        the coordinate repesentation of a python slice, 
        i.e. `(x0, y0, ...), (x1, y1, ...), ...`
    
    Examples
    -------- 
    >>> slices = (0, 5), (2, 10) # slice format: (x0, x1), (y0, y1)
    ... ascoord(slices) # convert to coordinate format
    ((0, 2), (5, 10)) 
    
    >>> coords = (0, 2), (5, 10) # coord format: (x0, y0), (x1, y1)
    ... asslice(coords) # convert to slice format
    ((0, 5), (2, 10))
    '''
