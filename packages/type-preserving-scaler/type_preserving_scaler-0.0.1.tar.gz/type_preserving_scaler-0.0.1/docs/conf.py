#!/usr/bin/env python
#
# type_preserving_scaler documentation build configuration file, created by sphinx-quickstart.
#
...
project = "type-preserving-scaler"
...
version = type_preserving_scaler.__version__
# The full version, including alpha/beta/rc tags.
release = type_preserving_scaler.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(type_preserving_scaler.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "type_preserving_scaler/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/type-preserving-scaler/blob/%s/%s" % (tag, filename)
...
html_theme_options = {
    ...
    # "github_user": "maximz",
    # "github_repo": "type-preserving-scaler",
    # "github_banner": True,
    # "github_type": "star",
    # "show_related": False,
    # "note_bg": "#FFF59C",
...
htmlhelp_basename = "type_preserving_scalerdoc"
...
latex_documents = [
    (
        master_doc,
        "type_preserving_scaler.tex",
        "type-preserving-scaler Documentation",
        author,
        "manual",
    ),
]
