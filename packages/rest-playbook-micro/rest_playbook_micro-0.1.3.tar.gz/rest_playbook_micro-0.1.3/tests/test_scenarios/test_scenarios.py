...
def test_scenario_mandatory_var():
    s = S("tests/test_scenarios/scenario_substitute.scenario")
    v = V("tests/test_scenarios/mandatory_test.vars")
...
def test_error_scenarios():
    s = S("tests/test_scenarios/file_test.scenario")
    v = V("tests/test_scenarios/file_test.vars")
