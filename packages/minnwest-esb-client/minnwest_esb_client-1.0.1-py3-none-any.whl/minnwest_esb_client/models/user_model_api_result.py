...
T = TypeVar("T", bound="UserModelApiResult")


@_attrs_define
class UserModelApiResult:
    """
    Attributes:
    ...
    data: Union[Unset, "UserModel"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = UserModel.from_dict(_data)

        user_model_api_result = cls(
