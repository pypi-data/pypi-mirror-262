...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/api/v1-q2/Account/accountTransferView",
    }
...
) -> Optional[Union[ProblemDetails, SoaAccountApiResult]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, SoaAccountApiResult]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, SoaAccountApiResult]
    """
