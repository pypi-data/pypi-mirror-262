...
@dataclass
class TypegraphFinalizeModeSimple:
    pass

@dataclass
class TypegraphFinalizeModeResolveArtifacts:
    value: Optional[ArtifactResolutionConfig]

TypegraphFinalizeMode = Union[TypegraphFinalizeModeSimple, TypegraphFinalizeModeResolveArtifacts]
...
class Core:
    ...
    def finalize_typegraph(self, caller: wasmtime.Store, mode: TypegraphFinalizeMode) -> Result[str, Error]:
        if isinstance(mode, TypegraphFinalizeModeSimple):
            variant31 = 0
            variant32 = 0
            variant33 = 0
            variant34 = 0
            ...
            variant39 = 0
            variant40 = 0
        elif isinstance(mode, TypegraphFinalizeModeResolveArtifacts):
            payload0 = mode.value
            if payload0 is None:
                variant22 = 0
                variant23 = 0
                ...
                if field is None:
                    ...
                    payload5 = field
                    ptr, len6 = _encode_utf8(payload5, self.component._realloc0, self.component._core_memory0, caller)
                    variant = 1
                    variant7 = ptr
                    variant8 = len6
                record9 = field3
                field10 = record9.migration_dir
                field11 = record9.action
                if field10 is None:
                    variant16 = 0
                    variant17 = 0
                    variant18 = 0
                    ...
                    variant18 = len15
                record19 = field11
                field20 = record19.create
                field21 = record19.reset
                variant22 = 1
                variant23 = variant
                variant24 = variant7
                variant25 = variant8
                ...
                variant27 = variant17
                variant28 = variant18
                variant29 = int(field20)
                variant30 = int(field21)
            variant31 = 1
            variant32 = variant22
            variant33 = variant23
            variant34 = variant24
            ...
            raise TypeError("invalid variant specified for TypegraphFinalizeMode")
        ret = self.component.lift_callee1(caller, variant31, variant32, variant33, variant34, variant35, variant36, variant37, variant38, variant39, variant40)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[str, Error]
        if load == 0:
            load41 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 4)
            load42 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 8)
            ptr43 = load41
            len44 = load42
            list = _decode_utf8(self.component._core_memory0, caller, ptr43, len44)
            expected = Ok(list)
        elif load == 1:
            ...
            for i55 in range(0, len54):
                ...
                ptr50 = load48
                len51 = load49
                list52 = _decode_utf8(self.component._core_memory0, caller, ptr50, len51)
                result.append(list52)
