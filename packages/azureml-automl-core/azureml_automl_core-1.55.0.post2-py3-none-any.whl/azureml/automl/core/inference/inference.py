...
spacy_english_tokenizer_url = "https://aka.ms/automl-resources/packages/en_core_web_sm-2.3.1.tar.gz"
AutoMLDNNPipPackagesList = ["pytorch-transformers==1.0.0", "spacy==2.3.9", spacy_english_tokenizer_url]
