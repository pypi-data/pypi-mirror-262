...
class TestFaceRecognition(unittest.TestCase):
    ...
    def test_face_rec_knn_add_face(self):
        engine_configs = EngineConfigurations({})
        engine_configs.add_configuration(AtomicEngineConfigurations.FACE_RECOGNITION_USE_DRONE_TO_CREATE_DATASET,
                                         "False")
    ...
    def test_face_rec_knn_recognize_face(self):
        image = cv2.imread(
            r'C:\Users\Public\projects\drone-buddy-library\dronebuddylib\atoms\facerecognition\resources\test_data\validation_data\malsha\malsha_14.jpg')
