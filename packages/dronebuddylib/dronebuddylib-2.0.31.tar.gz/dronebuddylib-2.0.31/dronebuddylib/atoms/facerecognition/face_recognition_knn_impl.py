...
class FaceRecognitionKNNImpl(IFaceRecognition):
    ...
    def __init__(self, engine_configurations: EngineConfigurations):
        ...
        self.use_drone = bool(configs.get(AtomicEngineConfigurations.FACE_RECOGNITION_USE_DRONE_TO_CREATE_DATASET.name,
                                          configs.get(
                                              AtomicEngineConfigurations.FACE_RECOGNITION_USE_DRONE_TO_CREATE_DATASET)))
    ...
    def remember_face(self, image=None, name=None, use_drone=False) -> bool:
        ...
        self.create_data_set(face_classifier, name, 0, 900, drone_instance)
        ...
        self.create_data_set(face_classifier, name, 1, 100, drone_instance)
        ...
        self.create_data_set(face_classifier, name, 2, 50, drone_instance)
    ...
    def create_memory(self):
        ...
        test_result = self.test_classifier()
        return test_result
