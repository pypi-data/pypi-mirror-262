...
@contextmanager
def suppress_system_exit() -> Generator:
...
def profile_my_function(func: Callable, *args, iterations: int = 100, **kwargs) -> None:
...
def calculate_cli_import_time() -> float:
    ...
    from regscale.regscale import cli  # flake8: noqa
