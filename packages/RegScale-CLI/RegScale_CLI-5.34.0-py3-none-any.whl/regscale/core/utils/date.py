...
def date_str(date_obj: Union[str, datetime.datetime, datetime.date]) -> str:
    """
    Convert a date/datetime object to a date string.

    :param Union[str, datetime.datetime, datetime.date] date_obj: The date/datetime object to convert.
...
def datetime_str(date_obj: Union[str, datetime.datetime, datetime.date]) -> str:
    """
...
def date_obj(
    date_str: Union[str, datetime.datetime, datetime.date]
...
def days_between(
    ...
    return [
        (date_obj(start) + datetime.timedelta(days=i)).strftime("%Y/%m/%d")
