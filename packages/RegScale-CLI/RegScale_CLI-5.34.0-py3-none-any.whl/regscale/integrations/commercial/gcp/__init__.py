        ...
        if any(
            ...
            control_ids = list(
                filter(
                    None,
                    [
                        self.control_implementation_map.get(str(cid).lower())
            ...
            for control_id in control_ids:
                ...
                if self.gcp_control_tests.get(control_id_str, {}).get(
                    gcp_finding.category
                ):
                    self.gcp_control_tests[control_id_str][gcp_finding.category][
                        "status"
                    ] = "Failed"
