...
def get_cpe_titles(
    search_str: str, lang: Optional[str] = "en", timeout: int = 30
) -> List[str]:
    """
...
def get_cpe_title_by_version(
    cpe_title_list: List[str], version: str, take_first=False
) -> Optional[str]:
    """
    ...
    :param bool take_first: whether to take the first title if no match is found
    :return: a CPE title
    :rtype: Optional[str]
    """
