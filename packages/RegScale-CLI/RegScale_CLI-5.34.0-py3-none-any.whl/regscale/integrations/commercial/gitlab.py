...
def get_regscale_issues(
    regscale_id: int, regscale_module: str, job_progress: Progress
) -> list:
...
def save_or_update_issues(
    gitlab_issues: list, regscale_issues: list, job_progress: Progress
) -> None:
...
def get_issues_from_gitlab(
    gitlab_url: str, gitlab_project_id: int, api_token: str, job_progress: job_progress
) -> list:
    ...
    :param str api_token: The GitLab API token to use
    :param job_progress: The progress object to use for updating
