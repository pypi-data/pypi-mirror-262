...
class Asset(RegScaleModel):
    ...
    @classmethod
    def get_map(cls, plan_id: int, key_field: str = "identifier") -> dict[str, "Asset"]:
        """
        ...
        assets = cast(
            List["Asset"], cls._handle_graph_response(response, child="asset")
        )
        return_assets = {}
        for asset in assets:
            ...
            if identifier:
                ...
                logger.error(f"Asset {asset} does not have a {key_field}.")
