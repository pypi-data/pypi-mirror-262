...
class ImplementationResults:
    ...
    :param stig_file_name: The name of the STIG file.
    :type stig_file_name: str
    """

    def __init__(self, stig_file_name, console):
        """
        Initializes an instance of ImplementationResults.
    ...
    def add_result(self, status):
        ...
        :param status: The status of the implementation.
        :type status: str
        """
    ...
    def get_total_implementations(self):
        """
