...
class DjangoModelProvider(BaseRecordProvider):
    ...
    def get_query_object_class(self):
        return QueryObject
    ...
    def get_record(self, key, query_object=None):
        ...
        """
        query_object = query_object if query_object else self.get_query_object_class()()
        try:
    ...
    def get_records(self, query_object):
        ...
        """
        assert isinstance(query_object, self.get_query_object_class())
        manager = self.get_manager(query_object)
