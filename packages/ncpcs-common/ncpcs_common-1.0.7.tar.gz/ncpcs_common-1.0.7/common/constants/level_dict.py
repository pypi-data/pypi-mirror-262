...
STANDARD_KEYWORD_MAP = {
    ...
    'Ⅰ期': {'1期', 'I期', 'Ⅰ期', '一期', '分期I', '分期Ⅰ', '分期 I', '分期 Ⅰ', '分期为I', '分期为Ⅰ', 'PRETEXT I',
            ...
            'I 期', 'Ⅰ 期', '分期I期', '分期Ⅰ期', '分期 I期', '分期 Ⅰ期', '分期为I期', '分期为Ⅰ期', 'Ｉ期', 'ＩＣ期', 'Ι期'},
    ...
    'Ⅲ期': {'3期', 'III期', 'Ⅲ期', '三期', 'ⅠII期', 'IⅠI期', 'IIⅠ期', 'IⅠⅠ期', 'ⅠIⅠ期', 'ⅠⅠI期', '分期III', '分期Ⅲ',
            ...
            '分期Ⅲ期', '分期 III期', '分期 Ⅲ期', '分期为III期', '分期为Ⅲ期', 'IIIS期', 'ⅢS期', 'IIIBS期', 'IIIAS期', 'III）期', '分期改为IIIS期', 'Ⅲ)期'},
    'Ⅳ期': {'4期', 'IV期', 'Ⅳ期', '四期', 'IⅤ期', 'ⅠV期', '分期IV', '分期Ⅳ', '分期 IV', '分期 Ⅳ', '分期为IV',
            ...
            '分期为IV期', '分期为Ⅳ期', 'ⅣEX期', 'IVS&期', 'IVAX期', 'ⅣBS期', 'IVBS期', 'IV）期', 'IV高期', 'ＩＶ期'},
    'Ⅴ期': {'5期', 'V期', 'Ⅴ期', '五期', '分期V', '分期Ⅴ', '分期 V', '分期 Ⅴ', '分期为V', '分期为Ⅴ', 'PRETEXT V',
            'PRETEXT Ⅴ', 'PRETEXTV', 'PRETEXTⅤ', 'PRETEXT-V', 'PRETEXT-Ⅴ', 'PRETEXT/POST-TEXT V', 'PRETEXT/POST-TEXT Ⅴ',
            'V 期','Ⅴ 期', '分期V期', '分期Ⅴ期', '分期 V期', '分期 Ⅴ期', '分期为V期', '分期为Ⅴ期'},
    'GROUP A期': {'A期', 'GROUP A', 'GROUPA', 'A 期', 'IIRCA'},
    'GROUP B期': {'B期', 'GROUP B', 'GROUPB', 'B 期', 'IIRCB'},
    'GROUP C期': {'C期', 'GROUP C', 'GROUPC', 'C 期', 'IIRCC'},
    'GROUP D期': {'D期', 'GROUP D', 'GROUPD', 'D 期', 'IIRCD'},
    'GROUP E期': {'E期', 'GROUP E', 'GROUPE', 'E 期', 'IIRCE'},
    'Ⅰ级': {'I级', 'WHO 1级', 'WHO1级', 'WHO  1级', 'Ⅰ级', 'WHO Ⅰ级', 'WHO I级', 'WHOⅠ级', 'WHOI级', 'WHO分型：Ⅰ级',
            ...
            'WHO分型：Ⅰ 级', 'WHO分型：I 级', 'WHO分级：Ⅰ 级', 'WHO分级：I 级', 'Ⅰ 级', 'I 级', 'WHO分型 1级', 'Ⅰ）级', 'WHO一级'},
    'Ⅱ级': {'II级', 'WHO 2级', 'WHO2级', 'WHO  2级', 'Ⅱ级', 'WHO Ⅱ级', 'WHO II级', 'WHOⅡ级', 'WHOII级', 'WHO分型：Ⅱ级',
            ...
            'WHO分型：Ⅱ 级', 'WHO分型：II 级', 'WHO分级：Ⅱ 级', 'WHO分级：II 级', 'Ⅱ 级', 'II 级', 'WHO分型 2级', 'WHO,2级'},
    'Ⅲ级': {'III级', 'WHO 3级', 'WHO3级', 'WHO  3级', 'Ⅲ级', 'WHO Ⅲ级', 'WHO III级', 'WHOⅢ级', 'WHOIII级',
            'WHO分型：Ⅲ级',
            'WHO分型：III级', 'WHO分级：Ⅲ级', 'WHO分级：III级', 'WHO分级：3级', 'WHO分级：3 级', 'WHO分型Ⅲ级',
            'WHO分型III级',
            'WHO分级Ⅲ级', 'WHO分级III级', 'WHO分型 Ⅲ级', 'WHO分型 III级', 'WHO分级 Ⅲ级', 'WHO分级 III级', 'WHO分级 3级',
    ...
    'Ⅳ级': {'IV级', 'WHO 4级', 'WHO4级', 'WHO  4级', 'Ⅳ级', 'WHO Ⅳ级', 'WHO IV级', 'WHO IV级', 'WHOⅣ级', 'WHOIV级',
            ...
            'WHO分型 4级', '四级', 'WHO,4级', 'WHO分型Ⅳ型', 'WHO分型，IV型', 'IVJ级', 'I-V-级', 'WHO4型'},
    ...
    'ⅠA1期': {'IA1期', 'ⅠA1期'},
    'ⅠA2期': {'IA2期', 'ⅠA2期'},
    'ⅠA期': {'1A期', 'I A期', 'IA期', 'ⅠA期', '一A期', '分期IA', '分期IA期'},
    'ⅠB1期': {'IB1期', 'ⅠB1期'},
    'ⅠB2期': {'IB2期', 'ⅠB2期'},
    'ⅠB3期': {'IB3期', 'ⅠB3期'},
    'ⅠB期': {'1B期', 'I B期', 'IB期', 'ⅠB期', '一B期', '分期IB', 'ⅠB 期', '分期IB期'},
    'ⅠE期': {'1E期', 'IE期', 'ⅠE期', '一E期'},
    'ⅡA1期': {'IIA1期', 'ⅡA1期'},
    'ⅡA2期': {'IIA2期', 'ⅡA2期'},
    ...
    'ⅡB期': {'2B期', 'IIB期', 'ⅡB期', '二B期', '分期IIB', 'II B 期', '分期为ⅡB', '分期为IIB', 'II B期', '分期IIB期', '分期为IIB期',
             '分期为ⅡB期', 'Ⅱ B期'},
    'ⅡC期': {'2C期', 'IIC期', 'ⅡC期', '二C期'},
    'ⅡE期': {'2E期', 'IIE期', 'ⅡE期', '二E期'},
    'ⅢA期': {'3A期', 'IIIA期', 'ⅢA期', '三A期'},
    'ⅢB期': {'3B期', 'IIIB期', 'ⅢB期', '三B期', '分期IIIB', '分期ⅢB', '分期 IIIB', '分期 ⅢB', '分期IIIB期', '分期ⅢB期',
             '分期 IIIB期', '分期 ⅢB期'},
    'ⅢC1期': {'IIIC1期', 'ⅢC1期', 'IIIC1P期'},
    'ⅢC2期': {'IIIC2期', 'ⅢC2期'},
    'ⅢC期': {'3C期', 'IIIC期', 'ⅢC期', '三C期'},
    'ⅣA期': {'4A期', 'IVA期', 'ⅣA期', '四A期', 'IV A期', 'IV A 期', '分期IVA期', '分期为IVA期'},
    'ⅣB期': {'4B期', 'IVB期', 'ⅣB期', '四B期', 'IV B期', 'IV B 期', '分期IVB期', '分期为IVB期'},
    'ⅣC期': {'4C期', 'IVC期', 'ⅣC期', '四C期', 'IV C期', 'IV C 期', '分期IVC期', '分期为IVC期'},
    'ⅣS期': {'4S期', 'IVS期', 'ⅣS期', '四S期', 'IV S期', 'IV S 期', '分期IVS期', '分期为IVS期', 'IV-S期', 'Ⅳ-S期'},
    '加速期': {'加速期'},
    '急变期': {'急变期'},
    '急性期': {'急性期'},
    '慢性期': {'慢性期'},
