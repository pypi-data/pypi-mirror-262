...
) -> Optional[Union[ProblemDetails, SoaAccountListApiResult]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, SoaAccountListApiResult]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, SoaAccountListApiResult]
    """
