...
@click.option('--ignore', '-i', default='.', help='ignore directory name')
    ...
    try:
        ...
        if filter:
            tags = {k.strip().lower(): v.strip() if isinstance(v, str) else
                    ...
                    if k.strip() in {'FileType', 'Identifier', 'Title', 'BookName', 'Author', 'Publisher', 'Creator', 'Date', 'Artist', 'TrackID', 'Album'}}
        return tags
