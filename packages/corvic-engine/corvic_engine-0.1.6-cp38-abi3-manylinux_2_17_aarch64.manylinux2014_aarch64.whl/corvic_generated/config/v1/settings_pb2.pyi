...
class Settings(_message.Message):
    __slots__ = ("load_dotenv", "config", "dev_mode", "metrics", "chat_server", "embedgen", "chat", "db", "ingest", "completion_models", "embedding_models", "huggingface", "retriever", "completion", "rockset", "google_identity_token", "check_name", "test_db", "workflow", "data_staging")
