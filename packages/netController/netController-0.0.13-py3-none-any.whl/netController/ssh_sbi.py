...
class NetworkDevice:
    ...
    def send_command(self, command:str):
        """
        Sends a command to the network device and returns the output.

        Args:
            command (str): The command to be sent to the network device.

        Returns:
            str: The output received from the network device.

        Raises:
            Exception: If there is an error sending the command.
