...
def plot_optical(
    ...
    >>> plot_optical("dspawpy_proj/dspawpy_tests/inputs/2.12/scf.h5", "AbsorptionCoefficient", 0, raw=True) # doctest:   +ELLIPSIS
    Reading .../dspawpy_proj/dspawpy_tests/inputs/2.12/scf.h5...
    >>> plot_optical("dspawpy_proj/dspawpy_tests/inputs/2.12/optical.json", "AbsorptionCoefficient", 0, raw=True) # doctest: +ELLIPSIS
