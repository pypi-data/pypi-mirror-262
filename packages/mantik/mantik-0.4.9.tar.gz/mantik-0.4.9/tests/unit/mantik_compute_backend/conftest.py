...
@pytest.fixture(scope="function")
def example_firecrest_config() -> compute_backend.config.core.Config:
    return compute_backend.config.core.Config(
        firecrest=compute_backend.config.firecrest.Firecrest(
            api_url="test-url",
...
@pytest.fixture(scope="function")
def example_firecrest_config_long_resources() -> (
...
@pytest.fixture()
def example_firecrest_config_for_python() -> compute_backend.config.core.Config:
    return compute_backend.config.core.Config(
        firecrest=compute_backend.config.firecrest.Firecrest(
            api_url="test-url",
            machine="test-machine",
