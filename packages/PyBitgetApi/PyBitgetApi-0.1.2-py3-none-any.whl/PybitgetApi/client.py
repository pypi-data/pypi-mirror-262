...
from PyBitgetApi.utils import utils
import PyBitgetApi.exceptions
import logger
...
class Client(object):
    ...
    def copy_get_history_trader_list(self):
        """
        ...
        :return:
        """
        return self._request_with_params(GET, BROKER_COPY_V2_URL + '/query-traders')

    def copy_get_history_trader_orders(self, traderId, productType, startTime, endTime):
        """
        ...
        """
        params = {}
        if traderId and productType and startTime and endTime:
    ...
    def copy_get_history_trader_pendings_orders(self, productType):
        """
