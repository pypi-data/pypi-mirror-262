...
class Attach:
    ...
    def _compose_hook(self, _module, _args):
        del self.module.__dict__.get('_parameters')[self.param_name]
        composed = self.proxy.forward()
        self.module.__class__.__mro__[-1].__setattr__(self.module, self.param_name, composed)

    def _decompose_hook(self, _module, _args, _output):
        self.module.__class__.__mro__[-1].__delattr__(self.module, self.param_name)
        self.module.__dict__.get('_parameters')[self.param_name] = self.proxy.param
