...
def initial_pops(n_repetitions, n_population, n_dimensions, x_lower, x_upper, type_pop, seeds):
    ...
    Args:
        ...
        x_upper (List or None): Upper limit of the design variables. 
                                Use None for combinatorial variables.
        type_pop (String): Type of population. Options: 'real code' or 'combinatorial code'.
...
def check_interval_01(x_i_old, x_lower, x_upper):
    """
    This function checks if a design variable is out of
    the limits established x_ lower and x_ upper and updates the variable if necessary.
...
def agent_selection(n_population, n, i_pop=False):
    ...
    Args:
        ...
        i_pop (Integer or Boolean):  Default is False (Selects n agents among all population). 
                        i_pop=Integer Selects n agents among all population, excluding i_pop agent.
...
def id_selection(n_dimensions, n, k_dimension=False):
    ...
    Args:
        ...
        k_dimension (Integer or Boolean):  Default is False (Selects n dimensions among all dimensions). 
                        k_dimension=Integer Selects n dimensions among all dimensions, excluding k dimension.
...
def mutation_01_hill_movement(obj_function, x_i_old, x_lower, x_upper,
    ...
    Hill Climbing movement.
    
    See documentation in https://wmpjrufg.github.io/METAPY/FRA_CO_MUTATION_01_HILL_MOVEMENT.html
...
def mutation_02_chaos_movement(obj_function, x_i_old, fit_i_old, x_lower, x_upper,
                                n_dimensions, alpha, n_tries, iteration, n_iter,
                                none_variable=None):
    """ 
    This function mutates a solution using a chaotic maps.
    
    See documentation in https://wmpjrufg.github.io/METAPY/FRA_CO_MUTATION_02_CHAOS_MOVEMENT.html
...
def mutation_03_de_movement(obj_function, x_r0_old, x_r1_old, x_r2_old, x_lower, x_upper,
                            n_dimensions, f, none_variable=None):
    """ 
    This function mutates a solution using a differential evolution mutation rand/1.
    
    See documentation in https://wmpjrufg.github.io/METAPY/FRA_CO_MUTATION_03_DE_MOVEMENT.html
...
def mutation_04_de_movement(obj_function, x_r0_old, x_r1_old, x_r2_old, x_r3_old, x_r4_old,
                            x_lower, x_upper, n_dimensions, f, none_variable=None):
    """ 
...
def mutation_05_de_movement(obj_function, x_r0_old, x_r1_old, x_best, x_lower, x_upper,
                            n_dimensions, f, none_variable=None):
    """ 
...
def mutation_06_de_movement(obj_function, x_r0_old, x_r1_old, x_r2_old, x_r3_old,
                            x_best, x_lower, x_upper, n_dimensions, f, none_variable=None):
    """ 
...
def mutation_07_de_movement(obj_function, x_i_old, x_r0_old, x_r1_old, x_r2_old,
                            x_best, x_lower, x_upper, n_dimensions, f, none_variable=None):
    """ 
