...
def hill_climbing_01(settings):
    ...
    Args:  
        ...
        settings[0] = setup: Algorithm setup
        setup keys:
        ...
        settings[1] initial population (List or METApy function): Users can inform the initial population or use initial population functions
        settings[2] seed (None or integer): Random seed. Use None for random seed
