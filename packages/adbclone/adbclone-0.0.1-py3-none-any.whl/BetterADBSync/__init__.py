...
from .SAOLogging import (FATAL, destination_counting_progress, log_tree,
                         logging_fatal, overall_progress, perror,
                         setup_root_logger, source_counting_progress,
                         truncate_path, live)
...
def main():
    ...
    completed_files, completed_size = 0, 0
    try:
