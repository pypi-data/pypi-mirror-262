...
class NearSynonym:
    def __init__(self):
        self.path_model_onnx = os.path.join(path_sys, "near_synonym/near_synonym_model/roformer_unilm_small.onnx")
        self.path_tokenizer = os.path.join(path_sys, "near_synonym/near_synonym_model/roformer_vocab.txt")
        self.path_ann = os.path.join(path_sys, "near_synonym/near_synonym_model/word2vec.ann")
    ...
    def near_antonym(self, word, topk=8, annk=256, annk_cpu=128, batch_size=32,
                     rate_ann=0.4, rate_sim=0.4, rate_len=0.2, rounded=4, is_debug=False):
        """   获取反义词   """
