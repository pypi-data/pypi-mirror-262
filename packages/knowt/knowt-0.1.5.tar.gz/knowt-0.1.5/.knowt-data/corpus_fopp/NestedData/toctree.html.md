...
::: {#nested-data-and-nested-iteration .section}
[17. ]{.section-number}Nested Data and Nested Iteration[¶](#nested-data-and-nested-iteration "Permalink to this heading"){.headerlink}
======================================================================================================================================

::: {.toctree-wrapper .compound}
[Nested Data and Nested Iteration]{.caption-text}

-   [17.1. Introduction: Nested Data and Nested
    Iteration](ListswithComplexItems.html){.reference .internal}
    -   [17.1.1. Lists with Complex
        Items](ListswithComplexItems.html#lists-with-complex-items){.reference
        .internal}
-   [17.2. Nested Dictionaries](NestedDictionaries.html){.reference
    .internal}
-   [17.3. Processing JSON results](jsonlib.html){.reference .internal}
-   [17.4. Nested Iteration](NestedIteration.html){.reference .internal}
-   [17.5. 👩‍💻 Structuring Nested
    Data](WPStructuringNestedData.html){.reference .internal}
-   [17.6. Deep and Shallow
    Copies](DeepandShallowCopies.html){.reference .internal}
-   [17.7. 👩‍💻 Extracting from Nested
    Data](WPExtractFromNestedData.html){.reference .internal}
    -   [17.7.1.
        Understand](WPExtractFromNestedData.html#understand){.reference
        .internal}
    -   [17.7.2.
        Extract](WPExtractFromNestedData.html#extract){.reference
        .internal}
    -   [17.7.3. Repeat](WPExtractFromNestedData.html#repeat){.reference
        .internal}
-   [17.8. Exercises](Exercises.html){.reference .internal}
    -   [17.8.1. Contributed
...
-   [[](../Sorting/ChapterAssessment.html)]{#relations-prev}
-   [[](ListswithComplexItems.html)]{#relations-next}
:::
