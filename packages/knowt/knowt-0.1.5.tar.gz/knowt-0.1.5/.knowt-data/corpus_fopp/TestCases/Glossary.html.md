...
::: {#glossary .section}
[18.9. ]{.section-number}Glossary[¶](#glossary "Permalink to this heading"){.headerlink}
========================================================================================

return value test[¶](#term-return-value-test "Permalink to this term"){.headerlink}

:   A return value test invokes a function on a particular set of inputs
    and checks whether the return value is the correct one for those
    inputs.

side effect test[¶](#term-side-effect-test "Permalink to this term"){.headerlink}

:   A side effect test invokes a function or method and then checks
    whether some object's contents were suitably transformed by the end
    of the execution of the function or method.

test case[¶](#term-test-case "Permalink to this term"){.headerlink}

:   An assertion about the state of the program at particular point in
    its execution, such as the type of a variable or of a value returned
    by a function.
:::
...
-   [[](WPProgramDevelopment.html)]{#relations-prev}
