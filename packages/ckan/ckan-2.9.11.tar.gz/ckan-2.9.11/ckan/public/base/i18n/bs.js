{
  ...
  "Input is too short, must be at least one character": [
    ...
    "Unos je prekratak, mora sadržavati najmanje %(num)ddva znaka",
  ...
  "Unable to authenticate upload": [
    null,
    "Nije moguće izvršiti autentifikaciju učitavanja"
  ],
  ...
  "You are uploading a file. Are you sure you want to navigate away and stop this upload?": [
    null,
    "U toku je učitavanje datoteke. Jeste li sigurni da želite otići sa ove stranice i prekinuti učitavanje?"
  ],
