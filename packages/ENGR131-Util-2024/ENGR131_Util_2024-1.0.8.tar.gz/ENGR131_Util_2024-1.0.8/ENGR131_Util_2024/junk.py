...
class ReadingPythonQuestion_f2024(ReadingPython):
   ...
   def __init__(self,
            ...
            solutions = {"comment" : [b'gAAAAABl9y_e_CICreAJ_Acvub2ImnPY9B3l2X4_Ve0nadJ6gRCxXQARRMueiusY44_4f1LkkLuH3zQiA2Iitq_hgMFLAamriwP2rdpkeo-beyHVRnvlJ7z5R2CZJkIoknP5lXYUSVAF7ZE7mG9HRETtcEVvVueICQ==',
            b'gAAAAABl9y_edYmA5bzWHn4YnfxrVthBzeDHOju4epajA0OP9h2c2GitV8LJB9lyE0ughAYR_0nLIxZsbGe0-Uj-nIdVrah3mRU9ZQfshVwLJWG0ZDk-WQKfrFH9L1grlUFnZLYZsjbOQSdd5uX42ZXS8asPqjdGwg==',
            b'gAAAAABl9y_eQOPgizoQVqCMPEWdyIDhWKIjnIYAY2DRAYAX8PMQxOIffuQmW_KS0h1mrvlHh2YsEv3ePG2f83RWVqaeC46Aw59OhxTUXpKU_ftLytRt3WMcfS9gWZf5g1HY5Ez2rbZe6-w9qLhKoex9x4ZZSQKNuA==',
            b'gAAAAABl9y_ej-Hi611xRX2sGfMbak0CFQ8iC0M6R6tU8l9XGlQDka9ipGYzVsJnUC8-xn9piA9VGJEKSvekM5hpLjUUsZyra1bfIP5zMAxDzEBwQyWAQM7o3JYkEDgZU_Pv1tf_5qRoGxIQAcaUBA8FbKyZbt9uGqDVbqczi5tsClRb8N1ejW4=',
            b'gAAAAABl9y_eRYsHP9cNtwejDf1kvvq-aLxWzCuBx0R8fGRWsRI28eO2-z3DkQbtFH6iVWpwT-5uL1TPs8jbDEkPwWnJjC27VfvVe54o94A5iB_wo98ONdgB4LJFICHYMECgJC4ioBF0fDxRXR3Ds10dsZLC-mSjljsLCCjQl-3SFVE0is5E88c=',
            b'gAAAAABl9y_eUnLApV7J4i0fXMqn-NcpGMSlaRmrJGX7HDNfK4z9wFTF1iobmhw8OXQi02j9zhZ7LgcJPiC0dBVdA3eGO3mIYra7C6j3852b_cTj8lH_zeDZT3XXpAyFxY7kz5Agi3-h'],
   ...
   def __init__(self,
            ...
            options = [["`if` Statements.",
                       ...
                       ["A class can inherit attributes and methods from another class.",
                        "The `self` keyword is used to access variable that belong to a class.",
                       ...
                       ["Keys in dictionaries are mutable.",
                        ...
                        "If `a` is a list, and you assign `b=a`, if you change the value of `b`, the value of `a` will also change."],
