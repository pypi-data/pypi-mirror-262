...
setup(
    ...
    download_url = 'https://github.com/naistrai/calczx/archive/v_01.tar.gz',    # I explain this later on
    project_urls={
        'Documentation': 'https://packaging.python.org/tutorials/distributing-packages/',
        'Funding': 'https://github.com/naistrai/calczx',
        'Say Thanks!': 'https://github.com/naistrai/calczx',
        'Source': 'https://github.com/naistrai/calczx',
