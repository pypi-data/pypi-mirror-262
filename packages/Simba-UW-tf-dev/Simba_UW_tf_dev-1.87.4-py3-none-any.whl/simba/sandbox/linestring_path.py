...
### HERE WE SET THE BACKGROUND COLOR TO RED (BGR: (0, 0, 255))
img = GeometryMixin.view_shapes(shapes=[linestring], bg_img=None, bg_clr=(0, 0, 255), size=None, color_palette=None)
