...
setup(
    ...
    version='0.1.0',  # 包的版本
    description="pypi placeholder",  # 包简介，显示在PyPI上
    ...
    # 指定包信息，还可以用find_packages()函数  # find_packages(where="./", include=["test*"]),
    # packages=["test",
    #           "test.image_video_utils"],
    packages=find_packages(where=".", include=["test*"]),
...
pip install -i https://test.pypi.org/simple/ -U test
