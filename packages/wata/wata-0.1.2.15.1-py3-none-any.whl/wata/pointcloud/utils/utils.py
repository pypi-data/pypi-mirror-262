...
def show_pcd_from_points(points, point_size=1, background_color=None, colors=None, create_coordinate=True, create_plane=True, type='open3d',savepath=None, plot_range=[0,-45,150,45]):
        if type == 'open3d':
        ...
        if type == 'open3d':
            open3d_draw_scenes(points=points, gt_boxes=gt_boxes, gt_labels=gt_labels, 
                               pred_boxes=pred_boxes, pred_labels=pred_labels, pred_scores=pred_scores,
                                ...
                                point_colors=point_colors, create_coordinate=create_coordinate)
        elif type == 'qtopengl':
            pass
        elif type == 'matplotlib':
