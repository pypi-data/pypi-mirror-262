...
@dataclass
class QueryDescriptionTokenizedContent:
    description: Optional[str] = None

    @staticmethod
    def from_dict(obj: Any) -> 'QueryDescriptionTokenizedContent':
        assert isinstance(obj, dict)
        description = from_union([from_str, from_none], obj.get("description"))
        return QueryDescriptionTokenizedContent(description)
...
class QueryDescription:
    description: Optional[str] = None
    tokenized_content: Optional[QueryDescriptionTokenizedContent] = None
    type: Optional[DescriptionType] = None

    @staticmethod
    def from_dict(obj: Any) -> 'QueryDescription':
        assert isinstance(obj, dict)
        description = from_union([from_str, from_none], obj.get("description"))
        tokenized_content = from_union([QueryDescriptionTokenizedContent.from_dict, from_none], obj.get("tokenizedContent"))
        type = from_union([DescriptionType, from_none], obj.get("type"))
        return QueryDescription(description, tokenized_content, type)
    ...
    def to_dict(self) -> dict:
        ...
        if self.description is not None:
            result["description"] = from_union([from_str, from_none], self.description)
        if self.tokenized_content is not None:
            result["tokenizedContent"] = from_union([lambda x: to_class(QueryDescriptionTokenizedContent, x), from_none], self.tokenized_content)
        if self.type is not None:
...
class QueryKnowledgeCard:
    descriptions: Optional[List[QueryDescription]] = None
    ...
    def from_dict(obj: Any) -> 'QueryKnowledgeCard':
        assert isinstance(obj, dict)
        descriptions = from_union([lambda x: from_list(QueryDescription.from_dict, x), from_none], obj.get("descriptions"))
        query = from_union([from_str, from_none], obj.get("query"))
        query_id = from_union([from_str, from_none], obj.get("queryId"))
        title = from_union([from_str, from_none], obj.get("title"))
        return QueryKnowledgeCard(descriptions, query, query_id, title)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.descriptions is not None:
            result["descriptions"] = from_union([lambda x: from_list(lambda x: to_class(QueryDescription, x), x), from_none], self.descriptions)
...
class InputOrOutputType1:
    ...
    query_description: Optional[QueryKnowledgeCard] = None
    ...
    def from_dict(obj: Any) -> 'InputOrOutputType1':
        ...
        query_description = from_union([QueryKnowledgeCard.from_dict, from_none], obj.get("queryDescription"))
        ...
        return InputOrOutputType1(asset_description, change_request, column_description, comment, data_document, deprecation, incident, query_description, type, usage)
    ...
    def to_dict(self) -> dict:
        ...
        if self.query_description is not None:
            result["queryDescription"] = from_union([lambda x: to_class(QueryKnowledgeCard, x), from_none], self.query_description)
        if self.type is not None:
