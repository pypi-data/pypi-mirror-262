...
Refer to the Terraform Registry for docs: [`data_vcd_vm_sizing_policy`](https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy).
'''
import abc
import builtins
import datetime
...
class DataVcdVmSizingPolicy(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy vcd_vm_sizing_policy}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy vcd_vm_sizing_policy} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy#name DataVcdVmSizingPolicy#name}.
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy#id DataVcdVmSizingPolicy#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param org: The name of organization to use - Deprecated and unneeded: will be ignored if used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy#org DataVcdVmSizingPolicy#org}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataVcdVmSizingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy#import import section} in the documentation of this resource for the id to use
...
class DataVcdVmSizingPolicyConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    @builtins.property
    def name(self) -> builtins.str:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy#name DataVcdVmSizingPolicy#name}.'''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy#id DataVcdVmSizingPolicy#id}.
    ...
    def org(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/vm_sizing_policy#org DataVcdVmSizingPolicy#org}
        '''
