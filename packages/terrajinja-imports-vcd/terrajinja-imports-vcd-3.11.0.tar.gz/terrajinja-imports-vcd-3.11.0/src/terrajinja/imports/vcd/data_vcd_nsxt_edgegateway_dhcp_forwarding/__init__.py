...
Refer to the Terraform Registry for docs: [`data_vcd_nsxt_edgegateway_dhcp_forwarding`](https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding).
'''
import abc
import builtins
import datetime
...
class DataVcdNsxtEdgegatewayDhcpForwarding(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding vcd_nsxt_edgegateway_dhcp_forwarding}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding vcd_nsxt_edgegateway_dhcp_forwarding} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param edge_gateway_id: Edge gateway ID for DHCP forwarding configuration. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding#edge_gateway_id DataVcdNsxtEdgegatewayDhcpForwarding#edge_gateway_id}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding#id DataVcdNsxtEdgegatewayDhcpForwarding#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across different organizations Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding#org DataVcdNsxtEdgegatewayDhcpForwarding#org}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataVcdNsxtEdgegatewayDhcpForwardingConfig(
    ...
    def edge_gateway_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding#edge_gateway_id DataVcdNsxtEdgegatewayDhcpForwarding#edge_gateway_id}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding#id DataVcdNsxtEdgegatewayDhcpForwarding#id}.
    ...
    def org(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_edgegateway_dhcp_forwarding#org DataVcdNsxtEdgegatewayDhcpForwarding#org}
        '''
