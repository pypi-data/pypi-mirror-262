...
Refer to the Terraform Registry for docs: [`vcd_nsxv_dnat`](https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat).
'''
import abc
import builtins
import datetime
...
class NsxvDnat(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat vcd_nsxv_dnat}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat vcd_nsxv_dnat} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param edge_gateway: Edge gateway name in which NAT Rule is located. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#edge_gateway NsxvDnat#edge_gateway}
        :param network_name: Org or external network name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#network_name NsxvDnat#network_name}
        :param network_type: Network type. One of 'ext', 'org'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#network_type NsxvDnat#network_type}
        :param original_address: Original address or address range. This is the the destination address for DNAT rules. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#original_address NsxvDnat#original_address}
        :param description: NAT rule description. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#description NsxvDnat#description}
        :param enabled: Whether the rule should be enabled. Default 'true'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#enabled NsxvDnat#enabled}
        :param icmp_type: ICMP type. Only supported when protocol is ICMP. One of ``any``, ``address-mask-request``, ``address-mask-reply``, ``destination-unreachable``, ``echo-request``, ``echo-reply``, ``parameter-problem``, ``redirect``, ``router-advertisement``, ``router-solicitation``, ``source-quench``, ``time-exceeded``, ``timestamp-request``, ``timestamp-reply``. Default ``any`` Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#icmp_type NsxvDnat#icmp_type}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#id NsxvDnat#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param logging_enabled: Whether logging should be enabled for this rule. Default 'false'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#logging_enabled NsxvDnat#logging_enabled}
        :param org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across different organizations Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#org NsxvDnat#org}
        :param original_port: Original port. This is the destination port for DNAT rules. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#original_port NsxvDnat#original_port}
        :param protocol: Protocol. Such as 'tcp', 'udp', 'icmp', 'any'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#protocol NsxvDnat#protocol}
        :param rule_tag: Optional. Allows to set custom rule tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#rule_tag NsxvDnat#rule_tag}
        :param rule_type: Read only. Possible values 'user', 'internal_high'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#rule_type NsxvDnat#rule_type}
        :param translated_address: Translated address or address range. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#translated_address NsxvDnat#translated_address}
        :param translated_port: Translated port. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#translated_port NsxvDnat#translated_port}
        :param vdc: The name of VDC to use, optional if defined at provider level. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#vdc NsxvDnat#vdc}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing NsxvDnat that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#import import section} in the documentation of this resource for the id to use
...
class NsxvDnatConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def edge_gateway(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#edge_gateway NsxvDnat#edge_gateway}
        '''
    ...
    def network_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#network_name NsxvDnat#network_name}
        '''
    ...
    def network_type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#network_type NsxvDnat#network_type}
        '''
    ...
    def original_address(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#original_address NsxvDnat#original_address}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#description NsxvDnat#description}
        '''
    ...
    def enabled(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#enabled NsxvDnat#enabled}
        '''
    ...
    def icmp_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#icmp_type NsxvDnat#icmp_type}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#id NsxvDnat#id}.
    ...
    def logging_enabled(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#logging_enabled NsxvDnat#logging_enabled}
        '''
    ...
    def org(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#org NsxvDnat#org}
        '''
    ...
    def original_port(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#original_port NsxvDnat#original_port}
        '''
    ...
    def protocol(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#protocol NsxvDnat#protocol}
        '''
    ...
    def rule_tag(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#rule_tag NsxvDnat#rule_tag}
        '''
    ...
    def rule_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#rule_type NsxvDnat#rule_type}
        '''
    ...
    def translated_address(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#translated_address NsxvDnat#translated_address}
        '''
    ...
    def translated_port(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#translated_port NsxvDnat#translated_port}
        '''
    ...
    def vdc(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/nsxv_dnat#vdc NsxvDnat#vdc}
        '''
