...
Refer to the Terraform Registry for docs: [`vcd_rde_type`](https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type).
'''
import abc
import builtins
import datetime
...
class RdeType(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type vcd_rde_type}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type vcd_rde_type} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: The name of the Runtime Defined Entity Type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#name RdeType#name}
        :param nss: A unique namespace associated with the Runtime Defined Entity Type. Combination of ``vendor``, ``nss`` and ``version`` must be unique. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#nss RdeType#nss}
        :param vendor: The vendor name for the Runtime Defined Entity Type. Combination of ``vendor``, ``nss`` and ``version`` must be unique. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#vendor RdeType#vendor}
        :param version: The version of the Runtime Defined Entity Type. The version string must follow semantic versioning rules. Combination of ``vendor``, ``nss`` and ``version`` must be unique Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#version RdeType#version}
        :param description: The description of the Runtime Defined Entity Type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#description RdeType#description}
        :param external_id: An external entity's ID that this definition may apply to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#external_id RdeType#external_id}
        :param hook: hook block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#hook RdeType#hook}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#id RdeType#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param inherited_version: To be used when creating a new version of a Runtime Defined Entity Type. Specifies the version of the type that will be the template for the authorization configuration of the new version.The Type ACLs and the access requirements of the Type Behaviors of the new version will be copied from those of the inherited version.If not set, then the new type version will not inherit another version and will have the default authorization settings, just like the first version of a new type Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#inherited_version RdeType#inherited_version}
        :param interface_ids: Set of Defined Interface URNs that this Runtime Defined Entity Type is referenced by. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#interface_ids RdeType#interface_ids}
        :param schema: The JSON-Schema valid definition of the Runtime Defined Entity Type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#schema RdeType#schema}
        :param schema_url: URL that should point to a JSON-Schema valid definition file of the Runtime Defined Entity Type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#schema_url RdeType#schema_url}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RdeType that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#import import section} in the documentation of this resource for the id to use
...
class RdeTypeConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#name RdeType#name}
        '''
    ...
    def nss(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#nss RdeType#nss}
        '''
    ...
    def vendor(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#vendor RdeType#vendor}
        '''
    ...
    def version(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#version RdeType#version}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#description RdeType#description}
        '''
    ...
    def external_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#external_id RdeType#external_id}
        '''
    ...
    def hook(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#hook RdeType#hook}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#id RdeType#id}.
    ...
    def inherited_version(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#inherited_version RdeType#inherited_version}
        '''
    ...
    def interface_ids(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#interface_ids RdeType#interface_ids}
        '''
    ...
    def schema(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#schema RdeType#schema}
        '''
    ...
    def schema_url(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#schema_url RdeType#schema_url}
        '''
...
class RdeTypeHook:
    def __init__(self, *, behavior_id: builtins.str, event: builtins.str) -> None:
        '''
        :param behavior_id: Existing Behavior that will be automatically invoked when the RDE of this RDE Type triggers the event. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#behavior_id RdeType#behavior_id}
        :param event: Event that will invoke the Behavior, one of PostCreate, PostUpdate, PreDelete, PostDelete. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#event RdeType#event}
        '''
        if __debug__:
    ...
    def behavior_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#behavior_id RdeType#behavior_id}
        '''
    ...
    def event(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/rde_type#event RdeType#event}
        '''
