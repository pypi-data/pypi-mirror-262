...
Refer to the Terraform Registry for docs: [`data_vcd_nsxt_distributed_firewall`](https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall).
'''
import abc
import builtins
import datetime
...
class DataVcdNsxtDistributedFirewall(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall vcd_nsxt_distributed_firewall}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall vcd_nsxt_distributed_firewall} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param vdc_group_id: The ID of VDC Group. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall#vdc_group_id DataVcdNsxtDistributedFirewall#vdc_group_id}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall#id DataVcdNsxtDistributedFirewall#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across different organizations Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall#org DataVcdNsxtDistributedFirewall#org}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataVcdNsxtDistributedFirewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall#import import section} in the documentation of this resource for the id to use
...
class DataVcdNsxtDistributedFirewallConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def vdc_group_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall#vdc_group_id DataVcdNsxtDistributedFirewall#vdc_group_id}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall#id DataVcdNsxtDistributedFirewall#id}.
    ...
    def org(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/nsxt_distributed_firewall#org DataVcdNsxtDistributedFirewall#org}
        '''
