...
Refer to the Terraform Registry for docs: [`data_vcd_org_vdc`](https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc).
'''
import abc
import builtins
import datetime
...
class DataVcdOrgVdc(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc vcd_org_vdc}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc vcd_org_vdc} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc#name DataVcdOrgVdc#name}.
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc#id DataVcdOrgVdc#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param org: Organization to create the VDC in. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc#org DataVcdOrgVdc#org}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataVcdOrgVdc that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc#import import section} in the documentation of this resource for the id to use
...
class DataVcdOrgVdcConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    @builtins.property
    def name(self) -> builtins.str:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc#name DataVcdOrgVdc#name}.'''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc#id DataVcdOrgVdc#id}.
    ...
    def org(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/org_vdc#org DataVcdOrgVdc#org}
        '''
