...
Refer to the Terraform Registry for docs: [`vcd_org_vdc_nsxt_network_profile`](https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile).
'''
import abc
import builtins
import datetime
...
class OrgVdcNsxtNetworkProfile(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile vcd_org_vdc_nsxt_network_profile}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile vcd_org_vdc_nsxt_network_profile} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param edge_cluster_id: ID of NSX-T Edge Cluster (provider vApp networking services and DHCP capability for Isolated networks). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#edge_cluster_id OrgVdcNsxtNetworkProfile#edge_cluster_id}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#id OrgVdcNsxtNetworkProfile#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param org: The name of organization to use, optional if defined at provider level. Useful when connected as sysadmin working across different organizations Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#org OrgVdcNsxtNetworkProfile#org}
        :param vapp_networks_default_segment_profile_template_id: Default NSX-T Segment Profile for vApp networks. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#vapp_networks_default_segment_profile_template_id OrgVdcNsxtNetworkProfile#vapp_networks_default_segment_profile_template_id}
        :param vdc: The name of VDC to use, optional if defined at provider level. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#vdc OrgVdcNsxtNetworkProfile#vdc}
        :param vdc_networks_default_segment_profile_template_id: Default NSX-T Segment Profile for Org VDC networks. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#vdc_networks_default_segment_profile_template_id OrgVdcNsxtNetworkProfile#vdc_networks_default_segment_profile_template_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing OrgVdcNsxtNetworkProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#import import section} in the documentation of this resource for the id to use
...
class OrgVdcNsxtNetworkProfileConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def edge_cluster_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#edge_cluster_id OrgVdcNsxtNetworkProfile#edge_cluster_id}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#id OrgVdcNsxtNetworkProfile#id}.
    ...
    def org(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#org OrgVdcNsxtNetworkProfile#org}
        '''
    ...
    def vapp_networks_default_segment_profile_template_id(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#vapp_networks_default_segment_profile_template_id OrgVdcNsxtNetworkProfile#vapp_networks_default_segment_profile_template_id}
        '''
    ...
    def vdc(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#vdc OrgVdcNsxtNetworkProfile#vdc}
        '''
    ...
    def vdc_networks_default_segment_profile_template_id(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/resources/org_vdc_nsxt_network_profile#vdc_networks_default_segment_profile_template_id OrgVdcNsxtNetworkProfile#vdc_networks_default_segment_profile_template_id}
        '''
