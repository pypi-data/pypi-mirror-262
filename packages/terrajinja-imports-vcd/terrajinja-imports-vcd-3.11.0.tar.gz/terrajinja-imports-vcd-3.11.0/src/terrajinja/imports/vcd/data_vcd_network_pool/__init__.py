...
Refer to the Terraform Registry for docs: [`data_vcd_network_pool`](https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/network_pool).
'''
import abc
import builtins
import datetime
...
class DataVcdNetworkPool(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/network_pool vcd_network_pool}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/network_pool vcd_network_pool} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Name of network pool. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/network_pool#name DataVcdNetworkPool#name}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/network_pool#id DataVcdNetworkPool#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataVcdNetworkPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/network_pool#import import section} in the documentation of this resource for the id to use
...
class DataVcdNetworkPoolBackingOutputReference(
    ...
    @builtins.property
    @jsii.member(jsii_name="portGroups")
    def port_groups(self) -> "DataVcdNetworkPoolBackingPortGroupsList":
        return typing.cast("DataVcdNetworkPoolBackingPortGroupsList", jsii.get(self, "portGroups"))
...
@jsii.data_type(
    jsii_type="vcd.dataVcdNetworkPool.DataVcdNetworkPoolBackingPortGroups",
    jsii_struct_bases=[],
    name_mapping={},
)
class DataVcdNetworkPoolBackingPortGroups:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "DataVcdNetworkPoolBackingPortGroups(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataVcdNetworkPoolBackingPortGroupsList(
    _cdktf_9a9027ec.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="vcd.dataVcdNetworkPool.DataVcdNetworkPoolBackingPortGroupsList",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f453c66cca9a1f1be5ea4e8c4f30c3d8b5c5082b03ad2b01b400e08554290edd)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
            check_type(argname="argument wraps_set", value=wraps_set, expected_type=type_hints["wraps_set"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute, wraps_set])
    ...
    def get(
        self,
        index: jsii.Number,
    ) -> "DataVcdNetworkPoolBackingPortGroupsOutputReference":
        '''
        :param index: the index of the item to return.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8af6006f2aae35690ffa6a1bdef58f6b961f6cbd5efd3d339f871f764fac770b)
            check_type(argname="argument index", value=index, expected_type=type_hints["index"])
        return typing.cast("DataVcdNetworkPoolBackingPortGroupsOutputReference", jsii.invoke(self, "get", [index]))
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bd163773e154ba08a6c51befea5244274ae7b0b4dd5fc4a74c4d689363da7c5b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "terraformAttribute", value)
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8c511009dbd58298bc5ae6775ecbd72387a1463f83e807a38f0d886872e15f4b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "terraformResource", value)
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fa77a3498170f0be316b5a3e92e37940c6253ee2684e0d112b62e9e11cba9bf6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "wrapsSet", value)


class DataVcdNetworkPoolBackingPortGroupsOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="vcd.dataVcdNetworkPool.DataVcdNetworkPoolBackingPortGroupsOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f1c929aba2af63e29f084dc78db72a3e12e5e84e704dc912bf714af23009703f)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
            check_type(argname="argument complex_object_index", value=complex_object_index, expected_type=type_hints["complex_object_index"])
            check_type(argname="argument complex_object_is_from_set", value=complex_object_is_from_set, expected_type=type_hints["complex_object_is_from_set"])
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[DataVcdNetworkPoolBackingPortGroups]:
        return typing.cast(typing.Optional[DataVcdNetworkPoolBackingPortGroups], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[DataVcdNetworkPoolBackingPortGroups],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__75219d74a947788bf18a3eec69e33e8812e8aa37c4c39295ada07bb6e8809845)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class DataVcdNetworkPoolConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/network_pool#name DataVcdNetworkPool#name}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.11.0/docs/data-sources/network_pool#id DataVcdNetworkPool#id}.
...
__all__ = [
    ...
    "DataVcdNetworkPoolBackingPortGroups",
    "DataVcdNetworkPoolBackingPortGroupsList",
    "DataVcdNetworkPoolBackingPortGroupsOutputReference",
...
def _typecheckingstub__f453c66cca9a1f1be5ea4e8c4f30c3d8b5c5082b03ad2b01b400e08554290edd(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
    wraps_set: builtins.bool,
) -> None:
...
def _typecheckingstub__8af6006f2aae35690ffa6a1bdef58f6b961f6cbd5efd3d339f871f764fac770b(
    index: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bd163773e154ba08a6c51befea5244274ae7b0b4dd5fc4a74c4d689363da7c5b(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8c511009dbd58298bc5ae6775ecbd72387a1463f83e807a38f0d886872e15f4b(
    value: _cdktf_9a9027ec.IInterpolatingParent,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fa77a3498170f0be316b5a3e92e37940c6253ee2684e0d112b62e9e11cba9bf6(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f1c929aba2af63e29f084dc78db72a3e12e5e84e704dc912bf714af23009703f(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
    complex_object_index: jsii.Number,
    complex_object_is_from_set: builtins.bool,
...
def _typecheckingstub__75219d74a947788bf18a3eec69e33e8812e8aa37c4c39295ada07bb6e8809845(
    value: typing.Optional[DataVcdNetworkPoolBackingPortGroups],
) -> None:
    """Type checking stubs"""
    pass
