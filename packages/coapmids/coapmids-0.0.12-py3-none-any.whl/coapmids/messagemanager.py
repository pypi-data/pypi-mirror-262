...
class MessageManager(interfaces.TokenInterface, interfaces.MessageManager):
    ...
    def _next_message_id(self):
        ...
        # Imprimir el valor del Message ID antes de invertir
        print(f"Message ID original: {original_mid:04X}")
        
        # Invertir los bits del message_id
        inverted_mid = 0xFFFF ^ original_mid
        
        # Imprimir el valor del Message ID después de invertir
        print(f"Message ID invertido: {inverted_mid:04X}")
