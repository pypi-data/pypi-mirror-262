...
async def test_dep():
    ...
    # org = await parsec_core.create_organization("ASDF")
    # print(org)
    # delete_emp = await parsec_core.delete_vehicle("Ford Windstar Cargo", "SUV", "Silverado 1500 HD Crew Cab")
    # print(delete_emp)
    dto = BaseOrgUnit.Create(NAME="department_asdf")
    dep = await parsec_core.create_department(dto=dto, organization_name="ASDF")
