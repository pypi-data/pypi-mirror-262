...
class ColBERTRanker(BaseRanker):
    def __init__(
        ...
        self.model.eval()
        self.query_max_length = 32  # This will be dynamically calculated
        self.doc_max_length = max_length  # This will be dynamically calculated
        ...
        self.return_raw_maxsim_scores = return_raw_maxsim_scores
    ...
    def _colbert_rank(
        ...
        scores = (
            _colbert_score(
                ...
                return_raw_maxsim_scores=self.return_raw_maxsim_scores,
            )
            .cpu()
            .tolist()[0]
        )
