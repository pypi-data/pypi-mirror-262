...
class TagMixins(Tag):
    ...
    def new_tag(
        ...
        **kwattrs: str,
        ...
        # return self._html.element_classes.get(Tag, Tag)(  # type: ignore
        #     None,
        #     self._html.builder,
        #     name_,
        #     namespace,
        ...
        # )
        if self._content is None:
            tag = self.element_classes.get(Tag, Tag)(  # type: ignore
                None,
                self.builder,
                name_,
                namespace,
            ...
            tag = self._html.element_classes.get(Tag, Tag)(  # type: ignore
                None,
                self._html.builder,
                name_,
                namespace,
