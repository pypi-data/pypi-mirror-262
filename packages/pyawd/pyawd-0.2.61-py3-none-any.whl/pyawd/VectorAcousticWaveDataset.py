...
def solve_vector_pde(u: dvt.VectorTimeFunction, f: dvt.VectorTimeFunction, a: dvt.Function, nx: int, ndt: int, ddt: float,
    ...
    if dim == 2:
        ...
        a.data[:] = create_inverse_distance_matrix(nx, x0=int(epicenter[0]), y0=int(epicenter[0]), tau=nx**2)**2
    else:
        ...
        a.data[:] = create_inverse_distance_matrix(nx, x0=int(epicenter[0]), y0=int(epicenter[0]),
                                                   z0=int(epicenter[1]), tau=nx ** 2) ** 2
