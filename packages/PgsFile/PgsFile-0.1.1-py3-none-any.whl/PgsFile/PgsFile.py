...
def extract_stopwords(lang=None):
    """
    Extract a certain text file from a multi-level folder.
    :param corpus_root: The path to the folder.
    :param file_name: The name of the text file to extract.
    :return: The contents of the text file, or None if the file doesn't exist.
    """
...
pickle_root=get_package_path('PgsFile').replace("__init__.py","models")
import pickle
