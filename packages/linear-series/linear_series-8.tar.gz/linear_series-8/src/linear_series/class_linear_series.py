...
from linear_series.get_base_point_tree import get_bp_tree
from linear_series.get_solution_set import get_solution_set
from linear_series.get_implicit import get_implicit_projection
from linear_series.get_implicit import get_implicit_image
import linear_series.get_linear_series  # prevent circular import
...
class LinearSeries:
    ...
    def get( deg_lst, bp_tree ):
        return linear_series.get_linear_series.get_linear_series( deg_lst, bp_tree )
