...
from linear_series.sage_interface import sage_save
from linear_series.sage_interface import sage_load
...
class LSTools():
    ...
    def start_timer():
        ...
        '''
        # get time
        LSTools.__start_time = time.perf_counter()  # set static variable.
    ...
    def stop_timer():
        ...
        '''
        LSTools.__end_time = time.perf_counter()
