...
from linear_series.sage_interface import sage_Compositions
from linear_series.sage_interface import sage_matrix
from linear_series.sage_interface import sage_vector
import linear_series.class_linear_series  # prevent circular import error
...
def get_linear_series( deg_lst, bp_tree ):
    ...
    ls = linear_series.class_linear_series.LinearSeries( mon_lst, ring )
    ...
    return linear_series.class_linear_series.LinearSeries( pol_lst, ring )
