...
from . import blockstorage_quotaset_v2
from . import blockstorage_quotaset_v3
from . import blockstorage_volume_attach_v2
...
from . import blockstorage_volume_v1
...
from . import data_openstack_blockstorage_snapshot_v2
from . import data_openstack_blockstorage_snapshot_v3
from . import data_openstack_blockstorage_volume_v2
...
from . import data_openstack_fw_policy_v1
...
from . import fw_firewall_v1
from . import fw_group_v2
from . import fw_policy_v1
from . import fw_policy_v2
from . import fw_rule_v1
