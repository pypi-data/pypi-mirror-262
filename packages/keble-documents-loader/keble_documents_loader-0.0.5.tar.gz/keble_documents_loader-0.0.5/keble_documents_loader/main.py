...
def xpath_load_meaningful_content(html: str, *, xpath_for_contentful_data: str,
                                  ...
                                  image_loader: Callable[[str], Optional[str]] = None) -> Optional[List[Document]]:
...
class KebleHtmlLoader:
    ...
    def __init__(self, html: str, *, xpath_for_contentful_data: Optional[str] = None,
                 child_xpath_for_contentful_image: Optional[str] = ".//img", image_loader: Callable[[str], Optional[str]] = None):
        self.__html = html
