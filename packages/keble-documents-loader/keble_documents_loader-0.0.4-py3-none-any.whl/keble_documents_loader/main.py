...
def xpath_load_meaningful_content(html: str, *, xpath_for_contentful_data: str,
                                  ...
                                  image_loader: Callable[[str], Optional[Document]] = None) -> Optional[List[Document]]:
    ...
    for el in text_elements:
        ...
        if child_xpath_for_contentful_image is not None and image_loader is not None:
            ...
            for image in images:
                ...
                loaded: Optional[Document] = image_loader(src)
...
class KebleHtmlLoader:
    ...
    def __init__(self, html: str, *, xpath_for_contentful_data: Optional[str] = None,
                 child_xpath_for_contentful_image: Optional[str] = ".//img", image_loader: Callable[[str], Optional[Document]] = None):
        self.__html = html
