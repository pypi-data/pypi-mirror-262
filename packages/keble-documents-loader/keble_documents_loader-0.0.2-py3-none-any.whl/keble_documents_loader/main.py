...
def xpath_load_meaningful_content(html: str, *, xpath_for_contentful_data: str,
                                  ...
                                  image_loader: BaseLoader=None) -> Optional[Document]:
...
class KebleHtmlLoader:
    ...
    def __init__(self, html: str, *, xpath_for_contentful_data: Optional[str] = None,
                 child_xpath_for_contentful_image: Optional[str] = ".//img", image_loader: BaseLoader = None):
        self.__html = html
        ...
        assert child_xpath_for_contentful_image is None or child_xpath_for_contentful_image[0] == ".", "You child_xpath_for_contentful_image should start with \".\"; child_xpath_for_contentful_image will be use on all the contentful elements."
