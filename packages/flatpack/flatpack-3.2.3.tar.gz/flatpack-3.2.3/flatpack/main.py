...
def fpk_train(directory: str, session: httpx.Client = None):
    ...
    try:
        ...
        print("⌨️ Keyboard interrupt received, cleaning up...")
        # Here, add any cleanup code necessary before exiting
        # For example, you might want to ensure that 'proc' is terminated gracefully
        proc.terminate()
        try:
