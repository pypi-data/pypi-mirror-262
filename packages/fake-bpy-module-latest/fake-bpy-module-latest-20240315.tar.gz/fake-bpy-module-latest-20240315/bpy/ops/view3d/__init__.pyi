...
def camera_to_view(override_context=None, execution_context=None, undo=None):
...
def camera_to_view_selected(override_context=None, execution_context=None, undo=None):
...
def clear_render_border(override_context=None, execution_context=None, undo=None):
...
def copybuffer(override_context=None, execution_context=None, undo=None):
...
def fly(override_context=None, execution_context=None, undo=None):
...
def localview_remove_from(override_context=None, execution_context=None, undo=None):
...
def navigate(override_context=None, execution_context=None, undo=None):
...
def ndof_all(override_context=None, execution_context=None, undo=None):
...
def ndof_orbit(override_context=None, execution_context=None, undo=None):
...
def ndof_orbit_zoom(override_context=None, execution_context=None, undo=None):
...
def ndof_pan(override_context=None, execution_context=None, undo=None):
...
def object_as_camera(override_context=None, execution_context=None, undo=None):
...
def object_mode_pie_or_toggle(override_context=None, execution_context=None, undo=None):
...
def ruler_add(override_context=None, execution_context=None, undo=None):
    """Add ruler
...
def ruler_remove(override_context=None, execution_context=None, undo=None):
    """Undocumented, consider contributing.
...
def smoothview(override_context=None, execution_context=None, undo=None):
    """Undocumented, consider contributing.
...
def snap_cursor_to_active(override_context=None, execution_context=None, undo=None):
...
def snap_cursor_to_center(override_context=None, execution_context=None, undo=None):
...
def snap_cursor_to_grid(override_context=None, execution_context=None, undo=None):
...
def snap_selected_to_active(override_context=None, execution_context=None, undo=None):
...
def snap_selected_to_grid(override_context=None, execution_context=None, undo=None):
...
def toggle_matcap_flip(override_context=None, execution_context=None, undo=None):
    """Flip MatCap
...
def toggle_xray(override_context=None, execution_context=None, undo=None):
...
def view_camera(override_context=None, execution_context=None, undo=None):
...
def view_center_camera(override_context=None, execution_context=None, undo=None):
...
def view_center_lock(override_context=None, execution_context=None, undo=None):
...
def view_center_pick(override_context=None, execution_context=None, undo=None):
...
def view_lock_clear(override_context=None, execution_context=None, undo=None):
...
def view_lock_to_active(override_context=None, execution_context=None, undo=None):
...
def view_persportho(override_context=None, execution_context=None, undo=None):
...
def walk(override_context=None, execution_context=None, undo=None):
...
def zoom_camera_1_to_1(override_context=None, execution_context=None, undo=None):
