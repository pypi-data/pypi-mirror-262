...
class CfcClient(bce_base_client.BceBaseClient):
    ...
    def publish_layer(self, layer_name, content=None, description=None,
            license_info=None, compatible_runtimes=None, config=None):
        """
        publish_layer
        :param layer_name  (required) The cfc layer name
        :type layer_name string       

        :param content (required) layer base64 object or bos bucket file path
        :type content {"BosBucket":"string", "BosObject": "string", "ZipFile": "string"}

        :param description   Description of the layer.
        :type description string

        :param license_info   license information of depencies.
        :type license_info string

        :param compatible_runtimes (required) cfc supported runtimes
        :type compatible_runtimes array of string
