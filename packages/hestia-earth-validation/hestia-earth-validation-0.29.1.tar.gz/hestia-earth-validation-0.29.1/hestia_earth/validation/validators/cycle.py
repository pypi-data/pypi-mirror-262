...
def validate_cycle(cycle: dict, node_map: dict = {}):
    ...
    return flatten([
        ...
        ([
            ...
            validate_list_sum_100_percent(cycle, 'practices', PRACTICE_SUM_100_TERM_TYPES, with_min_value=True),
            validate_list_sum_100_percent(cycle, 'practices', PRACTICE_SUM_100_MAX_TERM_TYPES),
            validate_list_percent_requires_value(
