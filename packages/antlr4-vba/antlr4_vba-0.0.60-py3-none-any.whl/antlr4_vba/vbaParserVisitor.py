...
class vbaParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by vbaParser#debugStatement.
    def visitDebugStatement(self, ctx:vbaParser.DebugStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by vbaParser#debugArgs.
    def visitDebugArgs(self, ctx:vbaParser.DebugArgsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by vbaParser#debugSep.
    def visitDebugSep(self, ctx:vbaParser.DebugSepContext):
        return self.visitChildren(ctx)
