...
@pass_tgclient
def update_imex(client, imex, folder_path: str, make_revision: bool = True, data_only:bool = False):
        ...
        for path, textgrid_uri in bar:
            ...
            with open(filename, "rb") as the_data:
                ...
                if not data_only:
                    ...
                    md_disk.generic.generated.last_modified = md_online.object_value.generic.generated.last_modified
...
@click.option(
    "--threaded", help="use multithreading for crud requests", is_flag=True
)
@pass_tgclient
