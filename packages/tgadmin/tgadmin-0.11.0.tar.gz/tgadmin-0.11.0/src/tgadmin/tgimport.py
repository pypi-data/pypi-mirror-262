...
def handle_aggregation_upload(tgcrud, sid, project_id, filename, agg_meta, imex_map, threaded):
    ...
    tguri = upload_modified(tgcrud, sid, project_id, agg_xml_root, agg_meta)
...
def upload_file(tgcrud, sid, project_id: str, data_path: PurePath, imex_map: dict, referenced_in: str = "" ) -> str:
    ...
    try:
        ...
        handle_crud_exception(error, sid, project_id)


def upload_modified(tgcrud, sid, project_id: str, etree_data, metadata) -> str:
...
def handle_crud_exception(error, sid, project_id):
