...
#   timestamp: 2024-03-15T04:52:45+00:00
...
class Binding(BaseModel):
    ...
    condition: Optional[Condition] = Field(
        None, description='Optional. The condition under which the binding applies.'
    )
    members: Optional[List[str]] = Field(
        None, description='Optional. The list of IAM users to be bound to the role.'
    )
...
class Model(BaseModel):
    ...
    spec: Optional[Spec] = Field(
        None, description='IAMPolicySpec defines the desired state of IAMPolicy'
    )
    status: Optional[Status] = Field(
        None, description='IAMPolicyStatus defines the observed state of IAMPolicy'
    )
...
class Spec(BaseModel):
    ...
    auditConfigs: Optional[List[AuditConfig]] = Field(
        None, description='Optional. The list of IAM audit configs.'
    )
    bindings: Optional[List[Binding]] = Field(
        None, description='Optional. The list of IAM bindings.'
    )
