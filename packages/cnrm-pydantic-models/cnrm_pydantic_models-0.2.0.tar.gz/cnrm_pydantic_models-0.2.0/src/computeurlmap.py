...
class RequestHeadersToAddItem2(BaseModel):
    ...
    headerName: Optional[str] = Field(
        None, description='The name of the header to add.'
    )
    headerValue: Optional[str] = Field(
        None, description='The value of the header to add.'
    )
...
class RouteRule(BaseModel):
    ...
    matchRules: Optional[List[MatchRule]] = Field(
        None, description='The rules for determining a match.'
    )
    priority: int = Field(
        ...,
...
class Spec(BaseModel):
    ...
    hostRule: Optional[List[HostRuleItem]] = Field(
        None, description='The list of HostRules to use against the URL.'
    )
    location: str = Field(
        ...,
