...
class Spec(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description='Description of the data exchange.'
    )
    ...
    documentation: Optional[str] = Field(
        None, description='Documentation describing the data exchange.'
    )
    icon: Optional[str] = Field(
        None, description='Base64 encoded image representing the data exchange.'
    )
    location: str = Field(
...
class Status(BaseModel):
    ...
    listingCount: Optional[int] = Field(
        None, description='Number of listings contained in the data exchange.'
    )
    name: Optional[str] = Field(
        None,
