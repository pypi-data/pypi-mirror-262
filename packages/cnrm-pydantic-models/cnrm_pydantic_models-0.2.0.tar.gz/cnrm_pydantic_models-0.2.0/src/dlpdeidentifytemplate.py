...
#   timestamp: 2024-03-15T04:52:26+00:00
...
class Condition(BaseModel):
    ...
    expressions: Optional[Expressions] = Field(None, description='An expression.')
...
class Condition2(BaseModel):
    ...
    expressions: Optional[Expressions1] = Field(None, description='An expression.')
...
class Condition4(BaseModel):
    ...
    expressions: Optional[Expressions2] = Field(None, description='An expression.')
...
class Condition6(BaseModel):
    ...
    expressions: Optional[Expressions3] = Field(None, description='An expression.')
...
class CryptoKey(BaseModel):
    ...
    transient: Optional[Transient] = Field(None, description='Transient crypto key')
    unwrapped: Optional[Unwrapped] = Field(None, description='Unwrapped crypto key')
...
class FieldTransformation(BaseModel):
    ...
    primitiveTransformation: Optional[PrimitiveTransformation2] = Field(
        None, description='Apply the transformation to the entire field.'
    )
...
class LowerBound(BaseModel):
    ...
    dateValue: Optional[DateValue] = Field(None, description='date')
    ...
    integerValue: Optional[int] = Field(None, description='integer')
    stringValue: Optional[str] = Field(None, description='string')
    timeValue: Optional[TimeValue] = Field(None, description='time of day')
    timestampValue: Optional[AwareDatetime] = Field(None, description='timestamp')
...
class PrimitiveTransformation(BaseModel):
    ...
    bucketingConfig: Optional[BucketingConfig] = Field(None, description='Bucketing')
    characterMaskConfig: Optional[CharacterMaskConfig] = Field(None, description='Mask')
    cryptoDeterministicConfig: Optional[CryptoDeterministicConfig] = Field(
        None, description='Deterministic Crypto'
    )
    cryptoHashConfig: Optional[CryptoHashConfig] = Field(None, description='Crypto')
    cryptoReplaceFfxFpeConfig: Optional[CryptoReplaceFfxFpeConfig] = Field(
        None, description='Ffx-Fpe'
    )
    dateShiftConfig: Optional[DateShiftConfig] = Field(None, description='Date Shift')
    fixedSizeBucketingConfig: Optional[FixedSizeBucketingConfig] = Field(
        None, description='Fixed size bucketing'
    )
    redactConfig: Optional[Dict[str, Any]] = Field(None, description='Redact')
    ...
    replaceWithInfoTypeConfig: Optional[Dict[str, Any]] = Field(
        None, description='Replace with infotype'
    )
...
class PrimitiveTransformation1(BaseModel):
    ...
    bucketingConfig: Optional[BucketingConfig1] = Field(None, description='Bucketing')
    ...
    cryptoHashConfig: Optional[CryptoHashConfig1] = Field(None, description='Crypto')
    cryptoReplaceFfxFpeConfig: Optional[CryptoReplaceFfxFpeConfig1] = Field(
        None, description='Ffx-Fpe'
    )
    dateShiftConfig: Optional[DateShiftConfig1] = Field(None, description='Date Shift')
...
class PrimitiveTransformation2(BaseModel):
    ...
    bucketingConfig: Optional[BucketingConfig2] = Field(None, description='Bucketing')
    ...
    cryptoHashConfig: Optional[CryptoHashConfig2] = Field(None, description='Crypto')
    cryptoReplaceFfxFpeConfig: Optional[CryptoReplaceFfxFpeConfig2] = Field(
        None, description='Ffx-Fpe'
    )
    dateShiftConfig: Optional[DateShiftConfig2] = Field(None, description='Date Shift')
...
class PrimitiveTransformation3(BaseModel):
    ...
    bucketingConfig: Optional[BucketingConfig3] = Field(None, description='Bucketing')
    ...
    cryptoHashConfig: Optional[CryptoHashConfig3] = Field(None, description='Crypto')
    cryptoReplaceFfxFpeConfig: Optional[CryptoReplaceFfxFpeConfig3] = Field(
        None, description='Ffx-Fpe'
    )
    dateShiftConfig: Optional[DateShiftConfig3] = Field(None, description='Date Shift')
...
class PrimitiveTransformation4(BaseModel):
    ...
    bucketingConfig: Optional[BucketingConfig4] = Field(None, description='Bucketing')
    ...
    cryptoHashConfig: Optional[CryptoHashConfig4] = Field(None, description='Crypto')
    cryptoReplaceFfxFpeConfig: Optional[CryptoReplaceFfxFpeConfig4] = Field(
        None, description='Ffx-Fpe'
    )
    dateShiftConfig: Optional[DateShiftConfig4] = Field(None, description='Date Shift')
...
class PrimitiveTransformation5(BaseModel):
    ...
    bucketingConfig: Optional[BucketingConfig5] = Field(None, description='Bucketing')
    ...
    cryptoHashConfig: Optional[CryptoHashConfig5] = Field(None, description='Crypto')
    cryptoReplaceFfxFpeConfig: Optional[CryptoReplaceFfxFpeConfig5] = Field(
        None, description='Ffx-Fpe'
    )
    dateShiftConfig: Optional[DateShiftConfig5] = Field(None, description='Date Shift')
...
class ReplaceConfig(BaseModel):
    ...
    newValue: Optional[NewValue] = Field(None, description='Value to replace it with.')
...
class ReplaceConfig1(BaseModel):
    ...
    newValue: Optional[NewValue1] = Field(None, description='Value to replace it with.')
...
class ReplaceConfig2(BaseModel):
    ...
    newValue: Optional[NewValue2] = Field(None, description='Value to replace it with.')
...
class ReplaceConfig3(BaseModel):
    ...
    newValue: Optional[NewValue3] = Field(None, description='Value to replace it with.')
...
class ReplaceConfig4(BaseModel):
    ...
    newValue: Optional[NewValue4] = Field(None, description='Value to replace it with.')
...
class ReplaceConfig5(BaseModel):
    ...
    newValue: Optional[NewValue5] = Field(None, description='Value to replace it with.')
...
class Spec(BaseModel):
    ...
    location: Optional[str] = Field(
        None, description='Immutable. The location of the resource'
    )
...
class TransformationErrorHandling(BaseModel):
    ...
    throwError: Optional[Dict[str, Any]] = Field(None, description='Throw an error')
