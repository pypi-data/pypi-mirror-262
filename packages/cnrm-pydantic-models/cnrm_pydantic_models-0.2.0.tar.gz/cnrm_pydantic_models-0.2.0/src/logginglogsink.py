...
#   timestamp: 2024-03-15T04:52:56+00:00
...
class Exclusion(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description='A description of this exclusion.'
    )
...
class FolderRef(BaseModel):
    ...
    external: Optional[str] = Field(
        None, description='Allowed value: The `folderId` field of a `Folder` resource.'
    )
    name: str = Field(
        ...,
        description='Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names',
...
class Spec(BaseModel):
    ...
    bigqueryOptions: Optional[BigqueryOptions] = Field(
        None, description='Options that affect sinks exporting data to BigQuery.'
    )
    description: Optional[str] = Field(
        None,
