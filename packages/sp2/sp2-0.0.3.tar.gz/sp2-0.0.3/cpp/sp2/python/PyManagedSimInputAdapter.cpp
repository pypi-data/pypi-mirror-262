...
#include <sp2/python/PyAdapterManager.h>
...
public:
    PyManagedSimInputAdapter( Engine * engine, AdapterManager * manager,
                              ...
                              PushMode pushMode ) : ManagedSimInputAdapter( engine, pyTypeAsSp2Type( pyType ), manager, pushMode ),
...
public:
    ...
    void pushPyTick( PyObject * value ) override
    {
        ...
        {
            SP2_THROW( TypeError, "\"" << Py_TYPE( m_pyadapter.ptr() ) -> tp_name << "\" managed sim adapter expected output type to be of type \""
...
PyTypeObject PyManagedSimInputAdapter_PyObject::PyType = {
    ...
    "_sp2impl.Pymanagedsiminputadapter", /* tp_name */
    ...
    "sp2 maanged sim adapter",     /* tp_doc */
    0,                         /* tp_traverse */
    0,                         /* tp_clear */
    0,                         /* tp_richcompare */
    0,                         /* tp_weaklistoffset */
...
static InputAdapter * pymanagedsimadapter_creator( sp2::AdapterManager * manager, PyEngine * engine,
                                                   PyObject * pyType, PushMode pushMode, PyObject * args )
{
    ...
    if( !PyType_IsSubtype( pyAdapterType, &PyManagedSimInputAdapter_PyObject::PyType ) )
        SP2_THROW( TypeError, "Expected PyManagedSimInputAdapter derived type, got " << pyAdapterType -> tp_name );
