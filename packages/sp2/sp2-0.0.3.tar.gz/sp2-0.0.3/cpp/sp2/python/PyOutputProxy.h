#ifndef _IN_SP2_PYTHON_PYOUTPUTPROXY_H
#define _IN_SP2_PYTHON_PYOUTPUTPROXY_H
...
inline void PyOutputProxy::outputTick( PyObject * value )
{
    ...
    {
        SP2_THROW( TypeError, "\"" << m_node -> name() << "\" node expected output type on output #" << ( int ) m_id.id
