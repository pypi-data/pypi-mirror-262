...
public:
    ...
    _unary_op( sp2::Engine * engine, const sp2::CppNode::NodeDef & nodedef ) : sp2::CppNode( engine, nodedef )
    {}
...
public:
    ...
    _binary_op( sp2::Engine * engine, const sp2::CppNode::NodeDef & nodedef ) : sp2::CppNode( engine, nodedef )
    {}
