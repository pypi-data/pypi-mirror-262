...
OutputBasketInfo::OutputBasketInfo( Sp2TypePtr & type, Node * node,
...
DynamicOutputBasketInfo::DynamicOutputBasketInfo( Sp2TypePtr & type, Node * node ) : OutputBasketInfo( type, node, 0, true ),
                                                                                     m_elemType( type ),
                                                                                     m_parentNode( node ),
                                                                                     m_capacity( 0 ),
                                                                                     m_ownTs( true )
{
    static Sp2TypePtr s_shapeType = std::make_shared<Sp2StructType>( sp2::autogen::DynamicBasketEvent::meta() );
