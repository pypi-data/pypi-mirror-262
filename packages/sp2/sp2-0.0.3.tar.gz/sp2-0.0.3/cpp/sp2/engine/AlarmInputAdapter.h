#ifndef _IN_SP2_ENGINE_ALARMINPUTADAPTER_H
#define _IN_SP2_ENGINE_ALARMINPUTADAPTER_H
...
{
public:
    AlarmInputAdapter( Engine * engine, Sp2TypePtr & type ) : InputAdapter( engine, type, PushMode::NON_COLLAPSING )
    {
    }
