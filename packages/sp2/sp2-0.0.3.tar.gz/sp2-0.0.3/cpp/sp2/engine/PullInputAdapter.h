#ifndef _IN_SP2_ENGINE_PULLINPUTADAPTER_H
#define _IN_SP2_ENGINE_PULLINPUTADAPTER_H
...
{
public:
    PullInputAdapter( Engine * engine, Sp2TypePtr & type, PushMode pushMode ) : InputAdapter( engine, type, pushMode )
    {
    }
