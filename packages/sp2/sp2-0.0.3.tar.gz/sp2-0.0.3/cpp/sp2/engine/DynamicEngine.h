#ifndef _IN_SP2_ENGINE_DYNAMICENGINE_H
#define _IN_SP2_ENGINE_DYNAMICENGINE_H
...
private:
    //these are outputs returned from the sub-graph, as opposed to sp2.add_graph_output calls
