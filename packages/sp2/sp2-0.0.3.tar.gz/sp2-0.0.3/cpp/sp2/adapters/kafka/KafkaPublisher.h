#ifndef _IN_SP2_ADAPTERS_KAFKA_KAFKAPUBLISHER_H
#define _IN_SP2_ADAPTERS_KAFKA_KAFKAPUBLISHER_H
...
public:
    ...
    OutputAdapter * getOutputAdapter( Sp2TypePtr & type, const Dictionary & properties, const std::string & key );
    OutputAdapter * getOutputAdapter( Sp2TypePtr & type, const Dictionary & properties, const std::vector<std::string> & keyFields );
