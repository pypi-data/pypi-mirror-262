#ifndef _IN_SP2_ADAPTERS_PARQUET_ParquetReader_H
#define _IN_SP2_ADAPTERS_PARQUET_ParquetReader_H
...
public:
    ...
    void init( sp2::DateTime start, sp2::DateTime end )
    {
...
private:
    class ChildGenerator : public sp2::Generator<std::string, sp2::DateTime, sp2::DateTime>
    {
    public:
        ...
        void init( sp2::DateTime, sp2::DateTime ){}
...
public:
    ...
    ParquetStructAdapter &getStructAdapter( const sp2::adapters::utils::StructAdapterInfo &structAdapterInfo );
                                    ...
                                    const std::optional<utils::Symbol> &symbol, const DialectGenericListReaderInterface::Ptr &listReaderInterface )
    {
        ...
        if(columnAdapterReference->getContainerValueType()->type() == sp2::Sp2Type::Type::STRING)
        {
        ...
        {
            PartialSwitchSp2Type<sp2::Sp2Type::Type::BOOL, sp2::Sp2Type::Type::INT64, sp2::Sp2Type::Type::DOUBLE>::invoke(
    ...
    /**
     * Set a known schema of a struct column. Any future files that will have the column will automatically bind to the given sp2 struct
     * metadata
     * @param columnName
     * @param metaData
     */
    ...
    /**
     * @return The known mappings of struct columns to the corresponding sp2 metadata. NOTE: the values might not be set for all struct columns,
...
public:
    ...
    ColumnAdapterReference operator[]( const std::string &name ) override
    {
        ...
        SP2_TRUE_OR_THROW_RUNTIME( it != m_columnNameToAdapterIndex.end(),
...
{
public:
    using GeneratorPtr = sp2::Generator<std::shared_ptr<arrow::Table>, sp2::DateTime, sp2::DateTime>::Ptr;
...
public:
    ...
    int64_t getCurRow() const override{ SP2_NOT_IMPLEMENTED; }
...
#endif //_IN_SP2_ADAPTERS_PARQUET_ParquetIterator_H
