#ifndef _IN_SP2_ADAPTERS_PARQUET_ParquetOutputAdapter_H
#define _IN_SP2_ADAPTERS_PARQUET_ParquetOutputAdapter_H

#include <sp2/adapters/parquet/ArrowSingleColumnArrayBuilder.h>
...
{
public:
    ParquetOutputHandler( ParquetWriter &parquetWriter, Sp2TypePtr &type )
...
{
public:
    SingleColumnParquetOutputHandler( Engine *engine, ParquetWriter &parquetWriter, Sp2TypePtr &type,
...
private:
    ...
    void createEnumColumnBuilder( const std::string &columnName, Sp2EnumMeta::Ptr enumMetaPtr );
...
{
public:
    ListColumnParquetOutputHandler( Engine *engine, ParquetWriter &parquetWriter, Sp2TypePtr &elemType, const std::string &columnName,
...
private:
    std::shared_ptr<arrow::ArrayBuilder> createValueBuilder( const Sp2TypePtr &elemType,
                                                             DialectGenericListWriterInterface::Ptr &listWriterInterface );
...
{
public:
    SingleColumnParquetOutputAdapter( Engine *engine, ParquetWriter &parquetWriter, Sp2TypePtr &type, std::string columnName )
...
{
public:
    ListColumnParquetOutputAdapter( Engine *engine, ParquetWriter &parquetWriter, Sp2TypePtr &type, std::string columnName,
                                    DialectGenericListWriterInterface::Ptr listWriterInterface )
...
{
public:
    StructParquetOutputHandler( Engine *engine, ParquetWriter &parquetWriter, Sp2TypePtr &type, DictionaryPtr fieldMap );
...
{
public:
    StructParquetOutputAdapter( Engine *engine, ParquetWriter &parquetWriter, Sp2TypePtr &type, DictionaryPtr fieldMap )
