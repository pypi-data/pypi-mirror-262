#include <sp2/adapters/parquet/ParquetFileWriterWrapper.h>
...
{
    SP2_TRUE_OR_THROW_RUNTIME( m_outputStream == nullptr, "Trying to open parquet file while previous was not closed" );
...
{
    SP2_TRUE_OR_THROW_RUNTIME(m_fileWriter, "File writer is null!!!");
