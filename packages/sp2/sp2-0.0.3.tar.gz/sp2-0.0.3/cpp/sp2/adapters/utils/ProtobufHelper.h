...
public:
    ...
    //type conversions
    static google::protobuf::FieldDescriptor::CppType sp2ToProtoCppType( const Sp2Type & type );
    static bool isCoercible( google::protobuf::FieldDescriptor::CppType src, Sp2Type::Type dest );
...
public:
    ...
    void init( const Sp2TypePtr & type, const Dictionary & fieldMap,
...
private:
    ...
    static Fields buildFields( const Sp2TypePtr & type, const Dictionary & fieldMap, const google::protobuf::Descriptor * protoDesc );
