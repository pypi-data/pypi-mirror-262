function(sp2_autogen MODULE_NAME DEST_FILENAME HEADER_NAME_OUTVAR SOURCE_NAME_OUTVAR)
    ...
    add_custom_command(OUTPUT  "${CMAKE_CURRENT_BINARY_DIR}/sp2_autogen/${DEST_FILENAME}.cpp" "${CMAKE_CURRENT_BINARY_DIR}/sp2_autogen/${DEST_FILENAME}.h"
        COMMAND ${CMAKE_COMMAND} -E env "PYTHONPATH=${PROJECT_BINARY_DIR}/lib:${CMAKE_SOURCE_DIR}:$$PYTHONPATH" "LD_LIBRARY_PATH=${PROJECT_BINARY_DIR}/lib:$$LD_LIBRARY_PATH}" ${Python_EXECUTABLE} ${SP2_AUTOGEN} -m ${MODULE_NAME} -d ${CMAKE_CURRENT_BINARY_DIR}/sp2_autogen -o ${DEST_FILENAME} ${SP2_AUTOGEN_EXTRA_ARGS}
            COMMENT "generating sp2 c++ types from module ${MODULE_NAME} ${PROJECT_BINARY_DIR} ${SP2_AUTOGEN}"
