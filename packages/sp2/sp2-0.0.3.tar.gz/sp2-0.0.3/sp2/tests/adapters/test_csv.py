...
import sp2
from sp2 import ts
from sp2.adapters.csv import CSVReader, YYYYMMDD_TIME_formatter
...
class TestCSVReader(unittest.TestCase):
    ...
    def test_starttime(self):
        ...
        # Exact hit
        res = sp2.run(aapl, starttime=datetime(2020, 3, 3, 9, 30, 4))[0]
        self.assertEqual(len(res), 2)
        self.assertEqual(res[0][0], datetime(2020, 3, 3, 9, 30, 4))

        # Missed, should start with first found tick
        res = sp2.run(aapl, starttime=datetime(2020, 3, 3, 9, 30, 3, 2))[0]
        self.assertEqual(len(res), 2)
        self.assertEqual(res[0][0], datetime(2020, 3, 3, 9, 30, 4))
