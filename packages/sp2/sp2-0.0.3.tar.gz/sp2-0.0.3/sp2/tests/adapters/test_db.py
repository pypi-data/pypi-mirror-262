...
import sp2
from sp2.adapters.db import _SQLALCHEMY_2, DateTimeAccessor, DBReader, EngineStartTimeAccessor, TimestampAccessor
...
class TestDBReader(unittest.TestCase):
    ...
    def test_sqlite_basic(self):
        ...
        for time_accessor in (
            ...
            def graph():
                ...
                sp2.add_graph_output("aapl_dyn", aapl_dyn)
                sp2.add_graph_output("aapl_dyn2", aapl_dyn2)
            ...
            dyn_struct = sp2.adapters.db.DBDynStruct_test_
            self.assertEqual(
    ...
    def test_sqlite_constraints(self):
        ...
        # NYC
        result = sp2.run(graph, starttime=pytz.timezone("US/Eastern").localize(datetime(2020, 3, 3, 9, 30)))
    ...
    def test_join_query(self):
        ...
        result = sp2.run(graph, starttime=starttime)
    ...
    def test_DateTimeAccessor(self):
        ...
        for starttime, endtime in periods:
            result = sp2.run(graph, starttime=tz.localize(starttime), endtime=tz.localize(endtime))
            target = [
