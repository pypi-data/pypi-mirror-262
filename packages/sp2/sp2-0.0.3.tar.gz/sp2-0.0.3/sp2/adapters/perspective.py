...
class PerspectiveTableAdapter:
    ...
    def publish(self, value: ts[object], field_map: typing.Union[typing.Dict[str, str], str, None] = None):
        ...
        """
        if issubclass(value.tstype.typ, sp2.Struct):
    ...
    def _publish_struct(self, value: ts[sp2.Struct], field_map: typing.Optional[typing.Dict[str, str]]):
...
class PerspectiveAdapter(DelayedNodeWrapperDef):
    ...
    def _instantiate(self):
        ...
        for table_name, table in self._tables.items():
            schema = {
                k: v.tstype.typ if not issubclass(v.tstype.typ, sp2.Enum) else str for k, v in table.columns.items()
            }
        ...
        _launch_application(self._port, manager, sp2.const("stub"))
