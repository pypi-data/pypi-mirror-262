#ifndef _IN_SP2_ADAPTERS_PARQUET_ValueDispatcher_H
#define _IN_SP2_ADAPTERS_PARQUET_ValueDispatcher_H
...
template< typename V >
using PushBatchValueDispatcher = ValueDispatcher<V, sp2::PushBatch *>;
