#ifndef _IN_SP2_PYTHON_PYOBJECTPTR_H
#define _IN_SP2_PYTHON_PYOBJECTPTR_H
...
template<>
struct hash<sp2::python::PyObjectPtr>
{
    size_t operator()( const sp2::python::PyObjectPtr & p ) const
    {
        return p.hash();
    }
};
