#ifndef _IN_SP2_PYTHON_INITHELPER_H
#define _IN_SP2_PYTHON_INITHELPER_H
...
#define __REGISTER_INIT_HOOK2( CALLBACK, LINE ) static bool inithook_##LINE = sp2::python::InitHelper::instance().registerCallback( CALLBACK );
...
#define REGISTER_TYPE_INIT( PY_TYPE, NAME )     REGISTER_INIT_HOOK( sp2::python::InitHelper::typeInitCallback( PY_TYPE, NAME ) );
#define REGISTER_MODULE_METHODS( METHODS )      REGISTER_INIT_HOOK( sp2::python::InitHelper::moduleMethodsCallback( METHODS ) );
#define REGISTER_MODULE_METHOD( NAME, METHOD, FLAGS, DOC ) REGISTER_INIT_HOOK( sp2::python::InitHelper::moduleMethod( NAME, METHOD, FLAGS, DOC ) );
