#ifndef _IN_SP2_PYTHON_PYSTRUCT_H
#define _IN_SP2_PYTHON_PYSTRUCT_H
...
//This is the base class of sp2.StructMeta
...
//This is an extension of sp2::StructMeta for python dialect, we need it in order to
//keep a reference to the python struct type from conversion to/from sp2::Struct <-> PyObject properly
...
struct PyStruct : public PyObject
{
    ...
    static bool isPyStructType( PyTypeObject * typ )
    {
        ...
        //make sure its not sp2.Struct python type itself
