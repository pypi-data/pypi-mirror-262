#ifndef _IN_SP2_ENGINE_PUSHPULLINPUTADAPTER_H
#define _IN_SP2_ENGINE_PUSHPULLINPUTADAPTER_H
...
{
public:
    PushPullInputAdapter( Engine * engine, Sp2TypePtr & type, PushMode pushMode,
...
inline void PushPullInputAdapter::pushTick( bool live, DateTime time, T &&value, PushBatch *batch )
{
    ...
    {
        if( unlikely( m_notifiedEndOfPull ) )
            SP2_THROW( RuntimeException, "PushPullInputAdapter tried to push a sim tick after live tick" );
