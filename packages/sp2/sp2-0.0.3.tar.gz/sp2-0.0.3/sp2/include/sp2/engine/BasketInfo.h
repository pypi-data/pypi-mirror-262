#ifndef _IN_SP2_ENGINE_BASKETINFO_H
#define _IN_SP2_ENGINE_BASKETINFO_H
...
public:
    ...
    {
        SP2_ASSERT( ( elemId >= 0 && elemId < m_size ) || ( elemId == -1 && m_isDynamic ) );
...
{
public:
    OutputBasketInfo( Sp2TypePtr & type, Node * node, size_t size, bool isDynamic = false );
    ~OutputBasketInfo();
    ...
    {
        SP2_ASSERT( elemId >= 0 && elemId < m_size );
...
{
public:
    DynamicOutputBasketInfo( Sp2TypePtr & type, Node * node );
