#ifndef _IN_SP2_ADAPTER_MANAGER_H
#define _IN_SP2_ADAPTER_MANAGER_H
...
{
public:
    ManagedSimInputAdapter( sp2::Engine *engine, const Sp2TypePtr &type, AdapterManager *manager, PushMode pushMode );
...
public:
    ...
    StatusAdapter *createStatusAdapter( Sp2TypePtr &type, PushMode pushMode );
...
inline void AdapterManager::scheduleTimerCB( DateTime next )
{
    ...
    {
        SP2_THROW( ValueError, "AdapterManager " << name() << " scheduler error: " << err.description() );
    }
