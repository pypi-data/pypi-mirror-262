...
from sp2.impl.mem_cache import Sp2GraphObjectsMemCache
...
class Context:
    ...
    def __init__(
        ...
        from sp2.impl.wiring.cache_support.graph_building import ContextCacheInfo
    ...
    def __enter__(self):
        ...
        self.mem_cache = Sp2GraphObjectsMemCache.new_context()
...
def new_global_context(enable=True):
    """
    Example 1:
    new_global_context() # at this point the context is visible to all subsequent sp2 calls

    Example 2:
    context = new_global_context(False) # the context is not visible yet in the SP2 lib
    with context:
