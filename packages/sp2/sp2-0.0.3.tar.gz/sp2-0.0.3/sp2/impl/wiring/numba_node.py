...
from sp2.impl.types.generic_values_resolver import GenericValuesResolver
from sp2.impl.wiring.edge import Edge
from sp2.impl.wiring.node import NodeDef, _create_node
from sp2.impl.wiring.numba_node_parser import NumbaNodeParser
...
class NumbaNodeDef(NodeDef):
    ...
    def _create(self, engine, memo):
        from sp2.impl.wiring.numba_utils.numba_type_resolver import NumbaTypeResolver
        from sp2.impl.wiring.numba_utils.sp2_cpp_numba_interface import NumbaTSTypedFunctionResolver, ffi_ptr_to_int
