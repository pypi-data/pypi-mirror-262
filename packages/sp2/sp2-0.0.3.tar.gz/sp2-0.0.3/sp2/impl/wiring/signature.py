...
from sp2.impl.types.common_definitions import ArgKind, InputDef, OutputBasketContainer, OutputDef
from sp2.impl.types.generic_values_resolver import GenericValuesResolver
from sp2.impl.types.instantiation_type_resolver import InputInstanceTypeResolver
...
from sp2.impl.wiring.special_output_names import UNNAMED_OUTPUT_NAME
...
class Signature:
    ...
    def parse_inputs(self, forced_tvars, *args, allow_subtypes=True, allow_none_ts=False, **kwargs):
        from sp2.utils.object_factory_registry import Injected
            ...
            if isinstance(resolved_input, Edge):
                if getattr(resolved_input.tstype, "typ", None) is int:
                    ...
                    if declared_type.typ is float:
                        from sp2.baselib import cast_int_to_float
