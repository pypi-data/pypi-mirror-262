...
from sp2.impl.wiring import MAX_END_TIME, py_push_adapter_def
...
class ThreadRunner:
    ...
    def _wrapped_graph(graph, stopper, *args, **kwargs):
        ...
        sp2.stop_engine(stop_signal)
        return graph(*args, **kwargs)

    @staticmethod
    def _run(output, graph, stopper, *args, **kwargs):
        try:
            output["result"] = sp2.run(ThreadRunner._wrapped_graph, graph, stopper, *args, **kwargs)
