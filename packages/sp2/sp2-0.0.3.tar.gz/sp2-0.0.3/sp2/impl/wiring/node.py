...
from sp2.impl.wiring import tstype
from sp2.impl.wiring.edge import Edge
from sp2.impl.wiring.node_parser import NodeParser


##Every NodeDefMeta instance represents a @sp2.node definition
...
class NodeDef:
    ...
    def _create(self, engine, memo):
        ...
        if node is None:
            ...
            node = _sp2impl.PyNode(engine, inputs, self._output_types, gen)
...
def _create_node(
    ...
    if create_wrapper:
        from sp2.impl.wiring.graph import _create_graph
