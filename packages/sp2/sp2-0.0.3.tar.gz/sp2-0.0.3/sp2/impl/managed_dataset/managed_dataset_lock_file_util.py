...
from sp2.utils.file_permissions import create_folder_with_permissions
from sp2.utils.lock_file import LockFile
...
class ManagedDatasetLockUtil:
    _READ_WRITE_LOCK_FILE_NAME = ".sp2_read_write_lock"
    _MERGE_LOCK_FILE_NAME = ".sp2_merge_lock"
