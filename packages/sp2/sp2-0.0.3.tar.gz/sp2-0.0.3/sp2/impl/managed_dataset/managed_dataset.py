...
import sp2
from sp2.impl.config import BaseCacheConfig
from sp2.impl.enum import Enum
from sp2.impl.managed_dataset.cache_partition_argument_serializer import (
    SerializedArgument,
    StructPartitionArgumentSerializer,
)
from sp2.impl.managed_dataset.dataset_metadata import DatasetMetadata, DictBasketInfo, TimeAggregation
from sp2.impl.managed_dataset.dateset_name_constants import DatasetNameConstants
from sp2.impl.managed_dataset.managed_dataset_lock_file_util import LockContext, ManagedDatasetLockUtil
from sp2.impl.managed_dataset.managed_dataset_path_resolver import DatasetPaths
from sp2.impl.struct import Struct
from sp2.utils.file_permissions import FilePermissions, apply_file_permissions, create_folder_with_permissions
from sp2.utils.rm_utils import rm_file_or_folder
...
class ManagedDatasetPartition:
    ...
    def merge_files(self, start_time: datetime, end_time: datetime, cache_config, parquet_output_config):
        from sp2.impl.managed_dataset.managed_dataset_merge_utils import SinglePartitionFileMerger
                ...
                if cur_dict_basket_columns or existing_meta_dict_columns:
                    if cur_dict_basket_columns is None or existing_meta_dict_columns is None:
                        ...
                        for col_name, col_info in metadata.dict_basket_columns.items():
                            ...
                            if issubclass(existing_type, sp2.Struct):
                                if not issubclass(cur_type, sp2.Struct):
                                    is_metadata_different = True
                                    break
