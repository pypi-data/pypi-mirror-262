...
class Sp2GraphObjectsMemCache(object):
    ...
    @classmethod
    def new_context(cls):
        new_instance = Sp2GraphObjectsMemCache()
...
def function_full_name(f):
    """A utility function that can be used for implementation of function_name for sp2_memoized_graph_object
    :param f:
    :return:
    """
    module = f.__module__
...
def sp2_memoized(func=None, *, force_memoize=False, function_name=None, is_user_data=True):
    ...
    def _impl(func):
        ...
        def __call__(*args, **kwargs):
            if MemoizeControl.is_memoize_on() or force_memoize:
                ...
                cache_instance = Sp2GraphObjectsMemCache.instance()
...
def sp2_memoized_graph_object(func=None, *, force_memoize=False, function_name=None):
    return sp2_memoized(func=func, force_memoize=force_memoize, function_name=function_name, is_user_data=False)
