...
class ContainerTypeNormalizer:
    ...
    _NORMALIZED_TYPE_MAPPING = {
        ...
        typing.List: list,
        typing.Tuple: tuple,
        sp2.typing.Numpy1DArray: numpy.ndarray,
        sp2.typing.NumpyNDArray: numpy.ndarray,
    }
    ...
    def _convert_containers_to_typing_generic_meta(cls, typ, is_within_container):
        if Sp2TypingUtils.is_generic_container(typ):
            ...
            return sp2.typing.NumpyNDArray[float]
        else:
    ...
    def normalized_type_to_actual_python_type(cls, typ, level=0):
        if Sp2TypingUtils.is_generic_container(typ):
            if Sp2TypingUtils.get_origin(typ) is typing.List and level == 0:
                return [cls.normalized_type_to_actual_python_type(typ.__args__[0], level + 1)]
            return cls._NORMALIZED_TYPE_MAPPING.get(Sp2TypingUtils.get_origin(typ), typ)
        else:
            return typ
