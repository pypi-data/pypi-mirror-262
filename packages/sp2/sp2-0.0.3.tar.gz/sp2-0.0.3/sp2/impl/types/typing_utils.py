...
class Sp2TypingUtils37:
    ...
    def is_numpy_array_type(cls, typ):
        return Sp2TypingUtils.is_generic_container(typ) and Sp2TypingUtils.get_orig_base(typ) is numpy.ndarray

    @classmethod
    def is_numpy_nd_array_type(cls, typ):
        return cls.is_numpy_array_type(typ) and cls.get_origin(typ) is sp2.typing.NumpyNDArray
...
Sp2TypingUtils = Sp2TypingUtils37
