...
from sp2.utils.file_permissions import FilePermissions, ensure_file_exists_with_permissions
...
class LockFile:
    ...
    @classmethod
    def sp2_lock_for_folder(cls, folder_path, shared=True):
        return LockFile(os.path.join(folder_path, cls._SP2_LOCK_FILE_NAME), shared=shared)
