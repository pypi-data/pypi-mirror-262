...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.discard_application  # this is an instance of the class Endpoint
        api_instance.discard_application()  # this invokes api_instance.discard_application.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.discard_application.callable or self.callable in this class
