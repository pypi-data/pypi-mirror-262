...
class ApplicationsIdpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.discard_application_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/applications/{client_id}',
                'operation_id': 'discard_application',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def discard_application(
        ...
        **kwargs
        ...
        """Discard Application  # noqa: E501

        Discards an application. Application is not deleted, all access tokens are revoked.Required scope: **organization_applications:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.discard_application(client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['client_id'] = \
            client_id
        return self.discard_application_endpoint.call_with_http_info(**kwargs)
