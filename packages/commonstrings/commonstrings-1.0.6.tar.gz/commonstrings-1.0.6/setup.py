...
ext_modules = [
    Extension(
        name="commonstrings",
        sources=[
            "./common_multiple_strings/commonstrings.pyx", 
        ...
        depends=[
            #'common_multiple_strings/auxiliary/alphabet.h', 
            #'common_multiple_strings/auxiliary/utf8.h', 
            #'common_multiple_strings/auxiliary/utf8/checked.h', 
            #'common_multiple_strings/auxiliary/utf8/core.h', 
            #'common_multiple_strings/auxiliary/utf8/unchecked.h', 
            #'common_multiple_strings/auxiliary/suffix_tree_simple.h'
        ],
        language="c++",
    ), 
]
