...
def run_treat2p(
    ...
    Args:
        # IO parameters :
            ...
            chan (int, optional): The channel number to process. One based (as is suite2p) set to 2 for channel 2.
                Defaults to 1.
    ...
    stat_file = make_file_path("stat")
    ops_file = make_file_path("ops")
