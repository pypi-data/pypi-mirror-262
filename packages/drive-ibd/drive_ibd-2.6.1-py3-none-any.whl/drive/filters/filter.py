...
class IbdFilter:
    ...
    def preprocess(
        ...
        for chunk in self.ibd_file:
            ...
            logger.debug(f"Identified {cohort_restricted_chunk.shape[0]} pairs in this chunk")  # noqa: E501
            ...
            logger.debug(f"{size_filtered_chunk.shape[0]} pairs remaining after filtering for the loci of interest with a {min_centimorgan} minimum shared segment threshold")   # noqa: E501
