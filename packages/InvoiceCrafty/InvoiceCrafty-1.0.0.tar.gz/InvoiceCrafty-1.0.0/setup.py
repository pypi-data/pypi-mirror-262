...
setup(
  name = 'InvoiceCrafty',         #* Your package will have this name
  packages = ['InvoiceCrafty'],   #* Name the package again
  ...
  description = 'This package can be used to convert Excel data of invoices to PDF invoices.',    # Short description of your library
  author = 'Jajula Sai Venkatesh',                   # Your name
  author_email = 'saivenkatesh619@gmail.com',  # Your email
  url = 'https://venkateshportfolio.streamlit.app/',              # Homepage of your library (e.g. github or your website)
