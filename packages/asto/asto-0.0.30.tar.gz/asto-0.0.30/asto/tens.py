...
# %% auto 0
__all__ = ['ptdevice', 'pttensor', 'to', 'devchain', 'dtypechain', 'tenchain', 'asdev', 'torchtype', 'gettype', 'try2dtype',
           'ten2cpu', 'ten2mps', 'ten2cuda', 'try2ten', 'asten', 'totorch', 'asnans', 'torchnans', 'nanslike', 'assize',
