...
def sdim(*slcs: slicespecs, axes: ints | None = None, ndim: intq = None) -> int:
     ...
     Parameters
     ----------
     slcs : slicespces | tuple[slice: tuple[int, int, int], ...] tuple[coord: tuple[int, ...], ...]
...
def flip_slice_format(*slcs: slicespecs) -> slicespecs:
    ...
    Returns
    -------
    slices: slicespces | tuple[slice: tuple[int, int, int], ...] tuple[coord: tuple[int, ...], ...]
...
def format_slice(*slcs: slicespecs, fmt: SliceFormats = SLICE, cur: SliceFormats | None = None) -> slicespecs:
    ...
    Parameters
    ----------
    slcs : slicespecs | tuple[slice: tuple[int, int, int], ...] tuple[coord: tuple[int, ...], ...]
        The slices to flip. Can be in 'coord' or 'slice' format.

    Returns
    -------
    slices: slicespecs | tuple[slice: tuple[int, int, int], ...] tuple[coord: tuple[int, ...], ...]
        The slices flipped to the opposite format.
