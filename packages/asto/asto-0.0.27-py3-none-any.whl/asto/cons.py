...
# %% auto 0
__all__ = ['COORD', 'SLICE', 'THWC', 'TCHW', 'TIME_HEIGHT_WIDTH_CHANNELS', 'TIME_CHANNELS_HEIGHT_WIDTH', 'THWC_AXES', 'TCHW_AXES',
           'TIME_HEIGHT_WIDTH_CHANNELS_AXES', 'TIME_CHANNELS_HEIGHT_WIDTH_AXES']
...
from nlit import COORD, SLICE, TCHW, THWC
