...
class EncoderDecoder:
    def __init__(
        ...
        self.encoder = OrtInferSession(encoder_path, providers=ort_providers)
        self.decoder = Decoder(decoder_path, ort_providers)
...
class Decoder:
    def __init__(self, decoder_path: Union[Path, str], provider: List[str]):
        self.max_seq_len = 512
        self.session = OrtInferSession(decoder_path, providers=provider)
