...
if dd.is_installed('vat'):
    ...
    class VatNumberValidator:
        ...
        def generate(self):
            return str(
                random.randint(int("1" * self.origin.length),
    ...
    vat_origins.add_item(
        'BE', VatOrigin('BE', (9, 10, 10), validator=ModValidator(97, 8, 2)))
