...
import _h2o_mlops_client.batch_manager.models
from _h2o_mlops_client.batch_manager import rest
from _h2o_mlops_client.batch_manager.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(_h2o_mlops_client.batch_manager.models, klass)
