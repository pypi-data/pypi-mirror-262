...
class DeployDeploymentComposition(object):
    ...
    def __init__(self, experiment_id=None, artifact_id=None, deployable_artifact_type_name=None, artifact_processor_name=None, runtime_name=None, local_vars_configuration=None):  # noqa: E501
