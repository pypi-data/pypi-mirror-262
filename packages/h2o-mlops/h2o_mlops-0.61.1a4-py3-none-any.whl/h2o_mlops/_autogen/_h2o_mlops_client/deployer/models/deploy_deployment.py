...
class DeployDeployment(object):
    ...
    def __init__(self, id=None, project_id=None, deployment_environment_id=None, created_time=None, last_modified_time=None, single_deployment=None, shadow_deployment=None, split_deployment=None, security=None, display_name=None, description=None, revision_id=None, revision_create_time=None, local_vars_configuration=None):  # noqa: E501
