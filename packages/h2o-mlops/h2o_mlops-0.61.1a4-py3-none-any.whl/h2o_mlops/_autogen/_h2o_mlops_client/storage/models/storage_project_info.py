...
class StorageProjectInfo(object):
    ...
    def __init__(self, project=None, registered_model_count=None, share_count=None, experiment_count=None, shared_user=None, local_vars_configuration=None):  # noqa: E501
