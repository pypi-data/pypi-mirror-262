...
class ApiDeployment(object):
    ...
    def __init__(self, id=None, name=None, description=None, mode=None, environment=None, type=None, problem_type=None, models=None, deployment_date=None, local_vars_configuration=None):  # noqa: E501
