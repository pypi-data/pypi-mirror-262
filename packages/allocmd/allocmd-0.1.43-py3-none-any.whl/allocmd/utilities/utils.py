...
def create_worker_account(worker_name, faucet_url, type='worker'):
    ...
    if make_path:
        ...
        print(colored(f"keys created and testnet-funded for this worker. please check {worker_name}.keys for your address and mnemonic", "green"))
