...
from djx.parser import XTMLParser
from djx.transformer import Transformer
...
class Template:
    ...
    def render(self, context, targets, keys):
        parser = XTMLParser()
...
class DjxEngine(Engine):
    def __init__(self, *args, **kwargs):
        kwargs.setdefault("app_dirs", False)
        kwargs.setdefault("loaders", [])
        kwargs["loaders"] += [
            "djx.loaders.FilesystemLoader",
            "djx.loaders.AppdirLoader",
        ]
...
class DjxTemplates(BaseBackend):
    app_dirname = "xtmls"
    ...
    def __init__(self, params):
        ...
        self.engine = DjxEngine(self.dirs, **options)
...
class Renderer:
    def __init__(self, template, backend):
        ...
        self.backend: DjxTemplates = backend
