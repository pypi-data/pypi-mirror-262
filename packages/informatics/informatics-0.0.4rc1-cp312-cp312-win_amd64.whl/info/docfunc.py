...
_GrpSettings = TypeVar('_GrpSettings')
_Canvas = TypeVar('_Canvas')
_KernelGen = TypeVar('_KernelGen')
_DcmSetConstructor = TypeVar('_DcmSetConstructor')
_DcmSeries = TypeVar('_DcmSeries')
_ImageViewer = TypeVar('_ImageViewer')
_dist = TypeVar('_dist')
_cdist = TypeVar('_cdist')
_mean = TypeVar('_mean')
_std = TypeVar('_std')
np_nan = TypeVar('np_nan')
...
def T():
    """
    marker for setting default values, add constraint type for keyword arguments. Using combined with
...
def FuncTools():
    ...
    .. attribute:: Methods:
       ...
       .. method:: attach_attr:
          ...
          statistic method to add document to function, applying typing hint, or type checking with hint
       ...
       .. method:: params_setting:
          ...
          statistic method to set default values, applying typing hint, or type checking with those hints. some
       ...
       .. method:: test_for:
          ...
          statistic method to test the decorated function.
...
def standardization(data: dual_ndarray):
    r"""
    standard scaler function or Unit to shrink data with values distributed as :math:`N(1, 0)`.
...
def Unit(mappings: list[Callable], structure: Literal['sequential', 'parallel'] = 'sequential',
    ...
    .. attribute:: Arguments:
       ...
       :param Optional[type] return_tp: the type of data in entry of this Unit; ``None`` as default to guess the
...
def GrpSettings(**kwargs):
    ...
    .. attribute:: Examples:
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/customized_scatter.jpg
...
def Canvas(data: Union[np_ndarray, tuple[np_ndarray, np_ndarray]] = None,
    ...
    """
    generic visualization utility. making line, scatter, histogram, beeswarm, box, heatmap, radar, pie figures
    ...
    .. attribute:: Arguments:
       ...
       :rtype: Canvas
       :raises IndexError: when number of groups exceeds 10 (the default max number of groups)
    ...
    .. attribute:: Methods:
       ...
       .. method:: save:
          ...
          statistic method; ``save_as`` to specify the file name for figure to be exported; ``figure.png`` as default

       .. method:: play:

          statistic method; create a new canvas then show figure. all ``**kwargs`` assignment supported.
    ...
    .. attribute:: Examples:
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/line_figure.jpg
          :name: line figure
          :width: 450
          :align: center
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/scatter_figure.jpg
          :name: scatter figure
          :width: 450
          :align: center
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/histogram_figure.jpg
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/beeswarm_figure.jpg
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/box_figure.jpg
          :name: box figure
          :width: 450
          :align: center
       ...
       .. code-block:: python
          ...
          config1 = vis.FigConfigs.Heatmap.update(tags=np.array([f"vec{_+1}" for _ in range(10)]))
          config2 = vis.FigConfigs.Heatmap.update(tags=np.array([f"mat{_+1}" for _ in range(10)]))
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/heat_vec_mat.jpg
          :name: heatmap figure
          :width: 650
          :align: center
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/radar_figures.jpg
          :name: radar figure
          :width: 650
          :align: center
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/pie_figure.jpg
          :name: pie figure
          :width: 450
          :align: center
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/image_figure.jpg
          :name: image figure
          :width: 450
          :align: center
    ...
    .. attribute:: Logs:
       ...
       .. versionchanged:: 0.0.4
          ...
          support writing image via ``save`` method.
...
def canny(data: dual_ndarray, k_shape: tuple[int, ...],
    ...
    through kernel :math:`N(\boldsymbol{\mu}, \boldsymbol{\Sigma})`. for canny filter, gradient components of tensor
    were calculated for all axis then integrated through 2 norm. for canny detector, pixels with gray level upper more
    than threshold will be identified as edges. for canny sharpen, pixels around edge-like area will be augmented
    into the effect of higher contrast. available for numpy and cupy ndarray.
...
def DcmSeries(data: Iterable[str], loader: Literal['SimpleITK', 'pydicom'] = 'SimpleITK',
    ...
    .. attribute:: Methods:
       ...
       .. method:: dvh_name_map:
          ...
          .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/dose_volume_histogram.jpg
...
def ImageViewer(gui_size: tuple[int, int] = (1000, 1000)):
    ...
    .. attribute:: Methods:
       ...
       .. method:: view:
          ...
          :var Optional[list[ndarray]] mask: list of bool ndarray with 3 dimension; Support observing 3 masks
                                             simultaneously in maximum; ``None`` as default
       ...
       .. method:: play:
          ...
          statistic method; create a new ImageViewer then view 3D image. all parameters defined the same as those
          when calling ``view``.
    ...
    .. attribute:: Examples:
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/image_viewer.jpg
       ...
       .. figure:: https://cdn.jsdelivr.net/gh/CubicZebra/PicHost@master/misc/image_viewer_mask.jpg
