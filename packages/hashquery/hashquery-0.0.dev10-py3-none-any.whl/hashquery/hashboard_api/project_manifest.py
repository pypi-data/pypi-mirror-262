...
class ProjectManifest:
    ...
    def __init__(self) -> None:
        self.models = ProjectModels()
        self.connections = ProjectConnections()
    ...
    def __repr__(self) -> str:
        return "\n".join(
            [
                f"Project: {HashboardAPI.project_id} on {HashboardAPI.base_uri}",
                str(self.models),
...
class ProjectModels(ProjectManifestTypedCollection["Model"]):
    ...
    def _item_alias(self, item: "Model") -> str:
        return item.linked_resource.alias or "__unnamed_model__"
