...
_credentials: Optional[HashboardClientCredentials] = None


def set_client_credentials(credentials: Optional[HashboardClientCredentials]):
    global _credentials
...
def get_client_credentials() -> Optional[HashboardClientCredentials]:
    if not _credentials:
        set_client_credentials(load_client_credentials())
    return _credentials
...
def load_client_credentials() -> Optional[HashboardClientCredentials]:
