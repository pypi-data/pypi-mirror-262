...
class ApiBSDownlinkTaskResponse(BaseApiBSDownlinkTask):
    ...
    bs_downlink_task_unbp_message_set_relay: Optional[ApiBSDownlinkTaskUnbpMessageSetRelayResponse]
    bs_downlink_task_unbp_message_set_schedule: Optional[ApiBSDownlinkTaskUnbpMessageSetScheduleResponse]
    bs_downlink_task_unbp_message_set_clock: Optional[ApiBSDownlinkTaskUnbpMessageSetClockResponse]
    bs_downlink_task_unbp_message_get_data: Optional[ApiBSDownlinkTaskUnbpMessageGetDataResponse]
...
#         ).check().payload_raw    # type: ignore
    ...
    def get_base_station_by_token(self, api_token: str) -> ApiBaseStationResponse:
        ...
        return self._api_device.request_get('/base-stations/auth-check', access_token=api_token).typed(ApiBaseStationTypeResponse).check().payload
