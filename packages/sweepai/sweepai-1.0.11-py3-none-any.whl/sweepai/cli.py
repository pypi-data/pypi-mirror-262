...
#     )
#     cprint(f"Firstly, we'll need your OpenAI API Key. You can get it from https://platform.openai.com/api-keys.")
...
#     cprint(f"Next, we'll need your GitHub Personal Access Token. You can get it from ")
