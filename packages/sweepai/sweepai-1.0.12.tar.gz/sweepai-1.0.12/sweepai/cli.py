...
from sweepai.utils.github_utils import get_app, get_github_client
...
def init():
    ...
    cprint(f"Firstly, we'll need your OpenAI API Key. You can get it here: https://platform.openai.com/api-keys", style="yellow")
    ...
    cprint(f"\nGreat! Next, we'll need your GitHub PAT. Here's a link with all the permissions pre-filled:\nhttps://github.com/settings/tokens/new?description=Sweep%20Self-hosted&scopes=repo,workflow", style="yellow")
    ...
    cprint(f"Installation complete ")
