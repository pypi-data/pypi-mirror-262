...
from .keyboard import (
    get_keypress, get_pressed_keys_list, is_key_pressed,
    wait_for_any_keypress, wait_for_keypress, wait_for_either_keypress
)
...
if is_connected():
    ...
    if latest_version:
        ...
        if installed_version and latest_version > installed_version:
            print("A newer version is available. Please consider upgrading: `pip install --upgrade kurumii`")
        else:
            pass
    ...
    def check_for_updates():
        ...
        if latest_version and latest_version > installed_version:
            print("\033[94m{}\033[0m".format("A newer version is available. Please consider upgrading."))  # \033[94m sets the text color to blue, \033[0m resets the color to default
