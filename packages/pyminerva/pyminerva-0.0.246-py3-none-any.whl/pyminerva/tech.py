...
def get_tech_yf_analysis(ticker):
    ...
    #         print(td_row)
        ...
        if i == 0:
            ...
            df_earnings_est = df_earnings_est.T
            df_earnings_est = df_earnings_est.reset_index()
            # df_earnings_est.columns = [*df_earnings_est.columns [1:]]
            # df_earnings_est.set_index('Earnings Estimate', inplace=True)
        elif i == 1:
