...
def report_system(system):
    ...
    db = {
        ...
        'species': [_.item() for _ in system.distinct_species],
        'composition': [system.composition[_.item()] for _ in system.distinct_species],
        'concentration': [system.concentration[_.item()] for _ in system.distinct_species],
...
def report_simulation(simulation):
    ...
    db = {
        ...
        'timestep': simulation.backend.timestep,
        'rmsd': simulation.rmsd.item(),
