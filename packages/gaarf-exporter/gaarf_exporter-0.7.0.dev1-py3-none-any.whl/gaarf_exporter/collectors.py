...
class Registry:
  ...
  def __init__(self, collectors: dict = registry) -> None:
  ...
  def find_collectors(self, collector_names: str | None = None) -> CollectorSet:
    ...
    Args:
      collector_names: Names of collectors that need to be fetched from registry.
...
class CollectorSet:
  ...
  def customize(self, kwargs: str) -> None:
