...
class Fuzzer(Thread):
    ...
    def brute(self,cookies_group):
        ...
        if res[6]!="":
            #print(response.text)
            return {"status_code":res[0],"reflects":res[1],"words":res[2],"bytes":res[3],"different_type":res[4],"different_status":res[5],"diffs":res[6],"headers":headers_group,"value_type":self.value_type}
        return None
