...
class Fuzzer(Thread):
    ...
    def brute(self,params_group,reqtype):
        ...
        if res[6]!="":
            return {"status_code":res[0],"reflects":res[1],"words":res[2],"bytes":res[3],"different_type":res[4],"different_status":res[5],"diffs":res[6],"request":dumprequest(response)}
        return None
        ...
        for reqtype in self.request_types:
            ...
            if response != None:
                ...
                if "base" in self.originalresponse:
                    ...
                    if res[6]!="":
                         self.results_queue.put({"status_code":res[0],"reflects":res[1],"words":res[2],"bytes":res[3],"different_type":res[4],"different_status":res[5],"diffs":res[6],"request":dumprequest(response)})
            else:
