...
def add(inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def constant(raw_value, *, loc=None, ip=None) -> _SubClassValueT:
...
def div(inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def cast(out, in_, *, loc=None, ip=None) -> _SubClassValueT:
...
def mul(inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def sub(inputs, *, loc=None, ip=None) -> _SubClassValueT:
