...
def hw_instance(outputs, name, machine, inputs, clock, reset, *, loc=None, ip=None) -> _SubClassValueT:
...
def instance(instance, name, machine, *, loc=None, ip=None) -> _SubClassValueT:
