...
def and_(inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def clock(input, edge, clock, *, loc=None, ip=None) -> _SubClassValueT:
...
def delay(input, delay, *, length=None, loc=None, ip=None) -> _SubClassValueT:
...
def disable(input, condition, *, loc=None, ip=None) -> _SubClassValueT:
...
def eventually(input, *, loc=None, ip=None) -> _SubClassValueT:
...
def implication(antecedent, consequent, *, loc=None, ip=None) -> _SubClassValueT:
...
def not_(input, *, loc=None, ip=None) -> _SubClassValueT:
...
def or_(inputs, *, loc=None, ip=None) -> _SubClassValueT:
