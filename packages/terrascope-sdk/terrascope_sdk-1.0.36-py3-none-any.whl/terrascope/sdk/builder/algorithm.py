...
class AlgorithmManifest:
    ...
    def __init__(self):
        ...
        self.__enable_byte_weighting = {
            "enable_byte_weighting": False
        }
        self.__required = {
            "metadata": {
                "description": False,
    ...
    def enable_byte_weighting(self, enabled: bool):
        self.__enable_byte_weighting['enable_byte_weighting'] = enabled
    ...
    def get(self) -> Struct:
        ...
        manifest.update(self.__enable_byte_weighting)
