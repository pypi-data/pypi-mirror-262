...
class ZendeskCustomHttpActionBuilder:
    ...
    def build(self) -> 'ZendeskCustomHttpAction':
        return self._get_instance()

    def _get_instance(self) -> 'ZendeskCustomHttpAction':
...
class ZendeskCustomHttpAction:
    """
    Represents a custom HTTP action for Zendesk.
    ...
    @staticmethod
    def prepare(data: dict) -> 'ZendeskCustomHttpAction':
