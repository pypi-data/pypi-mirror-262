...
class AMPLModel(object):
    ...
    def addConstraint(self, *args):
        return _amplpy_cplex_swig.AMPLModel_addConstraint(self, *args)
    ...
    def add_constraint(self, vars, coefficients, sense, rhs, name=None):
        return _amplpy_cplex_swig.AMPLModel_add_constraint(self, vars, coefficients, sense, rhs, name)
