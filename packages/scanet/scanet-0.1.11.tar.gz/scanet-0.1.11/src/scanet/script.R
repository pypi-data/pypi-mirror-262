...
co_expression_r <- function(final_exp, power, module_merging_threshold, network_type, cor_method, verbose,w=400,h=400){
    ...
    net <- exp2gcn(final_exp, module_merging_threshold=module_merging_threshold, net_type=network_type, 
                   SFTpower=power, cor_method=cor_method, verbose = verbose)
    names(net)
