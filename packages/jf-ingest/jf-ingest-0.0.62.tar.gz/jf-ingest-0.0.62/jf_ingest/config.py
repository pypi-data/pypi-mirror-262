...
class GitConfig:
    ...
    pull_since_for_repos: datetime = datetime.min
    ...
    def get_pull_from_for_prs(
        ...
        """
        return self.pull_prs_since_for_repo_in_org.get(org_login, {}).get(repo_id, default_value)
