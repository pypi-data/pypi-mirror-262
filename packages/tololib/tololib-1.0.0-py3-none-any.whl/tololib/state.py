...
class ToloStatus(NamedTuple):
    """A NamedTuple reflecting the current status of a TOLO device."""
    ...
    def from_bytes(data: bytes) -> "ToloStatus":
        ...
        return ToloStatus(
            ...
            # data[8]
            water_level=data[8],
            water_level_percent={0: 0, 1: 33, 2: 66, 3: 100}.get(data[8]) or 0,
            # data[9]
            fan_on=bool(data[9]),
            # data[10]
...
class ToloSettings(NamedTuple):
    """A NamedTuple reflecting the current settings of a TOLO device."""

    target_temperature: int
    power_timer: int | None
    aroma_therapy: AromaTherapySlot
    ...
    def from_bytes(data: bytes) -> "ToloSettings":
        ...
        return ToloSettings(
            ...
            # data[2]
            aroma_therapy=AromaTherapySlot(data[2]),
            # data[3]
