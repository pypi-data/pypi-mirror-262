...
# MF version: 2.11.5                                                             #
# Generated on 2024-03-14T18:36:24.972916                                        #
##################################################################################
...
class BatchJob(object, metaclass=type):
    ...
    def execute(self):
        ...
    def job_def(self, image, iam_role, job_queue, execution_role, shared_memory, max_swap, swappiness, inferentia, efa, memory, host_volumes, efs_volumes, use_tmpfs, tmpfs_tempdir, tmpfs_size, tmpfs_path, num_parallel, ephemeral_storage):
        ...
