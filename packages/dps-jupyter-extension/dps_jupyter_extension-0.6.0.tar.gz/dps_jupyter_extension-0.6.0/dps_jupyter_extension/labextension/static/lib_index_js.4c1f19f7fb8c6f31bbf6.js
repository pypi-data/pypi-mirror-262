"use strict";
(self["webpackChunk_maap_jupyterlab_dps_jupyter_extension"] = self["webpackChunk_maap_jupyterlab_dps_jupyter_extension"] || []).push([["lib_index_js"],{
...
const JobSubmissionForm = ({ uname }) => {
    ...
    const buildNotebookCommand = () => {
        _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_5__.Notification.success("testing link here: <a>https://repo.maap-project.org/root/register-job-hysds-v4/-/jobs/13030</a>", { autoClose: false });
...
/* harmony import */ var _JobStatusBadge__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./JobStatusBadge */ "./lib/components/JobStatusBadge.js");
...
/* harmony import */ var _redux_slices_jobsSlice__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../redux/slices/jobsSlice */ "./lib/redux/slices/jobsSlice.js");
/* harmony import */ var _redux_slices_JobsContainerSlice__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../redux/slices/JobsContainerSlice */ "./lib/redux/slices/JobsContainerSlice.js");
/* harmony import */ var _redux_slices_userInfoSlice__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../redux/slices/userInfoSlice */ "./lib/redux/slices/userInfoSlice.js");
/* harmony import */ var _utils_mapping__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/mapping */ "./lib/utils/mapping.js");
/* harmony import */ var _api_maap_py__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../api/maap_py */ "./lib/api/maap_py.js");
...
const JobsOverviewContainer = ({ jupyterApp }) => {
    ...
    const { itemSize } = (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.useSelector)(_redux_slices_JobsContainerSlice__WEBPACK_IMPORTED_MODULE_6__.selectJobsContainer);
    const { selectedJob, userJobInfo, jobRefreshTimestamp } = (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.useSelector)(_redux_slices_jobsSlice__WEBPACK_IMPORTED_MODULE_7__.selectJobs);
    const { username } = (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.useSelector)(_redux_slices_userInfoSlice__WEBPACK_IMPORTED_MODULE_8__.selectUserInfo);
    const { setSelectedJob, setUserJobInfo, setJobRefreshTimestamp } = _redux_slices_jobsSlice__WEBPACK_IMPORTED_MODULE_7__.jobsActions;
    ...
    const getJobInfo = () => {
        ...
        let response = (0,_api_maap_py__WEBPACK_IMPORTED_MODULE_9__.getUserJobs)(username);
        response.then((data) => {
            dispatch(setUserJobInfo((0,_utils_mapping__WEBPACK_IMPORTED_MODULE_10__.parseJobData)(data["response"]["jobs"])));
        }).finally(() => {
    ...
    const testSort = (canSort, isSortedDesc) => {
        if (canSort) {
            if (isSortedDesc === undefined) {
                return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_icons_fa__WEBPACK_IMPORTED_MODULE_11__.FaSort, { size: 24 });
            }
            else if (isSortedDesc) {
                return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_icons_fa__WEBPACK_IMPORTED_MODULE_11__.FaSortDown, { size: 24 });
            }
            else {
                return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_icons_fa__WEBPACK_IMPORTED_MODULE_11__.FaSortUp, { size: 24 });
            }
        }
    };
    ...
    const columns = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => [
        ...
        },
        {
            ...
            Cell: ({ cell: { row: { values: { status } } } }) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { textAlign: "center" } },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_JobStatusBadge__WEBPACK_IMPORTED_MODULE_12__.JobStatusBadge, { status: status })),
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "overview-header" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__.Button, { variant: "primary", onClick: () => (0,_utils_utils__WEBPACK_IMPORTED_MODULE_13__.openSubmitJobs)(jupyterApp, null) }, "+ Submit New Job"))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'table-toolbar' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__.ButtonGroup, { className: 'toolbar-btn' },
                showFilters ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { title: "Hide filters", onClick: () => setShowFilters(!showFilters) },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_icons_md__WEBPACK_IMPORTED_MODULE_14__.MdFilterAltOff, null)) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { title: "Show filters", onClick: () => setShowFilters(!showFilters) },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_icons_md__WEBPACK_IMPORTED_MODULE_14__.MdFilterAlt, null)),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { title: "Clear filters", onClick: () => setAllFilters([{ id: 'status', value: statusFilterOptions }]) },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_icons_md__WEBPACK_IMPORTED_MODULE_14__.MdClear, null)),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { title: "Refresh job list", onClick: getJobInfo },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_icons_md__WEBPACK_IMPORTED_MODULE_14__.MdRefresh, null))),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "table-container" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__.Table, Object.assign({}, getTableProps()),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("thead", null, headerGroups.map(headerGroup => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", Object.assign({}, headerGroup.getHeaderGroupProps(), { key: "Header Group" }), headerGroup.headers.map(column => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th", Object.assign({}, column.getHeaderProps()),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, showFilters ? column.canFilter ? column.render('Filter') : null : null)))))))),
                showSpinner ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tbody", null,
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", { key: "loading-jobs" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", { colSpan: columns.length, style: { textAlign: "center" } },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__.Spinner, { animation: "border", variant: "primary" })))) :
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tbody", Object.assign({}, getTableBodyProps()), page.map(row => {
                        prepareRow(row);
                        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", { key: row.index, className: selectedJob && (selectedJob.rowIndex === row.index) ? "selected-row" : "", onClick: () => handleRowClick(row) }, row.cells.map(cell => {
...
//# sourceMappingURL=lib_index_js.4c1f19f7fb8c6f31bbf6.js.map