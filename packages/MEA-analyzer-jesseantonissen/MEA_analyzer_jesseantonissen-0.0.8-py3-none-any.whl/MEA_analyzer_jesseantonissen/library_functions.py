...
def spikes(data, electrode, threshold, hertz, spikeduration, exit_time_s, amplitude_drop, plot_validation, electrode_amnt):
    ...
    if True:
        ...
        print(spike_x_values, spike_y_values, spike_indexes)
...
filename = 'Models/31_05_2021/20210531_No_compound_Day2_of_recording_mwd.h5'
analyse_electrode(filename, [109], 20000)