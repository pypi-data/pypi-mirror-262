...
class APIResponse:
    ...
    def validate(cls, v):
        if not isinstance(v, cls):
            raise TypeError("Expected object of type APIResponse")
        return v

    @classmethod
    def __get_pydantic_core_schema__(cls) -> dict[str, any]:
        return {
            "title": "APIResponse",
            "type": "object",
            "properties": {
                ...
                "content": {
                    "title": "Content",
                    "anyOf": [
                        {"type": "string", "description": "The raw text content from the response."},
                        {
                            "type": "object",
                            "description": "The JSON content from the response, parsed into an object."
                        }
                    ],
                    "description": "The content of the response, which may be text or parsed JSON."
                },
                "url": {
                    "title": "URL",
                    "type": "string",
                ...
                "history": {
                    "title": "History",
                    "type": "array",
                    "description": "The sequence of URLs visited in the history of the response.",
                    "items": {
                        "type": "object",
                        "properties": {"url": {"type": "string", "format": "uri"}, "status": {"type": "integer"}}
                    }
                },
                "encoding": {
                    "title": "Encoding",
                    "type": "string",
                    "description": "The text encoding of the response content."
                },
                "elapsed": {
                    "title": "Elapsed",
                    "type": "string",
                    "description": "The elapsed time from sending the request to receiving the response."
                },
                "cookies": {
                    "title": "Cookies",
                    "type": "object",
                    "description": "The cookies returned in the response.",
                    "additionalProperties": {"type": "string"}
                },
                "attempts": {
                    "title": "Attempts",
                    "type": "integer",
                    "description": "The number of attempts made to retrieve the response.",
                    "minimum": 1
                }
            },
            "required": ["status_code", "headers", "content", "url", "encoding", "elapsed", "cookies", "attempts"]
        }
