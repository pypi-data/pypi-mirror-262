...
class LengthDistributionSingle:
    def __init__(
        ...
        unique_length, counts_length = self.tidy(
            sequencing_report, sample, region_of_interest
        )
    ...
    @staticmethod
    def plot(
        unique_length, counts_length, sample, ax, font_settings, title_type="single"
    ):
        ax.bar(
            unique_length, counts_length, color="lightskyblue"
...
def length_distribution_multi(
    ...
    for experiment in unique_experiments:
        ...
        LengthDistributionSingle(
            sequencing_report,
            sample=experiment,
            region_of_interest=region_string,
            ax=ax,
