...
class ExperimentTracker(object):
    ...
    def __init__(
        ...
        if self._project_name is not None:
            job_name = self._get_windmill_job()
        ...
        if job_name is not None:
            self._update_run_id(run_id=self.tracker.get_run_id(), name=job_name)
    ...
    def _update_run_id(self, run_id: str, name: str):
        ...
        Update the run id.
        """
        workspace_id, project_name, local_name = parse_job_name(name)
    ...
    def _get_windmill_job(self):
        ...
        Get windmill job.
        """
        workspace_id, project_name = parse_project_name(self.project_name)
