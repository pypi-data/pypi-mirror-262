from .media_id import Electricity
...
class ElectricityListObjects(Electricity):
    """7_5_34"""


ELECTRICITY_LIST_OBJECTS = ElectricityListObjects()
...
class MeteringPointIdObjects(Electricity):
    """6_2_43"""
