...
def calculateGeneMCS(cobraModel, **kwargs):
    ...
    **Calculate the genetic minimal cut sets of a model**
    ...
    Optional arguments:
        ...
        - **targetKOs:** List of genes that you want to be part of the gMCS solutions. The list is expected to be of gene names. Default value is an empty list, which means that all genes will be considered.
        - **geneSubset:** List of genes to be considered in the gMCS problem. The list is expected to be of gene names. Default value is an empty list, which means that all genes will be considered.
