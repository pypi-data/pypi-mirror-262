...
def enrich_hourly_data(ingestment_output: IngestmentOutput, timespan: Timespan,
    ...
    if features.national_holidays:
        ingested_hourly_data = add_national_holiday(
            ingested_hourly_data,
            ingestment_output.enrichment_features.national_holidays,
            timespan.start, timespan.end)

    if features.weekly_averages:
