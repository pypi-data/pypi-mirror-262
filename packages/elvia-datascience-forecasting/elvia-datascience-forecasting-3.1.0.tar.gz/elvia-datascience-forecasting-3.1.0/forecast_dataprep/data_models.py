...
class FeatureSelection:
    ...
    :param bool weekly_averages: The average consumption for each hour of the week (the average is calculated based on a long time inverval, e.g. the last year)
    :param bool delayed_features: Past consumptions shifted forward in time, e.g. at t-24h
    :param bool national_holidays: National holidays 
    :param bool school_holidays: School holidays, location-dependant
    :param bool prices: Electricity prices
    """

    weekly_averages: bool
