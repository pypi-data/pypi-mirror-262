...
class TyperCommandGenerator:
    ...
    def get_proxy_for_parameter(self, value: FieldInfo):
        """
    ...
    def set_function_annotations_for_route(
        ...
        for name, value in parameters.items():
            annotations[name] = Annotated[value.annotation, self.get_proxy_for_parameter(value)]

        defaults = {
            name: parameters[name].default
            for name in parameters
            if parameters[name].default is not PydanticUndefined
        }
