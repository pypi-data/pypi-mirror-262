...
from fastapi2cli.web.authentication import AuthenticationResolverProtocol, NoAuthResolver, AuthenticationManager
...
def expose_app(
        app: FastAPI,
        authentication_resolver: AuthenticationResolverProtocol = None,
    ...
    :type authentication_resolver: AuthenticationResolverProtocol, optional
