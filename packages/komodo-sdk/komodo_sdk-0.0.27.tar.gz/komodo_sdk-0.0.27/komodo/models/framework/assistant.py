...
class AssistantRequest:
    ...
    def __init__(self, user, assistant, prompt, message_id=None, context=None, history=None):
        self.user = user
    ...
    def prepare_messages(self):
        instructions = build_message("INSTRUCTIONS", self.instructions())
        caution = build_message("CAUTION", "Do not make up fake data or hallucinate information.")
        guidance = build_message("GUIDANCE", "Prioritize tools provided to you to answer the questions.")
...
def build_context(context):
    ...
    if isinstance(context, str):
        return [build_message("CONTEXT", context)]
    return []
