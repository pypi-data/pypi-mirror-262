...
from komodo.models.framework.models import max_function_output_len
...
class ModelRequest:
    ...
    def prepare_metadata(self):
        metadata = {}
        metadata['user_id'] = self.user.email
        metadata['name'] = self.user.name
        metadata['agent_id'] = self.agent.shortcode
        metadata['max_output_length'] = max_function_output_len(self.agent.model)
        return metadata
