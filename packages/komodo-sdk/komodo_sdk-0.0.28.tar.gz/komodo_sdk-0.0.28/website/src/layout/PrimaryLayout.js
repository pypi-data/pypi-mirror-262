  ...
  const renderChatItem = (val, i) => (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="w-[200px] lg:w-[110px] xl:w-[60px] xxl:w-[100px] truncate" onClick={()=>setIsDrawerOpen(false)}>{val?.title}</div>
      </div>
          ...
          <div>
            ...
            <div className="text-center">
              <button
                ...
                className="bg-[#316FF6] text-[#fff] rounded-md px-24 pb-2 pt-3 text-[15px] font-cerebriregular xxl:px-10"
              >
                New Chat
              </button>
            </div>
