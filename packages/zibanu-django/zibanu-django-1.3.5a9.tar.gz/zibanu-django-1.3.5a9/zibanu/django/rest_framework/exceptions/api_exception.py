...
class APIException(SourceException):
    ...
    def __init__(self, detail: Any = None, code: str = "invalid", status_code: int = None, **kwargs) -> None:
        """
        Constructor method
        ...
        # Set detail from msf if exists and detail is None
        if detail is None and "msg" in kwargs:
            detail = kwargs.get("msg", self.__default_messages.get("500"))

        # Set default detail based on detail object
        self.default_detail = object_to_list(detail)
