...
class NewBookingResponse(genpy.Message):
  _md5sum = "623e15d7fba4d12713b8cbd6a5bb13ee"
  _type = "digitaleye_msgs/NewBookingResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# status of the request, use BOOKING_ underneath
uint32 status

uint32 BOOKING_HELD=0
uint32 BOOKING_HELD_MODIFICATIONS=1
uint32 BOOKING_REJECTED=2

"""
  # Pseudo-constants
  BOOKING_HELD = 0
  BOOKING_HELD_MODIFICATIONS = 1
  BOOKING_REJECTED = 2
...
class NewBooking(object):
  ...
  _md5sum = 'd0b4faaaa3b2ac048d593f7b0cadfac0'
