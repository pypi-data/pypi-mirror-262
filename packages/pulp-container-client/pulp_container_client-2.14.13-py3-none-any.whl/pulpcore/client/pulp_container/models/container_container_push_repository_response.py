...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, retain_repo_versions=None, description=None, latest_version_href=None, name=None, pulp_created=None, pulp_labels=None, manifest_signing_service=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
