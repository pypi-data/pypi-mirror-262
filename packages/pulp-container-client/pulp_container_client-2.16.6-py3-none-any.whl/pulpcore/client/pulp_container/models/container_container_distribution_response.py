...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, name=None, base_path=None, hidden=False, pulp_href=None, repository=None, content_guard=None, pulp_created=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
