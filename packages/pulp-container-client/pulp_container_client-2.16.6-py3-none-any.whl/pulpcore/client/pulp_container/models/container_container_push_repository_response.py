...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, pulp_labels=None, name=None, description=None, pulp_href=None, latest_version_href=None, retain_repo_versions=None, manifest_signing_service=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
