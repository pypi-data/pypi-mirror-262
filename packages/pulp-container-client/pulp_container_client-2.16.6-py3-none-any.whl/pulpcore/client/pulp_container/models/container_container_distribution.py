...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_labels=None, name=None, base_path=None, hidden=False, repository=None, content_guard=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
