...
class ContainerContainerPullThroughDistribution(object):
    ...
    def __init__(self, base_path=None, content_guard=None, hidden=False, pulp_labels=None, repository=None, name=None, remote=None, distributions=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
