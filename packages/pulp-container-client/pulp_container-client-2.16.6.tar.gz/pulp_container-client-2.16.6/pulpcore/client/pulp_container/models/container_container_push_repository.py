...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, pulp_labels=None, name=None, description=None, retain_repo_versions=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
