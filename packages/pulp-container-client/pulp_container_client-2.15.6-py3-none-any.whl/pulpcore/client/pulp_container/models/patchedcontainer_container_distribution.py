...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, hidden=False, repository=None, pulp_labels=None, content_guard=None, name=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
