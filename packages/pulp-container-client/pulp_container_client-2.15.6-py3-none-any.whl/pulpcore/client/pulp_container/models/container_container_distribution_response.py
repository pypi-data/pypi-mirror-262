...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, hidden=False, pulp_href=None, repository=None, pulp_labels=None, content_guard=None, pulp_created=None, name=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
