...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, retain_repo_versions=None, description=None, pulp_labels=None, name=None, versions_href=None, manifest_signing_service=None, pulp_created=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
