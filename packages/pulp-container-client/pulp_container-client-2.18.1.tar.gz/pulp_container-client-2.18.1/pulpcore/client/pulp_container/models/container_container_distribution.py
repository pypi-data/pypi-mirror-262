...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, pulp_labels=None, name=None, repository=None, base_path=None, hidden=False, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
