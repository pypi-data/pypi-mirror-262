...
class ContainerContainerPullThroughDistribution(object):
    ...
    def __init__(self, content_guard=None, pulp_labels=None, name=None, repository=None, base_path=None, hidden=False, remote=None, distributions=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
