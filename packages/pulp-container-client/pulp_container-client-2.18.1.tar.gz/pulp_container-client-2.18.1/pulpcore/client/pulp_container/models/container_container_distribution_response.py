...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_labels=None, pulp_href=None, name=None, repository=None, pulp_created=None, base_path=None, hidden=False, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
