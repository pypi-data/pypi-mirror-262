...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, versions_href=None, manifest_signing_service=None, pulp_labels=None, retain_repo_versions=None, name=None, pulp_created=None, description=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
