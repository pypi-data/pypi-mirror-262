...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, manifest_signing_service=None, description=None, pulp_labels=None, retain_repo_versions=None, name=None, local_vars_configuration=None):  # noqa: E501
