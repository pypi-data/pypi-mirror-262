...
from cartopy.feature import NaturalEarthFeature, GSHHSFeature, COASTLINE
...
class BathyMap():
    ...
    def plot_coastlines(self, resolution=None):
        """
        Plot coastlines
        ...
        if resolution is None:
            pass
        elif resolution in GSHSS_coast_resolutions:
            try:
                coast =  GSHHSFeature(scale=resolution)
            except Exception:
                print(f"Couldn't find/download GSHHSFeature {resolution} coastline")
        elif resolution in NE_coast_resolutions:
            try:
                coast = NaturalEarthFeature('physical', 'Coastline', scale=resolution)
            except Exception:
                print(f"Couldn't find/download NaturalEarthFeature {resolution} coastline")
        else:
