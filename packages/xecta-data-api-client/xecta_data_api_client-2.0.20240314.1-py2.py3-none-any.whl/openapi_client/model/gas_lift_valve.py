...
class GasLiftValve(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, xid, tubing_xid, source_id, source_mandrel_id, run_date, install_md, surface_open_pressure, surface_close_pressure, port_size, *args, **kwargs):  # noqa: E501
        """GasLiftValve - a model defined in OpenAPI
