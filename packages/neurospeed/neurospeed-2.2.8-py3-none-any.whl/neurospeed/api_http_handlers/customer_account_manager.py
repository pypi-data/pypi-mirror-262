...
class Customer_Account_Manager:
    ...
    def get_all_existing_users(self, page_number = 1, page_size = 50):
        ...
        return self._http_service.POST_request(endpoint, json.dumps(payload), header)
        # return self._http_service.POST_request(endpoint, '{pager: {page_number: 1,page_size: 10},filters: {}}', self._headers)
