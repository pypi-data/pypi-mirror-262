...
def EEG_processing_handler1(payload):
    ...
    # electrode_select is a list of EEG electrodes to be included in the calculation of the brainwave output. 
    ...
    # print(payload["output"]['brainwave_power'])
    ...
    # midiout.send_message([88,midi_Control_Change_number,output_value])
